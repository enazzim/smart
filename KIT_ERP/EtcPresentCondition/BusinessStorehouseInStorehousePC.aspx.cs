	...
	public class BusinessStorehouseInStorehousePC : System.Web.UI.Page
	{
		...
		private DataSet search()
		{
			...
			if(ItemSearchControl1.hdItem.Trim() == "")
				aa = new Search("BusinessStorehouseInStorehousePC",ItemSearchControl1.ItemNum,ItemSearchControl1.ItemDrawNum,ItemSearchControl1.ItemName,wdcFromDate,wdcToDate);
			else
				aa = new Search("BusinessStorehouseInStorehousePC",ItemSearchControl1.ItemNum,"", "",wdcFromDate,wdcToDate);
