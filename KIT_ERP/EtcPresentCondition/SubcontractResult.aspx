...
<%@ Page language="c#" Codebehind="SubcontractResult.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.EtcPresentCondition.SubcontractResult" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SubcontractResult</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="SubcontractResult" method="post" runat="server">
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="800" border="0">
								...
								<TR>
									...
									<TD align="right" width="515" height="30"><FONT face="굴림"><INPUT id="btnReset" style="WIDTH: 65px; HEIGHT: 20px" onclick="javascript:ResettxtBox()"
											...
											<asp:button id="btComSearch" runat="server" Height="20px" Width="60px" Text="거래처별"></asp:button>&nbsp;
											<asp:button id="btItemSearch" runat="server" Height="20px" Width="60px" Text="품목별"></asp:button>&nbsp;&nbsp;
										</FONT>
									</TD>
								</TR>
							</TABLE>
					...
					<TD vAlign="top" align="center" width="800">
						<FIELDSET style="BORDER-BOTTOM: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-TOP: #696969 2px solid; BORDER-RIGHT: #696969 2px solid"><LEGEND align="top">[검색결과]</LEGEND>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800">
								<TR>
									<TD colSpan="6" height="450"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Height="446px" Width="100%">
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="발주일자" Key="SaleDate" Width="100px" Format="yyyy-MM-dd" BaseColumnName="SaleDate">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="발주수량" Key="OrderQuantity" Width="100px" Format="###,###,###" BaseColumnName="OrderQuantity">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
															<HeaderStyle Cursor="Hand" VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="미납수량" Key="ArrearageQuantity" Width="100px" BaseColumnName="ArrearageQuantity"></igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="총 금액" Key="ArrearageCost" Width="148px" Hidden="True" Format="###,###,###"
															BaseColumnName="ArrearageCost">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
															<HeaderStyle Cursor="Hand" VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
										...
										<igtbl:ultrawebgrid id="UltraWebGrid2" runat="server" Width="100%" Height="446px">
											<DisplayLayout StationaryMargins="Header" AutoGenerateColumns="False" RowHeightDefault="20px" Version="3.00"
												SelectTypeRowDefault="Single" AllowColumnMovingDefault="OnServer" BorderCollapseDefault="Separate"
