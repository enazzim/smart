...
{
	/// <summary>
	/// BuyingOrderDelivery에 대한 요약 설명입니다.
	/// </summary>
	public class BuyingOrderDelivery : System.Web.UI.Page
	{
		...
		private void btItemSearch_Click(object sender, System.EventArgs e)
		{
			...
			UltraWebGrid1.Bands[0].Columns.FromKey("ItemClassification2").MergeCells = true;
			UltraWebGrid1.Bands[0].Columns.FromKey("CompanyName").MergeCells = true;//
			UltraWebGrid1.Bands[0].Columns.FromKey("ItemNum").MergeCells = true;
			UltraWebGrid1.Bands[0].Columns.FromKey("ItemName").MergeCells = true;//OrderQuantity, OrderDate, ProcessName, Unit,Standard
			//UltraWebGrid1.Bands[0].Columns.FromKey("ProcessName").MergeCells = true;
			//UltraWebGrid1.Bands[0].Columns.FromKey("Unit").MergeCells = true;
			//UltraWebGrid1.Bands[0].Columns.FromKey("Standard").MergeCells = true;
			//UltraWebGrid1.Bands[0].Columns.FromKey("OrderQuantity").MergeCells = true;NowStockQuantity
			//UltraWebGrid1.Bands[0].Columns.FromKey("OrderDate").MergeCells = true;
			UltraWebGrid1.Bands[0].Columns.FromKey("NowStockQuantity").MergeCells = true;
		}
		...
		private DataTable Search()
		{
			...
			conn.Open();
			string str = "SPBuyingOrderDelivery";
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			uwg.DataBind();
			UltraWebGrid1.Bands[0].Columns.FromKey("ItemClassification2").MergeCells = false;
			UltraWebGrid1.Bands[0].Columns.FromKey("CompanyName").MergeCells = false;
			UltraWebGrid1.Bands[0].Columns.FromKey("ItemNum").MergeCells = false;
			UltraWebGrid1.Bands[0].Columns.FromKey("ItemName").MergeCells = false;
			UltraWebGrid1.Bands[0].Columns.FromKey("NowStockQuantity").MergeCells = false;
