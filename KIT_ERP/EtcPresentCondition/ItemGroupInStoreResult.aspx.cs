...
{
	/// <summary>
	/// ItemGroupInStoreResult에 대한 요약 설명입니다.
	/// </summary>
	public class ItemGroupInStoreResult : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Button btCompanyGroupSearch;
		...
		protected KIT_ERP.Common.CompanySearchControl.CompanySearchControl CSC;
		...
		{    
			this.btCompanyGroupSearch.Click += new System.EventHandler(this.btCompanyGroupSearch_Click);
		...
		private void btCompanyGroupSearch_Click(object sender, System.EventArgs e)
		{
		...
		{
			SqlConnection conn = new SqlConnection(ConfigurationSettings.AppSettings["DSN"]);
			SqlDataAdapter adap = new SqlDataAdapter("SPInStoreResult",conn);
			...
			adap.SelectCommand.Parameters.Add("@CompanyName",CSC.Company);
			adap.SelectCommand.Parameters.Add("@BusinessRegistrationNum",CSC.BusinessRegistrationNum);
