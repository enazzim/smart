<%@ Page language="c#" Codebehind="PurchaseDailyReport.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.EtcPresentCondition.PurchaseDailyReport" %>
...
<HTML>
	<HEAD>
		<title>PurchaseDailyReport</title>
		...
		function ResettxtBox()
		{
			...
			document.Form1.ddlDivision.options[0].selected = true;
			document.Form1.ddlYear.options[0].selected=true;
			document.Form1.ddlMon.options[0].selected=true;
									...
									<TR>
										<td colSpan="7">
											<table id="table3" cellSpacing="0" cellPadding="0" width="800" border="0">
												<tr>
													<TD style="HEIGHT: 30px" align="left" width="210" height="30"><FONT face="굴림"><uc1:companysearchcontrol id="CSC1" runat="server"></uc1:companysearchcontrol></FONT></TD>
													<TD style="HEIGHT: 30px" vAlign="middle" align="left" width="590" height="30"><uc1:itemsearchcontrol id="ItemSearchControl1" runat="server"></uc1:itemsearchcontrol><asp:dropdownlist id="ddlItemGroup3" runat="server" Width="100px" Visible="False"></asp:dropdownlist></TD>
												</tr>
											</table>
										</td>
									</TR>
										...
										<TD colSpan="7">
											<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="800" border="0">
												<TR>
													...
													<TD align="left" width="100" height="30"><asp:dropdownlist id="ddlItemGroup1" runat="server" Width="100px"></asp:dropdownlist></TD>
													<TD align="right" width="70" height="30"><FONT face="굴림">품목분류2&nbsp;</FONT></TD>
													<TD align="left" width="100" height="30"><asp:dropdownlist id="ddlItemGroup2" runat="server" Width="100px"></asp:dropdownlist></TD>
													<TD align="right" width="70" height="30"><FONT face="굴림">승인&nbsp;</FONT></TD>
													<TD align="left" width="100" height="30">
														<asp:dropdownlist id="ddlRecognition" runat="server" BackColor="#EEEEE9">
													...
													<TD vAlign="middle" align="left" colSpan="2" height="30">
														<table id="tb" cellSpacing="0" cellPadding="0" width="280" border="0">
															<tr>
																<td align="right" width="60">년도</td>
																<td width="70"><asp:dropdownlist id="ddlYear" runat="server" BackColor="#EEEEE9" Width="55px">
																...
																<td align="right" width="30">월</td>
																<td><asp:dropdownlist id="ddlMon" runat="server" BackColor="#EEEEE9" Width="50px">
																		<asp:ListItem Value="선택">선택</asp:ListItem>
									...
									<TR>
										<TD colSpan="7">
											<table id="Table10" cellSpacing="0" cellPadding="0" width="800" border="0">
												<tr>
													<TD vAlign="middle" align="right" width="50" height="30">입력일&nbsp;</TD>
													<TD vAlign="middle" align="left" width="100" height="30"><igsch:webdatechooser id="wdcFromDate" runat="server" BorderStyle="Solid" BorderColor="DimGray" Font-Size="9pt"
													...
													<TD vAlign="middle" align="left" width="100" height="30"><igsch:webdatechooser id="wdcToDate" runat="server" BorderStyle="Solid" BorderColor="DimGray" Font-Size="9pt"
															BackColor="#EEEEE9" NullDateLabel=" " MaxDate="2076-06-06" Text=" " Width="100px" Height="20px">
															<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																MaxDate="2076-06-06" ShowTitle="False" ShowFooter="False">
																<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
													...
													<TD vAlign="middle" align="right" width="50" height="30">입고일</TD>
													<TD vAlign="middle" align="left" width="100" height="30"><igsch:webdatechooser id="wdcMinDate" runat="server" BorderStyle="Solid" BorderColor="DimGray" Font-Size="10pt"
															BackColor="#EEEEE9" NullDateLabel=" " Text=" " Width="100px" Height="18px">
															<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
													...
													<TD vAlign="middle" align="center" width="5" height="30">~</TD>
													<TD vAlign="middle" align="left" width="100" height="30"><igsch:webdatechooser id="wdcMaxDate" runat="server" BorderStyle="Solid" BorderColor="DimGray" Font-Size="10pt"
															BackColor="#EEEEE9" NullDateLabel=" " Text=" " Width="100px" Height="18px">
															<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																ShowTitle="False" ShowFooter="False">
																<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
													...
													<TD vAlign="middle" align="right" width="50" height="30">구분&nbsp;</TD>
													<TD vAlign="middle" align="left" width="50" height="30"><asp:dropdownlist id="ddlDivision" runat="server" BackColor="#EEEEE9">
						...
						<TD vAlign="top" align="center" width="800"><br>
							<FIELDSET style="BORDER-BOTTOM: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-TOP: #696969 2px solid; BORDER-RIGHT: #696969 2px solid"><LEGEND align="top">[검색결과]</LEGEND>
								<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800">
									<TR>
										<TD colSpan="6"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Width="100%" Height="406px">
												...
												<Bands>
													<igtbl:UltraGridBand>
														<Columns>
															<igtbl:UltraGridColumn HeaderText="년도" Key="Year" Width="40px" BaseColumnName="Year"></igtbl:UltraGridColumn>
															<igtbl:UltraGridColumn HeaderText="월" Key="Month" Width="30px" BaseColumnName="Month"></igtbl:UltraGridColumn>
															...
															<igtbl:UltraGridColumn HeaderText="공정" Key="ProcessName" Width="60px" BaseColumnName="ProcessName"></igtbl:UltraGridColumn>
															...
															<igtbl:UltraGridColumn HeaderText="입고수" Key="Quantity" Width="60px" Format="###,###,###" BaseColumnName="Quantity">
															...
															<igtbl:UltraGridColumn HeaderText="기준단가" Key="StandardUnitCost" Width="70px" Format="###,###,###" BaseColumnName="StandardUnitCost">
																<CellStyle HorizontalAlign="Right">
																	<Padding Right="4px"></Padding>
																</CellStyle>
															</igtbl:UltraGridColumn>
															<igtbl:UltraGridColumn HeaderText="단가" Key="ApplyUnitCost" Width="50px" Format="###,###,###" BaseColumnName="ApplyUnitCost">
																<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																	<Padding Right="4px"></Padding>
																</CellStyle>
															</igtbl:UltraGridColumn>
