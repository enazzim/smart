<%@ Page language="c#" Codebehind="PaymentPlanResultRegistrationPC.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.EtcPresentCondition.PaymentPlanResultRegistrationPC" %>
...
<HTML>
	<HEAD>
		<title>PaymentPlanResultRegistrationPC</title>
						...
						<FIELDSET style="BORDER-RIGHT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-BOTTOM: #696969 2px solid"><LEGEND align="top">[검색조건]</LEGEND>
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD align="right" width="70" height="30"><FONT face="굴림">지급일자&nbsp;</FONT></TD>
							...
							<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="100%">
								<tr>
									<td colSpan="2" width="100%">
										<igtbl:ultrawebgrid id="uwgPPR_HT" runat="server" Width="800px" Height="428px">
											<DisplayLayout AutoGenerateColumns="False" AllowSortingDefault="Yes" RowHeightDefault="20px" Version="3.00"
												...
												BorderCollapseDefault="Separate" AllowColSizingDefault="Free" RowSelectorsDefault="No" Name="uwgPPRxHT"
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														<igtbl:UltraGridColumn HeaderText="거래처" Key="CompanyName" Width="120px" BaseColumnName="CompanyName">
														...
														<igtbl:UltraGridColumn HeaderText="지급액(부가세)" Key="SupplementaryValueTaxPaymentCost" Format="###,###,###.00"
