	...
	public class RowMaterialRequirementCalculatePC : System.Web.UI.Page
	{
		...
		private DataSet searchButton()
		{
			...
			if(ItemSearchControl1.hdItem.Trim() == "")
				search = new KIT_ERP.Search("RowMaterialRequirementCalculatePC", ItemSearchControl1.ItemNum, ItemSearchControl1.ItemDrawNum, ItemSearchControl1.ItemName, wdcMinDate, wdcMaxDate,wdcFromDate,wdcToDate,ddlItemClassification1.SelectedItem.Value);
			else
				search = new KIT_ERP.Search("RowMaterialRequirementCalculatePC", ItemSearchControl1.ItemNum, "", "", wdcMinDate, wdcMaxDate,wdcFromDate,wdcToDate,ddlItemClassification1.SelectedItem.Value);
