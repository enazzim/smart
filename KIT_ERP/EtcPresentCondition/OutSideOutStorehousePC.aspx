<%@ Page language="c#" Codebehind="OutSideOutStorehousePC.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.EtcPresentCondition.OutSideOutStorehousePC" %>
...
--></SCRIPT>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="GridLayout"
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="PADDING-LEFT: 10px;Z-INDEX: 101;LEFT: 0px;WIDTH: 800px;PADDING-TOP: 10px;POSITION: absolute;TOP: 0px;HEIGHT: 550px"
				...
				<TR>
					<TD height="25">
						<table height="25" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								<TD align="left" width="392" style="WIDTH: 391px"><asp:button id="btnExcel" runat="server" Height="20px" Width="60px" Text="Excel" Font-Size="9pt"></asp:button>&nbsp;<igtblexp:ultrawebgridexcelexporter id="uwgExcel" runat="server"></igtblexp:ultrawebgridexcelexporter></TD>
								<TD align="right" width="181" style="WIDTH: 181px">&nbsp;</TD>
