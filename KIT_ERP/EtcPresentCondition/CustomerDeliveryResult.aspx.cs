...
{
	/// <summary>
	/// CustomerDeliveryResult에 대한 요약 설명입니다.
	/// </summary>
	public class CustomerDeliveryResult : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			CompanySearchControl1.UnitCostDistinction="수주거래처";
		...
		private DataTable ComSearch()
		{
			...
			SqlDataAdapter adap = new SqlDataAdapter("SPSalePC",conn);
		...
		private void btItemSearch_Click(object sender, System.EventArgs e)
		{
			...
			UltraWebGrid2.DisplayLayout.Pager.CurrentPageIndex = 1;
			UltraWebGrid2.DataSource = ItemSearch();
			UltraWebGrid2.DataBind();
		}
        
		private DataTable ItemSearch()
		{
			SqlConnection conn = new SqlConnection(ConfigurationSettings.AppSettings["DSN"]);
			SqlDataAdapter adap = new SqlDataAdapter("SPSaleItemPC",conn);
			adap.SelectCommand.Parameters.Add("@ItemNum",ItemSearchControl1.ItemNum);
			if(ItemSearchControl1.hdItem.Trim() == "")
			{
				adap.SelectCommand.Parameters.Add("@ItemDrawNum",ItemSearchControl1.ItemDrawNum);
