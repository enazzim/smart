	...
	public class SaleHistoryRegistrationPC : System.Web.UI.Page
	{
		...
		private DataSet Search()
		{
			...
			if(ItemSearchControl1.hdItem.Trim() == "")
				search = new Search("SaleHistoryRegistrationPC",ItemSearchControl1.ItemNum,ItemSearchControl1.ItemDrawNum,ItemSearchControl1.ItemName,wdcFromDate,wdcToDate,CSC1.Company,CSC1.BusinessRegistrationNum);
			else
				search = new Search("SaleHistoryRegistrationPC",ItemSearchControl1.ItemNum,"", "",wdcFromDate,wdcToDate,CSC1.Company,CSC1.BusinessRegistrationNum);
