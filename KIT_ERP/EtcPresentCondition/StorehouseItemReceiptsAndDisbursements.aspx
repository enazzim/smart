...
<%@ Page language="c#" Codebehind="StorehouseItemReceiptsAndDisbursements.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.EtcPresentCondition.StorehouseItemReceiptsAndDisbursements" %>
...
<HTML>
	<HEAD>
		<title>StorehouseItemReceiptsAndDisbursements</title>
		...
		function ResettxtBox()
		{
			...
			document.StorehouseItemReceiptsAndDisbursements.ddlEnd.options[0].selected=true;
		}
		//-->
		</script>
	</HEAD>
	<body MS_POSITIONING="GridLayout">
		<form id="StorehouseItemReceiptsAndDisbursements" method="post" runat="server">
					...
					<TD style="HEIGHT: 103px; PADDING-TOP: 10px" vAlign="top" align="center" width="800">
						<FIELDSET style="BORDER-BOTTOM: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-TOP: #696969 2px solid; BORDER-RIGHT: #696969 2px solid"><LEGEND align="top">[검색조건]</LEGEND>
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="800" border="0">
								...
								<TR>
									<TD align="right" width="70" height="30"><FONT face="굴림">수불일자&nbsp;</FONT></TD>
									...
									<td align="right" width="70"><FONT face="굴림">공정명&nbsp; </FONT>
									</td>
									<td align="left" width="100"><FONT face="굴림"><asp:dropdownlist id="ddlEnd" runat="server" BackColor="#EEEEE9" Width="100px"></asp:dropdownlist></FONT></td>
					...
					<TD vAlign="top" align="center" width="800">
						<FIELDSET style="BORDER-BOTTOM: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-TOP: #696969 2px solid; BORDER-RIGHT: #696969 2px solid"><LEGEND align="top">[검색결과]</LEGEND>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800">
								<TR>
									<TD colSpan="6" height="450"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Width="100%" Height="450px">
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="수불처" Key="CompanyName" Width="95px" Format="" BaseColumnName="CompanyName">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="수불사유" Key="HistoryDivision" Width="70px" BaseColumnName="HistoryDivision"></igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="입고량" Key="ReceiveStockQuantity" Width="60px" Format="###,###,###" BaseColumnName="ReceiveStockQuantity">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
															<HeaderStyle Cursor="Hand" VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="출고량" Key="OutStockQuantity" Width="60px" Format="###,###,###" BaseColumnName="OutStockQuantity">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="일자" Key="InOutDate" Width="93px" Format="yyyy-MM-dd" BaseColumnName="InOutDate">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle Cursor="Hand" VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
													</Columns>
