...
<%@ Page language="c#" Codebehind="OrderByDelivery.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.EtcPresentCondition.OrderByDelivery" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>OrderByDelivery</title>
			...
			<TABLE style="Z-INDEX: 101; POSITION: absolute; TOP: 8px; LEFT: 8px" id="Table1" border="0"
				...
				<TR>
					<TD style="PADDING-TOP: 10px" vAlign="top" width="800" align="center">
						<FIELDSET style="BORDER-BOTTOM: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; MARGIN-BOTTOM: 5px; BORDER-TOP: #696969 2px solid; BORDER-RIGHT: #696969 2px solid"><LEGEND align="top">[검색조건]</LEGEND>
							<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="0" width="800">
								...
								<TR>
									<TD height="30" width="70" align="right"><FONT face="굴림">발주일 : &nbsp;</FONT></TD>
									<TD height="30" width="100"><FONT face="굴림"><igsch:webdatechooser id="wdcFromDate" runat="server" NullDateLabel=" " MaxDate="2076-06-06" BorderColor="DimGray"
									...
									<TD height="30" width="100"><FONT face="굴림"><igsch:webdatechooser id="wdcToDate" runat="server" NullDateLabel=" " MaxDate="2076-06-06" BorderColor="DimGray"
												BorderStyle="Solid" Text=" " Font-Size="9pt" BackColor="#EEEEE9" Width="100px" Height="20px">
												<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
													MaxDate="2076-06-06" ShowTitle="False" ShowFooter="False">
													<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
									...
									<td width="100" align="left"><FONT face="굴림"><asp:dropdownlist id="ddlDivision" runat="server" BackColor="#EEEEE9" Width="100px">
												<asp:ListItem Value="구매">구  매</asp:ListItem>
												<asp:ListItem Value="외주">외  주</asp:ListItem>
											</asp:dropdownlist></FONT></td>
									<td width="70" align="right"><FONT face="굴림"></FONT></td>
									<td width="100" align="left"><FONT face="굴림"></FONT></td>
									<TD height="30" width="270" align="right"><FONT face="굴림">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										</FONT>
									</TD>
								</TR>
								<TR>
									<TD height="30" width="70" align="right"><FONT face="굴림">납기일 : &nbsp;</FONT></TD>
									<TD height="30" width="100"><FONT face="굴림"><igsch:webdatechooser id="wdcStartDate" runat="server" NullDateLabel=" " MaxDate="2076-06-06" BorderColor="DimGray"
												BorderStyle="Solid" Text=" " Font-Size="9pt" BackColor="#EEEEE9" Width="100px" Height="20px">
												<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
													MaxDate="2076-06-06" ShowTitle="False" ShowFooter="False">
													<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
									...
									<TD height="30" width="15" align="center"><FONT face="굴림">~</FONT></TD>
									<TD height="30" width="100"><FONT face="굴림"><igsch:webdatechooser id="wdcEndDate" runat="server" NullDateLabel=" " MaxDate="2076-06-06" BorderColor="DimGray"
												BorderStyle="Solid" Text=" " Font-Size="9pt" BackColor="#EEEEE9" Width="100px" Height="20px">
												<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
													MaxDate="2076-06-06" ShowTitle="False" ShowFooter="False">
													<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
									...
									<TD height="30" width="270" align="right"><INPUT style="Z-INDEX: 0; WIDTH: 65px; HEIGHT: 20px" id="btnReset" onclick="javascript:ResettxtBox()"
											value="초기화" type="button" name="btnReset"><FONT face="굴림">&nbsp; </FONT>
										<asp:button id="btItemSearch" runat="server" Text="검 색" Width="60px" Height="20px" style="Z-INDEX: 0"></asp:button></TD>
								</TR>
							</TABLE>
				...
				<TR>
					<TD vAlign="top" width="800" align="center">
						<FIELDSET style="BORDER-BOTTOM: #696969 2px solid; BORDER-LEFT: #696969 2px solid; MARGIN-TOP: 5px; WIDTH: 100%; HEIGHT: 107px; BORDER-TOP: #696969 2px solid; BORDER-RIGHT: #696969 2px solid"><LEGEND align="top">[검색결과]</LEGEND>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800">
								<TR>
									<TD height="450" colSpan="6"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Width="100%" Height="446px">
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														<igtbl:UltraGridColumn HeaderText="납기요구일" Key="DeliveryRequestDate" Hidden="True" Format="yyyy-MM-dd" BaseColumnName="DeliveryRequestDate"></igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="기종" Key="Model" Width="70px" BaseColumnName="Model"></igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="공정" Key="ProcessName" Width="50px" Hidden="True" BaseColumnName="ProcessName">
															<CellStyle HorizontalAlign="Center"></CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="단위" Key="Unit" Width="50px" Hidden="True" BaseColumnName="Unit">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle Cursor="Hand" VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="규격" Key="Standard" Width="150px" Hidden="True" BaseColumnName="Standard">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Left"></CellStyle>
														</igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="등록자" Key="OrderPerson" BaseColumnName="OrderPerson"></igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="입고단가" Key="DeliveryUnitCost" Width="70px" Format="###,###,###" BaseColumnName="DeliveryUnitCost">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="입고금액" Key="DeliveryTotalCost" Width="90px" Format="###,###,###" BaseColumnName="DeliveryTotalCost">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
														</igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="+/-량" Key="QuantityDiffer" Format="###,###,###" BaseColumnName="QuantityDiffer">
															<CellStyle HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
															<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="+/-금액" Key="CostDiffer" Format="###,###,###.##" BaseColumnName="CostDiffer">
															<CellStyle HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
