<%@ Page language="c#" Codebehind="ProductionPlanPC.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.EtcPresentCondition.ProductionPlanPC" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800" border="0">
											...
											<Bands>
												<igtbl:UltraGridBand AllowUpdate="RowTemplateOnly">
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="불륨번호" Key="VolumNum" BaseColumnName="VolumNum">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
								...
								<TR>
									<td><FONT face="굴림">&nbsp;</FONT><asp:button id="btnExcel" runat="server" Font-Size="10pt" Width="60px" Height="20px" Text="Excel"
											CommandName="Excel" Enabled="False"></asp:button><igtblexp:ultrawebgridexcelexporter id="uwgExcel" runat="server"></igtblexp:ultrawebgridexcelexporter></td>
									<TD style="HEIGHT: 46px" vAlign="middle" align="right" colSpan="2"><FONT face="굴림">&nbsp;&nbsp;&nbsp;
										</FONT><FONT face="굴림">&nbsp;&nbsp;&nbsp; </FONT><FONT face="굴림">&nbsp;</FONT></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
