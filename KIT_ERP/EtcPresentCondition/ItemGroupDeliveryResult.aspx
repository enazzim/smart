<%@ Page language="c#" Codebehind="ItemGroupDeliveryResult.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.EtcPresentCondition.ItemGroupDeliveryResult" %>
					...
					<TD style="HEIGHT: 103px; PADDING-TOP: 10px" vAlign="top" align="center" width="800">
						<FIELDSET style="BORDER-BOTTOM: #696969 2px solid; BORDER-LEFT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-RIGHT: #696969 2px solid"><LEGEND align="top">[검색조건]</LEGEND>
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD style="HEIGHT: 30px" align="left" width="800" colSpan="8" height="30"><FONT face="굴림">
								...
								<TR>
									<TD style="HEIGHT: 30px" align="left" width="800" colSpan="8" height="30">
										<table id="Table5" cellSpacing="0" cellPadding="0" width="800">
											<TR>
												...
												<TD style="HEIGHT: 30px" align="right" width="70" height="30">매출일자&nbsp;</TD>
												...
												<TD style="HEIGHT: 30px" align="right" width="315" colSpan="2" height="30"><FONT face="굴림"><INPUT id="btnReset" style="WIDTH: 65px; HEIGHT: 20px" onclick="javascript:ResettxtBox()"
														...
														<asp:button id="btItemGroupSearch" runat="server" Text="검 색" Width="60px" Height="20px"></asp:button>&nbsp;&nbsp;
													</FONT>
												</TD>
											</TR>
										</table>
