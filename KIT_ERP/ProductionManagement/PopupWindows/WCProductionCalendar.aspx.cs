...
{
	/// <summary>
	/// WCProductionCalendar에 대한 요약 설명입니다.
	/// </summary>
	public class WCProductionCalendar : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Label year;
		...
		//protected KIT_ERP.ProductionManagement.PopupWindows.dsCalendar dsCalendar1;
		...
		protected KIT_ERP.ProductionManagement.PopupWindows.dsCalendar dsCalendar1;
		protected System.Web.UI.WebControls.Label day;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!Page.IsPostBack)
			{
				...
				dl_Year.SelectedIndex = int.Parse(DateTime.Now.Year.ToString())-2004;
		...
		{    
			...
			this.dsCalendar1 = new KIT_ERP.ProductionManagement.PopupWindows.dsCalendar();
			...
			this.sqlDeleteCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Original_Content", System.Data.SqlDbType.NVarChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "Content", System.Data.DataRowVersion.Original, null));
			...
			// conn
			// 
			this.conn.ConnectionString = "workstation id=LHD;packet size=4096;user id=sa;data source=\"220.66.115.9\";persist" +
				" security info=True;initial catalog=daea_ERP;password=\"ezsys#0509\"";
			// 
			// sqlInsertCommand1
			// 
			...
			this.sqlInsertCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Content", System.Data.SqlDbType.NVarChar, 50, "Content"));
			...
			this.sqlSelectCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@name", System.Data.SqlDbType.NVarChar, 50, "WCName"));
			// 
			// sqlUpdateCommand1
			// 
			...
			this.sqlUpdateCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Content", System.Data.SqlDbType.NVarChar, 50, "Content"));
			...
			this.sqlUpdateCommand1.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Original_Content", System.Data.SqlDbType.NVarChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "Content", System.Data.DataRowVersion.Original, null));
		...
		private void bt_Select_Click(object sender, System.EventArgs e)
		{
			if(dl_WCName.SelectedIndex == 0)
			{
				...
				Response.Write("alert('작업장을 선택해주세요');");
			...
			else
			{
				...
				//작업장의 월이 선택되어지면 자동으로 1일로 포커스를 준다.
		...
		private void bt_Update_Click(object sender, System.EventArgs e)
		{
			...
			{
				Response.Write("<script language=javascript>");
				Response.Write("alert('날짜를 선택해주세요');");
				Response.Write("</script>");
			}
			else if(dl_WCName.SelectedItem.Value == "")
			{
				Response.Write("<script language=javascript>");
				Response.Write("alert('WC를 선택해주세요');");
				Response.Write("</script>");
			}
			else
			{
				...
				arr.Add(int.Parse(year.Text));
				arr.Add(int.Parse(mon.Text));
				arr.Add(int.Parse(day.Text));
				arr.Add(Decimal.Parse(tb_Time.Text));
				arr.Add(tb_Content.Text);
				arr.Add(int.Parse(lb_Index.Text));

				KIT_ERP.BasisInformation.MasterInfoRecordRUD rud = new KIT_ERP.BasisInformation.MasterInfoRecordRUD("WCProductionCalendarInfo","Update","PCI_MT",(int)PageName.WCProductionCalendarInfo,Session["ID"].ToString(),arr,"낱개입력");
				rud.ActivateRUD();
				...
				year.Text = 	Calendar1.SelectedDate.Year.ToString();				
				mon.Text = Calendar1.SelectedDate.Month.ToString();
				day.Text =Calendar1.SelectedDate.Day.ToString();
		...
		private void Find_Index()
		{
			...
			comm.Parameters.Add("@year", SqlDbType.VarChar).Value = year.Text;
			comm.Parameters.Add("@month", SqlDbType.VarChar).Value = mon.Text;
			comm.Parameters.Add("@day", SqlDbType.VarChar).Value = day.Text;
		...
		private void Calendar1_SelectionChanged(object sender, System.EventArgs e)
		{
			...
			{ 
				...
				if(dr["WC_Year"].ToString() == year.Text && dr["WC_Month"].ToString() == mon.Text &&
					dr["WC_Day"].ToString() == day.Text)
				{
