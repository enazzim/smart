...
{
	/// <summary>
	/// RowMaterialRequirement에 대한 요약 설명입니다.
	/// </summary>
	public class RowMaterialRequirement : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if(!Page.IsPostBack)
			{
				wdcDate.NullDateLabel = DateTime.Today.ToShortDateString();
		...
		private void button_Click(object sender, System.EventArgs e)
		{
			...
			if(button.ID.ToString() == "btnOK")
			{
				...
				{
					Response.Write("<script>alert('납기일자를 입력하세요!');</script>");
				}
				else
				{
					DataSet dsRowMaterial1 = (KIT_ERP.ProductionManagement.dsRowMaterial)Session["dataSet"];
