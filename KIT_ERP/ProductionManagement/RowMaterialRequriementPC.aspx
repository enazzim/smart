...
<%@ Page language="c#" Codebehind="RowMaterialRequriementPC.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ProductionManagement.RowMaterialRequriementPC" %>
						...
						<TD vAlign="top" align="center" width="800">
							...
							<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; FONT-SIZE: 9pt; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid"><LEGEND align="top">[검색결과]</LEGEND>
								<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800" border="0">
									<TR>
										<TD style="HEIGHT: 28px" width="70%" height="28"><asp:linkbutton id="lnkRowUpDate" runat="server"></asp:linkbutton></TD>
													...
													<Bands>
														<igtbl:UltraGridBand AllowUpdate="RowTemplateOnly">
															<Columns>
																...
																<igtbl:UltraGridColumn HeaderText="품목번호" Key="ItemNum" Width="130px" HeaderClickAction="SortMulti" BaseColumnName="ItemNum">
																...
																<igtbl:UltraGridColumn HeaderText="거래처" Key="CompanyName" HeaderClickAction="SortMulti" BaseColumnName="CompanyName"></igtbl:UltraGridColumn>
																...
																<igtbl:UltraGridColumn HeaderText="현재고" Key="NowStockQuantity" Width="60px" Format="###,###,###" BaseColumnName="NowStockQuantity">
																	<CellStyle HorizontalAlign="Right">
																		<Padding Right="4px"></Padding>
																	</CellStyle>
																</igtbl:UltraGridColumn>
																<igtbl:UltraGridColumn HeaderText="총구매량" Key="OrderQuantity" Width="72px" Format="###,###,##0.00" BaseColumnName="OrderQuantity">
																	<CellStyle VerticalAlign="Middle" HorizontalAlign="Right"></CellStyle>
																	<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
																</igtbl:UltraGridColumn>
																...
																<igtbl:UltraGridColumn HeaderText="납기일자" Key="FirstDeliveryDemandDate" Width="80px" Format="yyyy-MM-dd"
															...
															<RowEditTemplate>
																<P align="center">
																	<TABLE id="Table5" style="BORDER-TOP-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px; BORDER-LEFT-COLOR: dimgray; BORDER-BOTTOM-WIDTH: 1px; BORDER-BOTTOM-COLOR: dimgray; BORDER-TOP-COLOR: dimgray; BORDER-RIGHT-WIDTH: 1px; BORDER-RIGHT-COLOR: dimgray"
																		cellSpacing="0" cellPadding="0" width="800" align="center" bgColor="aliceblue" border="0">
																		<TR>
																			<TD align="right" width="130" height="30">
																				<asp:Label id="Label19" runat="server" Font-Size="9pt">품목번호 </asp:Label><FONT face="굴림">&nbsp;</FONT></TD>
																			<TD style="WIDTH: 131px; HEIGHT: 30px" height="30">
																				<asp:TextBox id="TextBox1" runat="server" BorderColor="DimGray" BorderStyle="Solid" BackColor="WhiteSmoke"
																					Width="130px" Height="20px" ReadOnly="True" ColumnKey="ItemNum" BorderWidth="1px"></asp:TextBox></TD>
																			<TD align="right" width="120" height="30">
																				<asp:Label id="Label18" runat="server" Font-Size="9pt">도면번호 </asp:Label>&nbsp;<FONT face="굴림"></FONT></TD>
																			<TD style="WIDTH: 151px; HEIGHT: 30px" height="30">
																				<asp:TextBox id="TextBox2" runat="server" BorderColor="DimGray" BorderStyle="Solid" BackColor="WhiteSmoke"
																					Width="130px" Height="20px" ReadOnly="True" ColumnKey="ItemDrawNum" BorderWidth="1px"></asp:TextBox></TD>
																			<TD align="right" width="120" height="30">
																				<asp:Label id="Label14" runat="server" Font-Size="9pt">품목명 </asp:Label><FONT face="굴림">&nbsp;</FONT></TD>
																			<TD style="HEIGHT: 30px" height="30">
																				<asp:TextBox id="TextBox3" runat="server" BorderColor="DimGray" BorderStyle="Solid" BackColor="WhiteSmoke"
																					Width="130px" Height="20px" ReadOnly="True" ColumnKey="ItemName" BorderWidth="1px"></asp:TextBox></TD>
																		</TR>
																		<TR>
																			<TD align="right" height="30">
																				<asp:Label id="Label15" runat="server" Font-Size="9pt">총구매량 </asp:Label><FONT face="굴림">&nbsp;</FONT></TD>
																			<TD style="WIDTH: 131px" height="30"><INPUT onkeypress="if(event.keyCode==13){return false;}" id="OrderQuanatity" onkeydown="OnKeyDown_Float(this);"
																					onblur="OnBlur_Cur(this);" onkeyup="Process(); OnKeyUp_Currency(this);" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; WIDTH: 130px; BORDER-BOTTOM: dimgray 1px solid; HEIGHT: 20px; BACKGROUND-COLOR: whitesmoke; TEXT-ALIGN: right"
																					onfocus="OnFocus_Obj(this);" type="text">
																			<TD align="right" height="30">
																				<asp:Label id="Label16" runat="server" Font-Size="9pt">납기일</asp:Label>&nbsp;<FONT face="굴림"></FONT></TD>
																			<TD style="WIDTH: 151px" height="30">
																				<igtxt:WebDateTimeEdit id="wdeFirstDeliveryDemandDate" runat="server" BorderColor="DimGray" BorderStyle="Solid"
																					BackColor="WhiteSmoke" Width="105px" Height="20px" BorderWidth="1px" DisplayModeFormat="d" UseBrowserDefaults="False"
																			...
																			<TD align="right" height="30">
																				<asp:Label id="Label17" runat="server" Font-Size="9pt">금액 </asp:Label><FONT face="굴림">&nbsp;</FONT></TD>
									...
									<TR>
										...
										<TD vAlign="middle" align="right" colSpan="2" width="300" height="35"><asp:button id="btnDelete" runat="server" Font-Size="9pt" Height="20px" Width="60px" Text="삭   제"
												CommandName="Delete" Enabled="False" BorderStyle="Outset"></asp:button><FONT face="굴림">&nbsp;&nbsp;
											</FONT>
											<asp:button id="btnCancle" runat="server" Font-Size="9pt" Height="20px" Width="60px" Text="취   소"
												CommandName="Cancle" Enabled="False" BorderStyle="Outset"></asp:button><FONT face="굴림">&nbsp;&nbsp;
											</FONT>
											<asp:button id="btnStop" runat="server" Font-Size="9pt" Height="20px" Width="60px" Text="중   단"
												CommandName="Stop" Enabled="False" BorderStyle="Outset"></asp:button>&nbsp;</TD>
									</TR>
								</TABLE>
							</FIELDSET>
						</TD>
