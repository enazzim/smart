<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ItemSearchControl.ascx.cs" Inherits="KIT_ERP.ProductionManagement.ItemSearchControl.ItemSearchControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<!--
	function openPopup(id, controlName, propertyClassification, businessRegistrationNum, unitcostDistinction)
	{
		...
		arr = window.showModalDialog
			("../ItemSearchControl/popUp_ItemSearch.aspx?tag="+ controlName + "&value=" + value + "&propertyClassification=" + propertyClassification + "&businessregistrationnum=" + businessRegistrationNum + "&unitcostdistinction=" + unitcostDistinction ,"f", "dialogHeight: 400px; dialogWidth: 807px; center: yes; help: no; resizable: no; status: no;");
