...
<%@ Page language="c#" Codebehind="RowMaterialRequirementCalculatePC.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ProductionManagement.RowMaterialRequirementCalculatePC" codePage="949" %>
...
<HTML>
	...
	<body bgColor="#f7f6f6" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
											...
											<Bands>
												<igtbl:UltraGridBand AllowUpdate="No">
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="자재산출" Key="RowMaterialCalculation" Width="70px" BaseColumnName="RowMaterialCalculation">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="불륨" Key="VolumNum" Width="50px" Hidden="True" BaseColumnName="VolumNum">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
			...
			<INPUT id="hidOrderRequestStandbyUsed" style="Z-INDEX: 107; LEFT: 408px; WIDTH: 64px; POSITION: absolute; TOP: 600px; HEIGHT: 22px"
				type="hidden" size="5" name="Hidden1" runat="server"><INPUT id="hidSafeyRowMaterialUsed" style="Z-INDEX: 106; LEFT: 336px; WIDTH: 64px; POSITION: absolute; TOP: 608px; HEIGHT: 22px"
				type="hidden" size="5" name="Hidden1" runat="server"><INPUT id="hidOrderNonInStorehouseUsed" style="Z-INDEX: 104; LEFT: 264px; WIDTH: 64px; POSITION: absolute; TOP: 608px; HEIGHT: 22px"
				type="hidden" size="5" name="Hidden1" runat="server"><INPUT id="hidOrderGapInStorehouseUsed" style="Z-INDEX: 103; LEFT: 192px; WIDTH: 64px; POSITION: absolute; TOP: 608px; HEIGHT: 22px"
				type="hidden" size="5" name="Hidden1" runat="server"><INPUT id="hidMinimumGapUsed" style="Z-INDEX: 102; LEFT: 120px; WIDTH: 64px; POSITION: absolute; TOP: 608px; HEIGHT: 22px"
				type="hidden" size="5" name="hidMinimumGapUsed" runat="server"> <INPUT id="hidPresentRowMaterialUsed" style="Z-INDEX: 101; LEFT: 32px; WIDTH: 64px; POSITION: absolute; TOP: 600px; HEIGHT: 22px"
