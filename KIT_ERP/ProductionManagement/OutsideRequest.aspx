...
<%@ Page language="c#" Codebehind="OutsideRequest.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ProductionManagement.OutsideRequest" codePage="949" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>OutsideRequest</title>
	...
	<body MS_POSITIONING="GridLayout" BGCOLOR="#f7f6f6">
		<form id="Form1" method="post" runat="server">
			<TABLE style="PADDING-LEFT: 10px; Z-INDEX: 101; LEFT: 0px; WIDTH: 800px; PADDING-TOP: 10px; POSITION: absolute; TOP: 0px; HEIGHT: 550px"
				cellSpacing="0" cellPadding="0" id="Table1" height="550" width="800" border="0">
				<tr>
					<td>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; FONT-SIZE: 9pt; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid"><LEGEND align="top">[검색조건]</LEGEND>
							<TABLE id="Table2" height="35" cellSpacing="0" cellPadding="0" width="800" border="0" DESIGNTIMEDRAGDROP="66">
								<TR>
									<TD vAlign="middle" align="left" colSpan="8" height="30" width="800">
										<table id="table10" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<td align="left" valign="middle" width="630"><uc1:ItemSearchControl id="ItemSearchControl1" runat="server"></uc1:ItemSearchControl></td>
								...
								<TR>
									<TD vAlign="middle" align="right" width="80" height="30">의뢰일&nbsp;
									</TD>
									<TD vAlign="middle" align="left" width="100" height="30">
										<igsch:webdatechooser id="wdc_FromDate" runat="server" Width="100px" Height="18px" Text=" " Font-Size="10pt"
									...
									<TD vAlign="middle" align="left" width="100" height="30">
										<igsch:webdatechooser id="wdc_ToDate" runat="server" Width="100px" Height="18px" Text=" " Font-Size="10pt"
											BackColor="#EEEEE9" BorderStyle="Solid" BorderColor="DimGray" NullDateLabel=" ">
											<EditStyle>
									...
									<TD vAlign="middle" align="right" colSpan="4" height="30" width="515">
										<asp:button id="bt_Clear" runat="server" Width="60px" Height="20px" Text="초기화" Font-Size="10pt"></asp:button>&nbsp;
										<asp:button id="bt_Search" runat="server" Width="60px" Height="20px" Text="검   색" Font-Size="10pt"></asp:button>&nbsp;&nbsp;
									</TD>
								</TR>
								<TR>
									<TD vAlign="middle" align="right" colSpan="8" height="8" width="800"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</td>
				...
				<tr>
					<td>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; FONT-SIZE: 9pt; BORDER-LEFT: dimgray 2px solid; WIDTH: 100%; BORDER-BOTTOM: dimgray 2px solid"><LEGEND align="top">[검색결과]</LEGEND>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800" border="0">
								<TR>
									<TD style="FONT-SIZE: 0pt; HEIGHT: 363px" vAlign="top" align="center" colSpan="3">
										<igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Height="410px" Width="100%">
											<DisplayLayout StationaryMargins="Header" AutoGenerateColumns="False" AllowSortingDefault="OnClient"
												...
												<Pager PageSize="20" PagerAppearance="Both">
												...
												<FrameStyle Width="100%" Cursor="Default" BorderWidth="1px" Font-Size="9pt" Font-Names="굴림"
													BorderColor="DimGray" BorderStyle="Solid" BackColor="Silver" Height="410px"></FrameStyle>
												...
												<RowStyleDefault Cursor="Hand" BorderWidth="1px" Font-Names="굴림" BorderColor="Gray" BorderStyle="Solid"
													ForeColor="Black" BackColor="#EBEFF6">
											...
											<Bands>
												<igtbl:UltraGridBand AllowUpdate="No">
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="공정순서" Key="ProcessSequenceNum" Width="80px" BaseColumnName="ProcessSequenceNum">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
														</igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="작업계획수량" Key="WorkPlanQuantity" Width="86px" Format="###,###,###" BaseColumnName="WorkPlanQuantity">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="작업완료수량" Key="WorkCompletionQuantity" Hidden="True" Format="###,###,###.##"
														...
														<igtbl:UltraGridColumn HeaderText="작업계획번호" Key="WCDailyWorkPlanHistoryIndex" Hidden="True" BaseColumnName="WCDailyWorkPlanHistoryIndex">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
														</igtbl:UltraGridColumn>
													</Columns>
								...
								<TR>
									<TD align="right" vAlign="middle" colspan="3" height="30"><INPUT id="chkAll" style="WIDTH: 40px; HEIGHT: 22px" type="hidden" size="1" value="true"
											name="Hidden1" runat="server">
										<asp:button id="bt_Request" runat="server" Font-Size="10pt" Height="20px" Width="60px" Text="의   뢰"></asp:button>&nbsp;</TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</td>
