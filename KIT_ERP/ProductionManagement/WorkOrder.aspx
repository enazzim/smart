...
<%@ Page language="c#" Codebehind="WorkOrder.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ProductionManagement.WorkOrder" codePage="949" %>
...
<HTML>
	<HEAD>
		...
		function RegistCheck()
		{
			if ( MonthCloseing == "0" )
			{
				return ( confirm("선택한 품목을 작업지시 하시겠습니까?") );	
			}
			else
			{
				alert('월 마감되어 작업지시할 수 없습니다.');
				return false;
			}
		}
		...
		function TextBox_Reset()
		{
			...
			frm.dl_ProcessCode.options[0].selected = true;
		}
		
		function openpopup()
		{
			window.open("PopupWindows/WorkOrder_Pop.aspx","","width = 710,scrollbars=yes,menubar=yes,status=no,toolbar=yes,center=yes");								
		}
--></SCRIPT>
	</HEAD>
	<body>
			...
			<TABLE id="Table1" style="LEFT: 10px; POSITION: absolute; TOP: 10px" cellSpacing="0" cellPadding="0"
							...
							<TABLE id="Table2" height="40" cellSpacing="0" cellPadding="0" width="800" align="center"
								...
								<TR>
									...
									<TD height="28"><igcmbo:webcombo id="wcWCName" runat="server" Height="20px" Width="120px" BackColor="#EEEEE9" SelBackColor="10, 36, 106"
											...
											<DropDownLayout DropdownWidth="365px" RowSelectors="No" RowHeightDefault="20px" HeaderClickAction="Select"
												DropdownHeight="350px" TableLayout="Fixed" StationaryMargins="Header">
									...
									<TD align="right" height="28">공정명&nbsp;
									</TD>
									<TD align="left" height="28">
										<asp:dropdownlist id="dl_ProcessCode" runat="server" Width="110px" Height="8px" BackColor="#EEEEE9"
											Font-Size="10pt">
					...
					<TD vAlign="top" align="center" colSpan="2">
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; FONT-WEIGHT: normal; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%"
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800" align="center">
								<TR height="35">
									<TD vAlign="top" align="center" rowSpan="1"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Height="406px" Width="800px">
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="도면번호" Key="ItemDrawNum" Width="140px" Hidden="True" BaseColumnName="ItemDrawNum"></igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="품목명" Key="ItemName" Width="140px" BaseColumnName="ItemName"></igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="순서" Key="ProcessSequenceNum" Width="60px" BaseColumnName="ProcessSequenceNum">
														...
														<igtbl:UltraGridColumn HeaderText="작업구분" Key="WorkDistinction" Width="70px" Hidden="True" Format="" BaseColumnName="WorkDistinction">
															<CellStyle HorizontalAlign="Left"></CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="계획수량" Key="WorkPlanQuantity" Width="100px" Format="###,###,##0.00" BaseColumnName="WorkPlanQuantity">
															<CellStyle HorizontalAlign="Right"></CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="완료수량" Key="WorkCompletionQuantity" Format="###,###,##0.00" BaseColumnName="WorkCompletionQuantity">
															<CellStyle HorizontalAlign="Right"></CellStyle>
														</igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="납기요구일" Key="DeliveryDate" BaseColumnName="DeliveryDate"></igtbl:UltraGridColumn>
				...
				<TR>
					...
					<TD align="left" height="30">&nbsp;
						<asp:button id="Button1" runat="server" Height="20px" Width="65px" Text="Excel"></asp:button>
						<igtblexp:UltraWebGridExcelExporter id="UltraWebGridExcelExporter1" runat="server"></igtblexp:UltraWebGridExcelExporter></TD>
					<TD align="right" height="30"><INPUT id="chkAll" style="WIDTH: 48px; HEIGHT: 21px" type="hidden" size="2" value="true">&nbsp;
						<asp:button id="Button2" runat="server" Text="작업지시"></asp:button>&nbsp;&nbsp;
					</TD>
				</TR>
			</TABLE>
		</form>
