<%@ Page language="c#" Codebehind="DeliveryResult.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BuyingOutside.DeliveryResult" %>
...
<HTML>
	...
	<body ms_positioning="GridLayout">
		<form id="DeliveryResult" method="post" runat="server">
					...
					<TD style="PADDING-TOP: 10px; HEIGHT: 103px" vAlign="top" align="center" width="800">
						<FIELDSET style="BORDER-RIGHT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-BOTTOM: #696969 2px solid"><LEGEND align="top">[검색조건]</LEGEND>
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="800" border="0">
								<TR>
									<TD style="HEIGHT: 30px" align="right" width="70" height="30"><FONT face="굴림">거래처&nbsp; </FONT>
									</TD>
									<TD style="HEIGHT: 30px" align="left" width="100" height="30"><FONT face="굴림"><igcmbo:webcombo id="wcCompany" runat="server" Height="20px" Width="100px" BackColor="#EEEEE9" Font-Size="9pt"
												BorderColor="DimGray" BorderStyle="Solid" Version="3.00" BorderWidth="1px" ForeColor="Black" DropImageXP1="/ig_common/WebGrid3/ig_cmboDown1.bmp" DropImageXP2="/ig_common/WebGrid3/ig_cmboDown2.bmp"
								...
								<TR>
									<TD align="right" width="70" height="30"><FONT face="굴림">발주일자&nbsp;</FONT></TD>
					...
					<TD vAlign="top" align="center" width="800">
						<FIELDSET style="BORDER-RIGHT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-BOTTOM: #696969 2px solid"><LEGEND align="top">[검색결과]</LEGEND>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800">
								<TR>
									<TD colSpan="6" height="450"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Height="450px" Width="800px">
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="공정명" Key="ProcessName" Width="98px" BaseColumnName="ProcessName">
															<CellStyle HorizontalAlign="Center"></CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="발주일자" Key="DeliveryDate" Width="100px" Format="yyyy-MM-dd" BaseColumnName="DeliveryDate">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="발주수량" Key="OrderQuantity" Width="80px" Format="###,###,###" BaseColumnName="OrderQuantity">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
															<HeaderStyle Cursor="Hand" VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="입고량" Key="InOrderQuantity" Width="80px" Format="###,###,###" BaseColumnName="InOrderQuantity">
															<CellStyle HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="미납량" Key="RemainQuantity" Width="80px" Format="###,###,###" BaseColumnName="RemainQuantity">
															<CellStyle HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="단가" Key="ApplyUnitCost" Width="90px" Hidden="True" Format="###,###,###"
															BaseColumnName="ApplyUnitCost">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="총 금액" Key="TotalCost" Width="148px" Hidden="True" Format="###,###,###"
