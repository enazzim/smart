...
<HTML>
	<HEAD>
		...
		function UltraWebGrid1_AfterRowTemplateOpenHandler(gridName, rowId)
		{
			...
			//이전크레임금액
			document.ClaimPC.lb_Cost.value = row.getCellFromKey("ClaimCost").getValue();//기존금액
			
			document.ClaimPC.igtbl_TextBox_0_7.value = MakeCommaSeparate(row.getCellFromKey("ClaimQuantity").getValue());//수량
			document.ClaimPC.igtbl_TextBox_0_8.value = MakeCommaSeparate(row.getCellFromKey("ClaimCost").getValue());//금액
					...
					<TD vAlign="top" align="center" width="800"><FONT face="굴림">
							<FIELDSET style="BORDER-RIGHT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 800px; BORDER-BOTTOM: #696969 2px solid; HEIGHT: 48px"><LEGEND align="top">[검색조건]</LEGEND>
								<TABLE id="Table2" style="HEIGHT: 28px" cellSpacing="0" cellPadding="0" width="800">
									<TR>
										<TD align="left" width="200" height="30" colSpan="2"><FONT face="굴림">
									...
									<TR>
										<td colspan="5" width="800">
											<table id="t" cellpadding="0" cellspacing="0" border="0" width="800">
												<tr>
													<td width="70" height="30" align="right"><FONT face="굴림">접수일&nbsp; </FONT>
													</td>
														...
														<P align="center">
															<TABLE id="Table3" style="HEIGHT: 80px" cellSpacing="0" cellPadding="0" width="800" border="0">
																...
																<TR>
																	...
																	<TD align="left"><FONT face="굴림"><INPUT id="igtbl_TextBox_0_7" onkeydown="OnKeyDown_Float(this);" onkeyup="OnKeyUp_Currency(this);"
																	...
																	<TD align="left"><FONT face="굴림"><INPUT id="igtbl_TextBox_0_8" onkeydown="OnKeyDown_Float(this);" onkeyup="OnKeyUp_Currency(this);"
																				onblur="OnBlur_Cur(this);" onfocus="OnFocus_Obj(this);" style="TEXT-ALIGN: right; WIDTH: 150px; BACKGROUND-COLOR: #eeeee9"
