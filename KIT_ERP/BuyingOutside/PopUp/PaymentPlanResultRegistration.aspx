...
<HTML>
	<HEAD>
		...
		function Process()	
		{
			var Tax = Number(RemoveComma(document.Form1.tb_ItemPaymentCost.value))/10;
			var Tax1 = (Math.round(Tax,1));
			document.Form1.tb_SupplementaryValueTaxPaymentCost.value = MakeCommaSeparate((Math.round((Tax1 * 10000)) / 10000));
		}
...
//////////////////////////////////////////////////////////////////////////////////////////
		...
		function uwgP_HT_DblClickHandler(gridName, cellId){
			...
			document.Form1.tb_ItemPaymentCost.value = row.getCellFromKey("ItemPaymentCost").getValue();//그리드에서 선택한 수금액(물품대)을 넣음		
			document.Form1.lbOldCost.value = row.getCellFromKey("ItemPaymentCost").getValue();
			
			document.Form1.tb_SupplementaryValueTaxPaymentCost.value = row.getCellFromKey("SupplementaryValueTaxPaymentCost").getValue();//그리드에서 선택한 지급액(부가세)을 넣음		
							...
							<TABLE style="WIDTH: 800px; HEIGHT: 42px" cellSpacing="0" cellPadding="0" width="800">
								...
								<TR>
									...
									<TD style="WIDTH: 246px; HEIGHT: 26px">
										<asp:textbox id="tb_ItemPaymentCost" style="TEXT-ALIGN: right" runat="server" BorderColor="DimGray"
											BorderStyle="Solid" Height="20px" BackColor="#EEEEE9" Font-Size="9pt" Width="110px" BorderWidth="1px">0</asp:textbox></TD>
									<TD style="WIDTH: 126px; HEIGHT: 26px" align="right"><FONT face="굴림" size="2">지급액(부가세)&nbsp;</FONT></TD>
									<TD style="WIDTH: 3px; HEIGHT: 26px">
										<asp:textbox id="tb_SupplementaryValueTaxPaymentCost" style="TEXT-ALIGN: right" runat="server"
											BorderColor="DimGray" BorderStyle="Solid" Height="20px" BackColor="#EEEEE9" Font-Size="9pt"
											Width="110px" BorderWidth="1px">0</asp:textbox></TD>
									<TD style="WIDTH: 196px; HEIGHT: 26px" align="right"><FONT face="굴림" size="2">미지급액&nbsp;</FONT></TD>
									<TD style="HEIGHT: 26px" align="right"><asp:textbox id="txtEvidence" runat="server" Width="110px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt" BorderStyle="Solid" BorderWidth="1px" BorderColor="DimGray" ReadOnly="True" style="TEXT-ALIGN: right"></asp:textbox></TD>
								</TR>
								<TR>
