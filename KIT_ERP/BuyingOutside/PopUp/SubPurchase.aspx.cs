...
{
	/// <summary>
	/// SubPurchase에 대한 요약 설명입니다.
	/// </summary>
	public class SubPurchase : System.Web.UI.Page
	{
		...
		private void First()
		{
			...
			Label5.Text = " ";
			Label6.Text = " ";
			Label7.Text = String.Format("{0:#,###}",uwg.Rows[0].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label8.Text = DateTime.Parse(uwg.Rows[0].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[0].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[0].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Second()
		{
			...
			Label13.Text = " ";	// 규격
			Label14.Text = " ";		// 단위	
			Label15.Text = String.Format("{0:#,###}",uwg.Rows[1].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label16.Text = DateTime.Parse(uwg.Rows[1].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[1].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[1].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Third()
		{
			...
			Label21.Text = " ";		// 규격
			Label22.Text = " ";			// 단위	
			Label23.Text = String.Format("{0:#,###}",uwg.Rows[2].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label24.Text = DateTime.Parse(uwg.Rows[2].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[2].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[2].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Fourth()
		{
			...
			Label29.Text = " ";		// 규격
			Label30.Text = " ";		// 단위	
			Label31.Text = String.Format("{0:#,###}",uwg.Rows[3].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label32.Text = DateTime.Parse(uwg.Rows[3].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[3].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[3].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Fifth()
		{
			...
			Label37.Text = " ";		// 규격
			Label38.Text = " ";		// 단위	
			Label39.Text = String.Format("{0:#,###}",uwg.Rows[4].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label40.Text = DateTime.Parse(uwg.Rows[4].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[4].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[4].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Sixth()
		{
			...
			Label45.Text = " ";	// 규격
			Label46.Text = " ";		// 단위	
			Label47.Text = String.Format("{0:#,###}",uwg.Rows[5].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label48.Text = DateTime.Parse(uwg.Rows[5].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[5].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[5].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Seventh()
		{
			...
			Label53.Text = " ";		// 규격
			Label54.Text = " ";		// 단위	
			Label55.Text = String.Format("{0:#,###}",uwg.Rows[6].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label56.Text = DateTime.Parse(uwg.Rows[6].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[6].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[6].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Eighth()
		{
			...
			Label61.Text = " ";	// 규격
			Label62.Text = " ";		// 단위	
			Label63.Text = String.Format("{0:#,###}",uwg.Rows[7].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label64.Text = DateTime.Parse(uwg.Rows[7].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[7].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[7].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Ninth()
		{
			...
			Label69.Text = " ";	// 규격
			Label70.Text = " ";		// 단위	
			Label71.Text = String.Format("{0:#,###}",uwg.Rows[8].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label72.Text = DateTime.Parse(uwg.Rows[8].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[8].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[8].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Tenth()
		{
			...
			Label77.Text = " ";	// 규격
			Label78.Text = " ";		// 단위	
			Label79.Text = String.Format("{0:#,###}",uwg.Rows[9].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label80.Text = DateTime.Parse(uwg.Rows[9].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[9].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[9].Cells.FromKey("DeliveryDate").Text).Day;
		...
		private void Eleventh()
		{
			...
			Label85.Text = " ";		// 규격
			Label86.Text = " ";			// 단위	
			Label87.Text = String.Format("{0:#,###}",uwg.Rows[10].Cells.FromKey("DeliveryQuantity").Value);	// 수량
			Label88.Text = DateTime.Parse(uwg.Rows[10].Cells.FromKey("DeliveryDate").Text).Year+"/ "+DateTime.Parse(uwg.Rows[10].Cells.FromKey("DeliveryDate").Text).Month+"/ "+DateTime.Parse(uwg.Rows[10].Cells.FromKey("DeliveryDate").Text).Day;
