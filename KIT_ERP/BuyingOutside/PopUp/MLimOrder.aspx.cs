...
{
	/// <summary>
	/// MLimOrder에 대한 요약 설명입니다.
	/// </summary>
	public class MLimOrder : System.Web.UI.Page
	{
		...
		{
			Label1.Text = "1";
			Label2.Text = MateralQuality(uwg.Rows[0].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label9.Text = "2";
			Label10.Text = MateralQuality(uwg.Rows[1].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label17.Text = "3";
			Label18.Text = MateralQuality(uwg.Rows[2].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label25.Text = "4";
			Label26.Text = MateralQuality(uwg.Rows[3].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label33.Text = "5";
			Label34.Text = MateralQuality(uwg.Rows[4].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label41.Text = "6";
			Label42.Text = MateralQuality(uwg.Rows[5].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label49.Text = "7";
			Label50.Text = MateralQuality(uwg.Rows[6].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label57.Text = "8";
			Label58.Text = MateralQuality(uwg.Rows[7].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label65.Text = "9";
			Label66.Text = MateralQuality(uwg.Rows[8].Cells.FromKey("ItemNum").Text);		// 재질
		...
		{
			Label73.Text = "10";
			Label74.Text = MateralQuality(uwg.Rows[9].Cells.FromKey("ItemNum").Text);		// 재질
