<%@ Page language="c#" Codebehind="SubPurchase.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BuyingOutside.PopUp.SubPurchase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SubPurchase</title>
				...
				<tr>
					<td colspan="12" vAlign="top">
						<table width="1000" border="0" cellpadding="0" cellspacing="0" id="Table3" align="center">
							<tr>
								<td width="30" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" height="25">순번</td>
								<td width="190" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" height="25">품명</td>
								<td width="175" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
								...
								<td width="200" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="90"><FONT face="굴림">금액</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="90">
									납기일</td>
								<td width="30" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid"
									vAlign="middle" align="center" height="25">비고</td>
							</tr>
							<tr>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="30">
									<asp:Label id="Label1" runat="server"></asp:Label>&nbsp;</td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="190">
									<asp:Label id="Label2" runat="server"></asp:Label>&nbsp;</td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="175">
									<asp:Label id="Label3" runat="server"></asp:Label>&nbsp;</td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="50">
									<asp:Label id="Label4" runat="server"></asp:Label>&nbsp;</td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="200">
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="90">
								...
								<td style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid"
									height="25" vAlign="middle" align="center" width="30">&nbsp;</td>
							</tr>
							<tr>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="30">
							...
							<TR>
								<TD style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid"
									vAlign="middle" align="center" colSpan="11"><FONT face="굴림"></FONT>
									<table id="tb" border="0" cellpadding="0" cellspacing="0" align="center" width="1000">
										<TBODY>
											<tr>
												<td rowspan="2" style="FONT-SIZE: 9pt; PADDING-TOP: 5px" width="820" height="10" vAlign="top">
													<P>&nbsp;<FONT face="굴림">&nbsp;거래처 협조사항 :<br>
															&nbsp;① 납품서에 품번을 반드시 명기할 것<br>
															&nbsp;② 주문서의 단가 이상시 담당자에 연락할 것</FONT></P>
													<P><FONT face="굴림">&nbsp; </FONT>
													</P>
													<P><FONT face="굴림">&nbsp;발주자 :&nbsp;
