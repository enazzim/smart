<%@ Page language="c#" Codebehind="Purchase1.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BuyingOutside.PopUp.Purchase1" %>
...
<HTML>
	<HEAD>
		...
		<link href="http://ts.daumcdn.net/custom/blog/0/606/skin/images/nanumgothic.css" rel="stylesheet"
			type="text/css">
		<style>
.t3 { POSITION: relative; FONT-FAMILY: 'Nanum Gothic'; FONT-SIZE: 13px }
.t3 H3 { MARGIN-BOTTOM: 0.75em; LETTER-SPACING: -0.05em; COLOR: #323232; FONT-SIZE: 1.69em }
.t3 .tblWrap { WIDTH: 100%; OVERFLOW: hidden }
.t3 TABLE { BORDER-BOTTOM: #e2e2e2 2px solid; LINE-HEIGHT: 18px; BORDER-SPACING: 0; WIDTH: 90% !important; BORDER-COLLAPSE: collapse; LETTER-SPACING: -0.05em; BORDER-TOP: #37315d 3px solid }
.t3 THEAD TR:first-child TH { BORDER-TOP: 0px }
.t3 TH { TEXT-ALIGN: center; BORDER-LEFT: #e2e2e2 1px solid; PADDING-BOTTOM: 10px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: #e2e2e2 1px solid; FONT-WEIGHT: 400; PADDING-TOP: 10px }
.t3 TD { TEXT-ALIGN: center; BORDER-LEFT: #e2e2e2 1px solid; PADDING-BOTTOM: 10px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: #e2e2e2 1px solid; FONT-WEIGHT: 400; PADDING-TOP: 10px }
.t3 THEAD TR:first-child TH:first-child { BORDER-LEFT: 0px }
.t3 TD.ty3 { BORDER-LEFT: 0px }
					...
					<td colspan="12" vAlign="top">
						<table width="1000" border="0" cellpadding="0" cellspacing="0" id="Table3" align="center">
							<tr>
								...
								<td width="50" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" height="25"><FONT face="굴림">단가</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="80"><FONT face="굴림">금액</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label89" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label92" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label94" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label96" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">&nbsp;
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label98" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label100" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
									<asp:Label id="Label103" runat="server"></asp:Label>&nbsp;</td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
									<asp:Label id="Label105" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="center" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label106" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label108" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
							...
							<tr>
								...
								<td height="25" style="BORDER-LEFT: black 1px solid; PADDING-RIGHT: 3px; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="50">
									<asp:Label id="Label110" runat="server"></asp:Label><FONT face="굴림">&nbsp;</FONT></td>
								<td height="25" style="BORDER-LEFT: black 1px solid; FONT-SIZE: 9pt; BORDER-TOP: black 1px solid"
									vAlign="middle" align="right" width="80">
