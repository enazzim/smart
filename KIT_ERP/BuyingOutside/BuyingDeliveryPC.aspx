											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="현재고" Key="NowStockQuantity" Width="70px" Format="###,###,###.##" BaseColumnName="NowStockQuantity">
															<CellStyle HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="입고수량" Key="DeliveryQuantity" Width="70px" Format="###,###,##0.00" HeaderClickAction="SortMulti"
														...
														<igtbl:UltraGridColumn HeaderText="표준단가" Key="StandardUnitCost" Format="###,###,##0.00" HeaderClickAction="SortMulti"
														...
														<igtbl:UltraGridColumn HeaderText="검사자" Key="UpdatingPerson" HeaderClickAction="SortMulti" BaseColumnName="UpdatingPerson">
															<CellStyle HorizontalAlign="Center"></CellStyle>
														</igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="검사일" Key="UpdatingDate" Format="yyyy-MM-dd" HeaderClickAction="SortMulti"
															BaseColumnName="UpdatingDate">
															<CellStyle HorizontalAlign="Center"></CellStyle>
														</igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="구매발주원장번호" Key="BuyingOrderHistoryIndex" HeaderClickAction="SortMulti"
														...
														<igtbl:UltraGridColumn HeaderText="구매납품원장번호" Key="BuyingDeliveryHistoryIndex" HeaderClickAction="SortMulti"
					...
					<TD>
						<TABLE id="Table6" style="HEIGHT: 20px" cellSpacing="0" cellPadding="0" width="100%">
							...
							<TR>
								...
								<TD align="right" colSpan="2"><asp:button id="btnCancel" runat="server" Height="20px" Width="65px" Text="삭   제" Font-Size="9pt"></asp:button>&nbsp;
									<asp:button id="btnStop" runat="server" Height="20px" Width="65px" Text="중   단" Font-Size="9pt"></asp:button></TD>
							</TR>
						</TABLE>
