...
<%@ Page language="c#" Codebehind="PreOutStorehousePopUp.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BuyingOutside.PreOutStorehousePopUp" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PreOutStorehousePopUp</title>
		...
		function Lot(inputValue)
        {
			...
			document.Form1.Textbox3.value = inputValue;
							...
							<TBODY>
								<TR>
									<TD style="FONT-WEIGHT: bold; FONT-SIZE: 13pt; COLOR: white; BORDER-BOTTOM: darkgray double; HEIGHT: 30px; BACKGROUND-COLOR: darkgray"
										align="left" bgColor="dimgray" colSpan="6" height="30">&nbsp;선출고</TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD style="WIDTH: 60px; HEIGHT: 16px" align="right" bgColor="gainsboro">&nbsp;</TD>
									<td style="WIDTH: 200px; HEIGHT: 16px" align="left" bgColor="gainsboro">
										<asp:textbox id="Textbox3" runat="server" BorderStyle="Inset" BackColor="#EEEEE9" Width="136px"
											Height="20px" ReadOnly="True" Font-Size="9pt" Enabled="False" Visible="False"></asp:textbox>
										<asp:button id="btLot" runat="server" Height="20px" Text="..." Visible="False"></asp:button></td>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 140px; HEIGHT: 16px" bgColor="#dcdcdc">
										<asp:textbox id="txtThisTimeOutStorehouseQuantity" style="TEXT-ALIGN: right" runat="server" BorderColor="DimGray"
											Width="110px" BorderStyle="Solid" Height="20px" BackColor="#EEEEE9" BorderWidth="1px"></asp:textbox></TD>
									<TD style="WIDTH: 80px; HEIGHT: 16px" align="right" bgColor="#dcdcdc">공정명&nbsp;
									</TD>
									<TD style="WIDTH: 130px; HEIGHT: 16px" bgColor="#dcdcdc"><asp:dropdownlist id="ddlProcessName" runat="server" Width="130px" BackColor="#EEEEE9"></asp:dropdownlist></TD>
									<TD style="WIDTH: 60px; HEIGHT: 16px" align="right" bgColor="#dcdcdc"><INPUT id="hdLotNum" style="WIDTH: 55px; HEIGHT: 20px" type="hidden" size="3" name="hdLotNum"
											runat="server"></TD>
									<TD align="right" bgColor="#dcdcdc" width="200"><FONT face="굴림"></FONT></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 680px; HEIGHT: 3px" align="right" bgColor="#696969" colspan="6"></TD>
								</TR>
								<TR>
									<TD width="680" style="HEIGHT: 21px" align="right" bgColor="lightgrey" colSpan="6"><INPUT id="hdBusinessRegistrationNum" style="WIDTH: 40px; HEIGHT: 22px" type="hidden" size="1"
