...
<%@ Page language="c#" Codebehind="EtcClaimPC.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BuyingOutside.EtcClaimPC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>EtcClaimPC</title>
		...
		{
			GridName = gridName;
    			if(document.EtcClaimPC.chkAll.value == "true")
    			{
					AllCheck();
				}
				else
		...
		function AllCheck() // 전부 체크하기
		{
			...
			document.EtcClaimPC.chkAll.value = "false";
		}
		...
		function AllUncheck() // 전부체크 해제하기
		{
			...
			document.EtcClaimPC.chkAll.value = "true";
		}
		function UltraWebGrid1_MouseOverHandler(gridName, id, button)
		{
			...
			{ // Are we over a cell
				...
				document.EtcClaimPC.lb_RowIndex.value = parts[1];
			}
		}
		...
		function UltraWebGrid1_AfterRowTemplateOpenHandler(gridName, rowId)
		{
			...
			//Add code to handle your event here.
			document.EtcClaimPC.lb_RowSelectIndex.value = document.EtcClaimPC.lb_RowIndex.value;
			
			
			//이전크레임금액
			document.EtcClaimPC.lb_Cost.value = row.getCellFromKey("ClaimCost").getValue();//기존금액
			
			document.EtcClaimPC.tbClaimRegion.value = row.getCellFromKey("EtcClaimRegion").getValue();//공제사유
			document.EtcClaimPC.igtbl_TextBox_0_8.value = MakeCommaSeparate(row.getCellFromKey("ClaimCost").getValue());//금액
			...
			document.EtcClaimPC.hdYear.value = year;
			document.EtcClaimPC.hdMon.value = mon;			
		}
...
--></SCRIPT>
	...
	<body style="FONT-SIZE: x-small" MS_POSITIONING="GridLayout" bgColor="#f7f6f6">
		<form id="EtcClaimPC" method="post" runat="server">
					...
					<TD vAlign="top" align="center" width="800"><FONT face="굴림">
							<FIELDSET style="BORDER-RIGHT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 800px; BORDER-BOTTOM: #696969 2px solid; HEIGHT: 48px"><LEGEND align="top">[검색조건]</LEGEND>
								<TABLE id="Table2" style="HEIGHT: 28px" cellSpacing="0" cellPadding="0" width="800">
									<TR>
										<TD align="left" width="800" height="30" colSpan="5"><FONT face="굴림">
									...
									<TR>
										...
										<TD align="right" width="455" height="30"><INPUT id="btnReset" style="WIDTH: 65px; HEIGHT: 20px" onclick="javascript:ResettxtBox()"
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="기타공제 사유" Key="EtcClaimRegion" Width="400px" Format="" HeaderClickAction="SortMulti"
														...
														<P align="center">
															<TABLE id="Table3" style="HEIGHT: 80px" cellSpacing="0" cellPadding="0" width="800" border="0">
																<TR>
																	...
																	<TD align="left"><FONT face="굴림"><INPUT id="igtbl_TextBox_0_4" style="WIDTH: 200px; BACKGROUND-COLOR: #eeeee9" readOnly
																				type="text" columnKey="CompanyName"></FONT></TD>
																	<TD align="right"><FONT face="굴림">공제사유</FONT></TD>
																	<TD align="left"><FONT face="굴림"><INPUT id="tbClaimRegion" style="WIDTH: 400px; BACKGROUND-COLOR: #eeeee9" type="text" columnKey="EtcClaimRegion"></FONT></TD>
																</TR>
																<TR>
																	...
																	<TD align="left">
																		<igsch:WebDateChooser id="wdcDate" runat="server" NullDateLabel=" " Text="Null" Width="116px" BorderColor="DimGray"
																			Height="20px" BackColor="#EEEEE9" BorderStyle="Solid">
																			<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																				ShowTitle="False" ShowFooter="False">
																				<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
																				<OtherMonthDayStyle ForeColor="White"></OtherMonthDayStyle>
																	...
																	<TD align="left"><FONT face="굴림"><INPUT id="igtbl_TextBox_0_8" onkeydown="OnKeyDown_Float(this);" onblur="OnBlur_Cur(this);"
																				onkeyup="OnKeyUp_Currency(this);" style="WIDTH: 150px; BACKGROUND-COLOR: #eeeee9; TEXT-ALIGN: right" onfocus="OnFocus_Obj(this);"
