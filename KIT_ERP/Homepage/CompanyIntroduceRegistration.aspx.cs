...
{
	/// <summary>
	/// CompanyIntroduceRegistration에 대한 요약 설명입니다.
	/// </summary>
	public class CompanyIntroduceRegistration : System.Web.UI.Page
	{
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				Cmd.CommandText = "INSERT INTO HBP_T(Title, Contents, AppendFile, FileName, FileSize, FileType, RegistrationPerson, Distinction) VALUES(@Title, @Contents, @AppendFile, @FileName, @FileSize, @FileType, @RegistrationPerson, @Distinction)";
				...
				Cmd.Parameters.Add("@Distinction", SqlDbType.Bit).Value = true;
