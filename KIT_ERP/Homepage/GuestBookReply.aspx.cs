...
{
	/// <summary>
	/// GuestBookReply에 대한 요약 설명입니다.
	/// </summary>
	public class GuestBookReply : System.Web.UI.Page
	{
		...
		private string HGuestIndex = string.Empty;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				if (Request.Params["HGuestIndex"] != null)
					HGuestIndex = Request.Params["HGuestIndex"].ToString();
		...
		private void LoadData()
		{
			...
			Cmd.CommandText = "SELECT * FROM HG_T WHERE HGuestIndex = @HGuestIndex";
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			string sp;
			sp = "UP_INSERT_HGUESTREPLY";
			
			SqlCommand Cmd = new SqlCommand(sp, Con);
			Cmd.CommandType = CommandType.StoredProcedure;

			Cmd.Parameters.Add("@ParentHGuestIndex", SqlDbType.Int);
			Cmd.Parameters.Add("@PrevHGuestIndex", SqlDbType.Int);
			...
			int HGuestIndex2 = int.Parse(HGuestIndex = Request.Params["HGuestIndex"].ToString());
			int depth2 = int.Parse(depth = Request.Params["depth"].ToString());
			int prevHGuestIndex2 = (HGuestIndex2-1)/1000 * 1000;


			Cmd.Parameters["@ParentHGuestIndex"].Value = HGuestIndex2;
			Cmd.Parameters["@PrevHGuestIndex"].Value = prevHGuestIndex2;
