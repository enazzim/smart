...
{
	/// <summary>
	/// PDS_Registration에 대한 요약 설명입니다.
	/// </summary>
	public class PDS_Registration : System.Web.UI.Page
	{
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			if(CheckBox1.Checked)
			{
				...
				else
				{
					...
					try
					{
						...
						Cmd.Parameters.Add("@Classify", SqlDbType.SmallInt).Value = 1;
						Cmd.ExecuteNonQuery();

						Cmd.CommandText = "INSERT INTO HD_T(Title, Contents, AppendFile, FileName, FileSize, FileType, RegistrationPerson, Category) VALUES(@Title, @Contents, @AppendFile, @FileName, @FileSize, @FileType, @RegistrationPerson, @Category2)";
					...
					{
						Con.Close();
						Response.Cookies["HD_T"]["PageNumber"] = "0";
						Response.Redirect("PDS.aspx");
					}
				}
			}
			...
			else if(!CheckBox1.Checked)
			{
				...
				else
				{
					try
					{
						Cmd.CommandText = "INSERT INTO HD_T(Title, Contents, AppendFile, FileName, FileSize, FileType, RegistrationPerson, Category) VALUES(@Title, @Contents, @AppendFile, @FileName, @FileSize, @FileType, @RegistrationPerson, @Category)";
						Cmd.Parameters.Add("@Title", SqlDbType.VarChar).Value = Title.Text;
						Cmd.Parameters.Add("@Contents", SqlDbType.VarChar).Value = Content.Text;
						Cmd.Parameters.Add("@AppendFile", SqlDbType.Image).Value = Files1;
						Cmd.Parameters.Add("@FileName", SqlDbType.VarChar).Value = FileName.ToString();
