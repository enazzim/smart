<%@ Page language="c#" Codebehind="FreeRegistration.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Homepage.FreeRegistration" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FreeRegistration</title>
						...
						<div align="center"><FONT face="굴림">
								<TABLE id="Table2" cellSpacing="0" cellPadding="3" width="800" border="2" style="FONT-SIZE: 10pt"
									...
									<TR height="30">
										...
										<TD width="30%">
											<asp:TextBox id="Password" runat="server" Height="100%" Width="106px" BorderWidth="1px" BorderStyle="Solid"
