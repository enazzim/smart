<%@ Page language="c#" Codebehind="BusinessProduct.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Homepage.BusinessProduct" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="FONT-SIZE: 0pt; Z-INDEX: 101; LEFT: 10px; POSITION: absolute; TOP: 0px"
				...
				<TR height="27">
					...
					<TD align="left" colSpan="3" style="FONT-SIZE: 10pt">
						<P>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD><FONT face="굴림">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<asp:DropDownList id="DropDownList1" runat="server" AutoPostBack="True"></asp:DropDownList>
											<asp:Button id="Button1" runat="server" Text="삭  제" Height="20px" Width="65px" Visible="False"></asp:Button></FONT></TD>
									<TD align="right"><asp:button id="btnWrite" runat="server" Width="65px" Height="20px" Text="글쓰기" Enabled="False"></asp:button><FONT face="굴림">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										</FONT>
									</TD>
								</TR>
							</TABLE>
				...
				<TR>
					...
					<TD style="FONT-SIZE: 0pt" vAlign="top" colSpan="3" align="center"><FONT face="굴림"><asp:datagrid id="DataGrid1" runat="server" Font-Size="9pt" Width="800px" AllowPaging="True" AllowCustomPaging="True"
								...
								<Columns>
									<asp:HyperLinkColumn DataNavigateUrlField="HBizProductIntroIndex" DataNavigateUrlFormatString="BusinessProductAdjustment.aspx?HBizProductIntroIndex={0}"
