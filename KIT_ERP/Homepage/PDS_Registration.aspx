<%@ Page language="c#" Codebehind="PDS_Registration.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Homepage.PDS_Registration" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PDS_Registration</title>
				...
				<TR height="350">
					...
					<TD style="FONT-SIZE: 10pt" vAlign="top" colSpan="3" align="center"><FONT face="굴림"></FONT>
						<div align="center"><FONT face="굴림">
								<TABLE id="Table3" cellSpacing="0" cellPadding="3" width="100%" border="2" style="FONT-SIZE: 10pt"
									...
									<tr>
										...
										<td height="30">
											...
											<asp:TextBox id="TextBox1" runat="server" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px"
												Width="180px" Visible="False" BackColor="#EEEEE9"></asp:TextBox></td>
									</tr>
									<TR>
										<TD align="center" width="120" height="30">
