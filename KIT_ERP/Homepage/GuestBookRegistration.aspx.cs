...
{
	/// <summary>
	/// GuestBookRegistration에 대한 요약 설명입니다.
	/// </summary>
	public class GuestBookRegistration : System.Web.UI.Page
	{
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			SqlCommand Cmd = new SqlCommand("UP_INSERT_HGUESTNEW", Con);
			...
			Response.Cookies["HG_T"]["PageNumber"] = "0";
			Response.Redirect("GuestBook.aspx");
		}		
	}
}
