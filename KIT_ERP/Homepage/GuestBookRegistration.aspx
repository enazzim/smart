<%@ Page language="c#" Codebehind="GuestBookRegistration.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Homepage.GuestBookRegistration" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>GuestBookRegistration</title>
						...
						<div align="center"><FONT face="굴림">
								<TABLE id="Table2" cellSpacing="0" cellPadding="3" width="100%" border="2" style="FONT-SIZE: 10pt"
									...
									<TR height="30">
										...
										<TD width="30%">
											<asp:TextBox id="Password" runat="server" Height="100%" Width="77px" BorderWidth="1px" BorderStyle="Solid"
