...
<%@ Page language="c#" Codebehind="BuyingIndex.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ManagementInfomation.BuyingIndex" %>
	...
	<HEAD>
		...
		<!--
			...
			function ResettxtBox()
			{
				...
				document.Form1.ddlBuyingBiv.options[0].selected = true;			
			}
		//-->
		</script>
	</HEAD>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="LEFT: 10px; POSITION: absolute; TOP: 10px" cellSpacing="0" cellPadding="0"
						...
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table1" height="50" cellSpacing="0" cellPadding="0" width="100%" align="center"
								...
								<TR>
									...
									<TD width="130" height="30"><asp:dropdownlist id="ddlItemClassification1" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류2&nbsp;</TD>
									<TD align="left" width="130" height="30" style="WIDTH: 91px"><asp:dropdownlist id="ddlItemClassification2" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류3&nbsp;</TD>
									<TD align="left" width="130" height="30"><asp:dropdownlist id="ddlItemClassification3" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류4&nbsp;</TD>
									<TD vAlign="middle" align="left" width="130" colSpan="3" height="30"><asp:dropdownlist id="ddlItemClassification4" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD align="left" height="30" width="200" colSpan="2">
										<uc1:CompanySearchControl id="CSC1" runat="server"></uc1:CompanySearchControl>
									</TD>
									<TD align="right" height="30" width="70">매입 형태&nbsp;</TD>
									<TD align="right" height="30" style="WIDTH: 130px">
										<asp:DropDownList id="ddlBuyingBiv" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt">
									...
									<TD align="right" colSpan="6" height="30" width="400"><INPUT id="btnReset" style="WIDTH: 65px; HEIGHT: 20px" onclick="javascript:ResettxtBox()"
				...
				<TR>
					<TD>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							align="middle" DESIGNTIMEDRAGDROP="51"><BR>
							<LEGEND style="FONT-SIZE: 10pt" align="left">
								[ 검색결과 ]
							</LEGEND>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0" align="center">
								<TR>
									<TD align="center" vAlign="top"><igchart:ultrachart id="UltraChart1" runat="server" Width="794px" ForeColor="#E0E0E0" BackColor="WhiteSmoke"
											...
											EnableCrossHair="False" ChartType="StackColumnChart" DoughnutChart-BreakAlternatingSlices="True" DoughnutChart-OthersCategoryPercent="0"
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="월별 매입 지표   " FontSizeBestFit="False"
											...
											<Tooltips BorderThickness="1" FormatString="&lt;DATA_VALUE:###,###,##.00&gt; 원" EnableFadingEffect="False"
								...
								<TR>
									<TD align="center" vAlign="top"><igtbl:ultrawebgrid id="DataGrid1" runat="server" Width="100%" Height="200px">
											<DisplayLayout ColWidthDefault="130px" StationaryMargins="Header" AllowSortingDefault="Yes" RowHeightDefault="20px"
