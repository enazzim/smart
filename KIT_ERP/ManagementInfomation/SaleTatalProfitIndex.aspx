...
<%@ Page language="c#" Codebehind="SaleTatalProfitIndex.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ManagementInfomation.SaleTatalProfitIndex" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" bgColor="#f7f6f6">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="LEFT: 10px; POSITION: absolute; TOP: 10px" height="550" cellSpacing="0"
					...
					<TD height="60">
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table1" height="50" cellSpacing="0" cellPadding="0" width="100%" align="center"
								border="0">
								<TR>
									<TD align="right" width="60" height="28">품목분류1&nbsp;
									</TD>
									<TD width="100" height="28">
										<asp:dropdownlist id="ddlItemClassification1" runat="server" Width="100px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="60" height="28">품목분류2&nbsp;</TD>
									<TD align="left" width="100" height="28">
										<asp:dropdownlist id="ddlItemClassification2" runat="server" Width="100px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="60" height="28">품목분류3&nbsp;</TD>
									<TD align="left" width="100" height="28">
										<asp:dropdownlist id="ddlItemClassification3" runat="server" Width="100px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="65" height="28">품목분류4&nbsp;</TD>
									<TD vAlign="middle" align="left" width="100" colSpan="3" height="28">
										<asp:dropdownlist id="ddlItemClassification4" runat="server" Width="100px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD height="28" width="155" align="right"><INPUT id="btnReset" style="WIDTH: 65px; HEIGHT: 20px" onclick="javascript:ResettxtBox()"
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800" border="0">
								<TR>
									<TD vAlign="top" align="center">
										<igchart:ultrachart id="UltraChart1" runat="server" Width="800px" ForeColor="#E0E0E0" BackColor="WhiteSmoke"
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="매출 총 이익 지표  [ 현재날짜   ]"
											...
											<Tooltips BorderThickness="1" FormatString="&lt;DATA_VALUE:00.00&gt; 원" EnableFadingEffect="False"
								...
								<TR>
									<TD align="right" vAlign="middle" height="25">
										<asp:button id="btnAll" runat="server" Width="80px" Height="20px" Text="전체보기" Visible="False"></asp:button>&nbsp;
										<asp:button id="btn_totProfit" runat="server" Width="80px" Height="20px" Text="총이익" Visible="False"></asp:button>&nbsp;
										<asp:button id="btnB_Cost" runat="server" Width="80px" Height="20px" Text="매입" Visible="False"></asp:button>&nbsp;
										<asp:button id="btnS_Cost" runat="server" Width="80px" Height="20px" Text="매출" Visible="False"></asp:button>&nbsp;&nbsp;
									</TD>
								</TR>
								<TR>
									<TD>
										<igtbl:ultrawebgrid id="DataGrid1" runat="server" Width="800px" Height="200px">
								...
								<tr height="40">
									<td>&nbsp;
										<asp:Button id="Button2" runat="server" Width="60px" Text="Excel" Height="20px"></asp:Button>
