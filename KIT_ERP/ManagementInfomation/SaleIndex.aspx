...
<%@ Page language="c#" Codebehind="SaleIndex.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ManagementInfomation.SaleIndex" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="LEFT: 10px; POSITION: absolute; TOP: 10px" height="550" cellSpacing="0"
						...
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table1" height="50" cellSpacing="0" cellPadding="0" width="100%" align="center"
								...
								<TR>
									...
									<TD width="120" height="28"><asp:dropdownlist id="ddlItemClassification1" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="28">품목분류2&nbsp;</TD>
									<TD align="left" width="120" height="28"><asp:dropdownlist id="ddlItemClassification2" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="28">품목분류3&nbsp;</TD>
									<TD align="left" width="120" height="28"><asp:dropdownlist id="ddlItemClassification3" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="28">품목분류4&nbsp;</TD>
									<TD vAlign="middle" align="left" width="120" colSpan="3" height="28"><asp:dropdownlist id="ddlItemClassification4" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD height="28"></TD>
								</TR>
								<TR>
									<TD align="left" height="28" width="600" colSpan="6">
										<uc1:CompanySearchControl id="CSC1" runat="server"></uc1:CompanySearchControl>
									</TD>
									<TD height="28" align="right" colSpan="4">&nbsp;&nbsp;<INPUT id="btnReset" style="WIDTH: 65px; HEIGHT: 20px" onclick="javascript:ResettxtBox()"
											type="button" value="초기화" name="btnReset">
										<asp:button id="btnSearch" runat="server" Height="20px" Width="60px" Text="검  색"></asp:button>&nbsp;&nbsp;</TD>
								</TR>
								<TR>
									<TD align="right" height="8" colSpan="10"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
				...
				<TR>
					<TD>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							align="middle" DESIGNTIMEDRAGDROP="48"><BR>
							<LEGEND style="FONT-SIZE: 10pt" align="left">
								[ 검색결과 ]
							</LEGEND>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800" border="0">
								<TR>
									<TD vAlign="top" align="center"><igchart:ultrachart id="UltraChart1" runat="server" Width="796px" ForeColor="#E0E0E0" BackColor="WhiteSmoke"
											Height="350px" Transform3D-ZRotation="0" Transform3D-Scale="100" Transform3D-XRotation="28" Transform3D-YRotation="12" EmptyChartText=" "
											EnableCrossHair="False" ChartType="LineChart" DoughnutChart-BreakAlternatingSlices="True" DoughnutChart-OthersCategoryPercent="0"
											...
											<LineChart DrawStyle="Solid" Thickness="3" NullHandling="Zero" MidPointAnchors="True" StartStyle="Round"
												HighLightLines="False" EndStyle="DiamondAnchor"></LineChart>
											<ColorModel ColorBegin="Yellow" ColorEnd="Blue" AlphaLevel="255" ModelStyle="PureRandom" Grayscale="False"
												Scaling="Decreasing">
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="월별 매출 지표" FontSizeBestFit="False"
											...
											<Data DataMember="" SwapRowsAndColumns="False" UseMinMax="True" UseRowLabelsColumn="False"
											...
											<Tooltips BorderThickness="1" FormatString="&lt;DATA_VALUE:00.00&gt; 원" EnableFadingEffect="False"
												Format="Custom" FontColor="Black" BorderColor="Black" Display="MouseMove" BackColor="250, 235, 215"
												Padding="2"></Tooltips>
