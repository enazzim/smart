<%@ Page language="c#" Codebehind="CompanyItems.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ManagementInfomation.CompanyItems" %>
					...
					<TD colSpan="2" height="60">
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 811px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 78px"
							...
							<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="800" align="center" border="0">
									...
									<td width="800" height="30">
										<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="800" border="0">
											<tr>
												...
												<TD align="left" width="600" height="30"><uc1:itemsearchcontrol id="ISC1" runat="server"></uc1:itemsearchcontrol></TD>
											</tr>
										</TABLE>
									</td>
								</TR>
								<TR>
									<TD align="right" width="800"><INPUT id="btnReset" style="WIDTH: 65px; HEIGHT: 20px" onclick="javascript:ResettxtBox()"
								...
								<TR>
									<TD align="right" width="800" height="8"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
					...
					<TD vAlign="top" height="400">
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 811px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 400px"
							...
							<TABLE id="Table3" style="WIDTH: 100%; HEIGHT: 400px" cellSpacing="0" cellPadding="0">
								...
								<TR>
									<TD vAlign="top" align="center" width="875"><igtbl:ultrawebgrid id="uwg1" runat="server" Width="100%" Height="411px">
											<DisplayLayout AutoGenerateColumns="False" AllowSortingDefault="Yes" RowHeightDefault="20px" Version="3.00"
												...
												AllowColSizingDefault="Free" RowSelectorsDefault="No" Name="uwg1">
												<AddNewBox>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
												...
												<FrameStyle Width="100%" BorderWidth="1px" Font-Size="9pt" Font-Names="굴림" BorderColor="DimGray"
													BorderStyle="Solid" BackColor="Silver" Height="411px"></FrameStyle>
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														<igtbl:UltraGridColumn HeaderText="거래처명" Key="CompanyName" Width="123px" BaseColumnName="CompanyName">
														...
														<igtbl:UltraGridColumn HeaderText="규 격" Key="Standard" Width="180px" BaseColumnName="Standard"></igtbl:UltraGridColumn>
														<igtbl:UltraGridColumn HeaderText="단가구분" Key="UnitCostDistinction" Width="80px" BaseColumnName="UnitCostDistinction"
															NullText="">
															<CellStyle HorizontalAlign="Center"></CellStyle>
														</igtbl:UltraGridColumn>
														...
														<igtbl:UltraGridColumn HeaderText="단가" Key="StandardUnitCost" Width="80px" Format="###,###,##0.00" BaseColumnName="StandardUnitCost">
