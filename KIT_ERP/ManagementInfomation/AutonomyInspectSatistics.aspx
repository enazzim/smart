...
<%@ Page language="c#" Codebehind="AutonomyInspectSatistics.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ManagementInfomation.AutonomyInspectSatistics" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AutonomyInspectIndex</title>
	...
	<body bottomMargin="0" bgColor="#f7f6f6" leftMargin="0" topMargin="0" rightMargin="0"
		XMLNS:igchart="http://schemas.infragistics.com/ASPNET/WebControls/WebChart">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table3" style="LEFT: 10px; POSITION: absolute; TOP: 10px" cellSpacing="0" cellPadding="0"
				width="800" border="0">
				<TR>
					<TD vAlign="top" align="center">
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="796" align="center" border="0">
								<TR>
									<TD align="right" width="70" height="30">품목분류1&nbsp;
									</TD>
									<TD width="120" height="30"><asp:dropdownlist id="ddlItemClassification1" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류2&nbsp;</TD>
									<TD align="left" width="120" height="30"><asp:dropdownlist id="ddlItemClassification2" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류3&nbsp;</TD>
									<TD align="left" width="120" height="30"><asp:dropdownlist id="ddlItemClassification3" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류4&nbsp;</TD>
									<TD vAlign="middle" align="left" width="120" colSpan="3" height="30"><asp:dropdownlist id="ddlItemClassification4" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px"></asp:dropdownlist></TD>
								</TR>
								<TR>
									...
									<TD height="30" colSpan="2">
										<igcmbo:webcombo id="wcWCName" runat="server" Height="20px" BackColor="#EEEEE9" Width="120px" Editable="True"
											Version="3.00" BorderWidth="1px" BorderColor="Gray" SelBackColor="10, 36, 106" SelectedIndex="-1"
											ForeColor="Black" SelForeColor="White" DropImageXP1="/ig_common/WebGrid3/ig_cmboDown1.bmp" DropImageXP2="/ig_common/WebGrid3/ig_cmboDown2.bmp"
											BorderStyle="Groove">
				...
				<TR>
					<TD align="center"><BR>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"><LEGEND style="FONT-SIZE: 10pt" align="left">[ 
								검색결과 ]
							</LEGEND>
							<table cellSpacing="0" cellPadding="0" border="0" width="100%" align="center">
								<tr>
									<td align="center" vAlign="top"><igchart:ultrachart id="UltraChart1" runat="server" Width="796px" BackColor="WhiteSmoke" Height="350px"
											Transform3D-ZRotation="0" Transform3D-Scale="100" Transform3D-XRotation="28" Transform3D-YRotation="12" EmptyChartText=" " EnableCrossHair="False"
											ChartType="StackColumnChart" DoughnutChart-BreakAlternatingSlices="True" DoughnutChart-OthersCategoryPercent="0" DoughnutChart-BreakOthersSlice="False"
											DoughnutChart-ColumnIndex="0" DoughnutChart-PieThickness="0" DoughnutChart-BreakAllSlices="True" DoughnutChart-StartAngle="0"
											DoughnutChart-BreakDistancePercentage="10" DoughnutChart-RadiusFactor="100" DoughnutChart-InnerRadius="50" CrossHairColor="SlateGray"
											BackgroundImageStyle="StretchedFit" EnableViewState="False">
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="자주 검사 지표  [&lt;TODAY_DATE:yyyy/MM/dd&gt;]"
											...
											<TitleBottom Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="Copyright KITC Inc." FontSizeBestFit="False"
											...
											<Data DataMember="" SwapRowsAndColumns="True" UseMinMax="True" UseRowLabelsColumn="True"
											...
											<Legend Font="Microsoft Sans Serif, 7.8pt" Visible="False" AlphaLevel="91" BorderThickness="1"
												...
												BackgroundColor="FloralWhite" DataAssociation="DefaultData" Location="Right" FormatString="&lt;ITEM_LABEL&gt;">
												<Margins Bottom="13" Left="5" Top="5" Right="5"></Margins>
											</Legend>
											<Tooltips BorderThickness="1" FormatString="&lt;DATA_VALUE:###,###,##.00&gt; PPM" EnableFadingEffect="False"
										...
										</igchart:ultrachart><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Width="100%" Height="200px">
								...
								<tr>
									<td height="40">&nbsp;
										<asp:button id="Button2" runat="server" Width="65px" Height="20px" Text="Excel"></asp:button><igtblexp:ultrawebgridexcelexporter id="UltraWebGridExcelExporter1" runat="server" DownloadName="AutonomyInspectSatistics.XLS"></igtblexp:ultrawebgridexcelexporter></td>
								</tr>
							</table>
						</FIELDSET>
					</TD>
