...
{
	/// <summary>
	/// SubRegistration에 대한 요약 설명입니다.
	/// </summary>
	public class SubRegistration : System.Web.UI.Page
	{
		...
		private void btnApply_Click(object sender, System.EventArgs e)
		{
			...
			SqlCommand Cmd = new SqlCommand();
			Cmd.Connection = Con;
			Cmd.CommandText = "INSERT INTO SN_T(Title, Contents, RegistrationPerson) VALUES(@Title, @Contents, @RegistrationPerson)";
			...
			Response.Cookies["SN_T"]["PageNumber"] = "0";
			Response.Redirect("SubNotice.aspx");
		}
	}
}
