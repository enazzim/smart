<%@ Page language="c#" Codebehind="FreeReply.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Homepage.FreeReply" %>
			...
			<TABLE id="Table1" style="FONT-SIZE: 0pt; Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px"
									...
									<TR height="30">
										...
										<TD width="30%">
											...
											<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" Display="None" ControlToValidate="RegistrationPerson"
												ErrorMessage="작성자를 입력해주세요!"></asp:RequiredFieldValidator></TD>
										...
										<TD width="30%">
											<asp:TextBox id="Password" runat="server" Height="100%" Width="93px" BorderWidth="1px" BorderStyle="Solid"
				...
				<tr height="25" align="center">
					...
					<td align="right" colspan="3" style="FONT-SIZE: 10pt">
						...
						<asp:Button id="Button2" runat="server" Text="등  록" Height="20px" Width="65px"></asp:Button><FONT face="굴림">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</FONT>
					</td>
				</tr>
			</TABLE>
