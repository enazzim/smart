<%@ Page language="c#" Codebehind="BusinessProductAdjustment.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Homepage.BusinessProductAdjustment" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BusinessProductAdjustment</title>
	...
	<body MS_POSITIONING="FlowLayout" bgcolor="whitesmoke">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="FONT-SIZE: 0pt; Z-INDEX: 101; LEFT: 10px; POSITION: absolute; TOP: 0px"
				cellSpacing="0" cellPadding="0" width="800" border="0" align="center" borderColorDark="#ffffff"
				borderColorLight="gray">
				<TR height="30">
					<TD vAlign="middle" width="10"><FONT face="굴림"></FONT></TD>
					<TD vAlign="middle" align="center" colSpan="3">
						<TABLE id="Table2" style="FONT-SIZE: 0pt" height="30" cellSpacing="0" cellPadding="0" width="180"
							border="0">
							<TR height="30">
				...
				<TR height="380">
					...
					<TD style="FONT-SIZE: 10pt" vAlign="top" colSpan="3" align="center"><FONT face="굴림"></FONT>
						<div align="center"><FONT face="굴림">
								<TABLE id="Table3" style="FONT-SIZE: 10pt" cellSpacing="0" cellPadding="3" width="800"
									border="2" borderColorDark="dimgray" borderColorLight="white">
									<TR height="30">
									...
									<TR height="30">
										...
										<TD colSpan="5" vAlign="middle">
											<TABLE id="Table4" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
												<TR>
													<TD>
														<asp:TextBox id="Title" runat="server" MaxLength="33" ReadOnly="True" BorderWidth="1px" BorderStyle="Solid"
															BorderColor="DimGray" Height="97%" Width="100%" BackColor="#EEEEE9"></asp:TextBox>
													...
													<TD align="center" width="12%">
														<asp:Label id="Label10" runat="server" ForeColor="ControlDarkDark" Font-Bold="True">Category</asp:Label></TD>
													<TD width="20%">
														<asp:DropDownList id="DropDownList1" runat="server" Width="100%" Enabled="False" BackColor="#EEEEE9"></asp:DropDownList></TD>
												</TR>
											</TABLE>
										</TD>
									</TR>
									<TR height="30">
										...
										<TD colSpan="3">
											<asp:Label id="Label7" runat="server" Font-Size="10pt" Font-Bold="True" ForeColor="ControlDarkDark">첨부파일변경 : </asp:Label>
											<INPUT id="File1" type="file" size="23" name="File1" runat="server" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; BORDER-BOTTOM: dimgray 1px solid; BACKGROUND-COLOR: #eeeee9"></TD>
									</TR>
									<TR>
										<TD align="center">
											<asp:Label id="Label5" runat="server" Font-Bold="True" ForeColor="ControlDarkDark">내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용</asp:Label></TD>
										<TD colSpan="5">
											<asp:TextBox id="Content" runat="server" TextMode="MultiLine" BorderColor="DimGray" BorderStyle="Solid"
												BorderWidth="1px" ReadOnly="True" Width="724px" Height="240px" BackColor="#EEEEE9"></asp:TextBox>
				...
				<tr height="25" align="center">
					...
					<td align="center" colspan="3" style="FONT-SIZE: 0pt"><FONT face="굴림">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<TABLE id="Table5" style="FONT-SIZE: 10pt" height="100%" cellSpacing="0" cellPadding="0"
								width="800" border="0">
								<TR>
									<TD align="left">
