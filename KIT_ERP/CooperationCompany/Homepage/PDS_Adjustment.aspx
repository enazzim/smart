<%@ Page language="c#" Codebehind="PDS_Adjustment.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Homepage.PDS_Adjustment" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PDS_Adjustment</title>
											...
											<TABLE id="Table4" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
												<TR>
													<TD vAlign="middle">
														...
														<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ErrorMessage="※ 제목을 입력해 주세요!" ControlToValidate="Title"
															Display="None"></asp:RequiredFieldValidator></TD>
													<TD vAlign="middle" align="center" width="12%">
														<asp:Label id="Label7" runat="server" ForeColor="ControlDarkDark" Font-Bold="True">Category</asp:Label></TD>
									...
									<TR>
										...
										<TD colSpan="5">
											...
											<asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" Display="None" ControlToValidate="Content"
												ErrorMessage="※ 내용을 입력해 주세요!"></asp:RequiredFieldValidator></TD>
									</TR>
								</TABLE>
							</FONT>
						</div>
