<%@ Page language="c#" Codebehind="SubFreeBoard.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.CooperationCompany.SubFreeBoard" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SubFreeBoard</title>
					...
					<TR>
						...
						<td vAlign="top" colSpan="3">
							<asp:datagrid id="DataGrid1" runat="server" Width="800px" AllowPaging="True" AllowCustomPaging="True"
								AutoGenerateColumns="False" GridLines="Horizontal" CellPadding="0" BackColor="White" BorderWidth="0px"
								BorderStyle="None" BorderColor="#336666" PageSize="15" Height="20px">
								...
								<HeaderStyle Font-Bold="True" Height="20px" ForeColor="ControlDarkDark" BackColor="#C0C0FF"></HeaderStyle>
								<Columns>
									<asp:HyperLinkColumn DataNavigateUrlField="SubFreeBoardIndex" DataNavigateUrlFormatString="SubFreeAdjustment.aspx?SubFreeBoardIndex={0}"
