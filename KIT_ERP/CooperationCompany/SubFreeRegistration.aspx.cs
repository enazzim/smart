...
{
	/// <summary>
	/// SubFreeRegistration에 대한 요약 설명입니다.
	/// </summary>
	public class SubFreeRegistration : System.Web.UI.Page
	{
		...
		private void btnApply_Click(object sender, System.EventArgs e)
		{
			...
			SqlCommand Cmd = new SqlCommand("UP_INSERT_SUBFREENEW", Con);
			...
			Response.Cookies["SFB_T"]["PageNumber"] = "0";
			Response.Redirect("SubFreeBoard.aspx");
