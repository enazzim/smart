<%@ Page language="c#" Codebehind="QuantityStandardIndex.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Management.QuantityStandardIndex" %>
...
<HTML>
	...
	<body bottomMargin="0" bgColor="#f7f6f6" leftMargin="15" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="WIDTH: 800px; HEIGHT: 432px" height="432" cellSpacing="0" cellPadding="0"
				width="800" border="0">
				<TR>
					...
					<TD height="40">
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table1" height="40" cellSpacing="0" cellPadding="0" width="800" align="center"
								border="0">
								<TR>
									<TD align="right" width="120" height="30">품목분류1&nbsp;
									</TD>
									<TD width="120" height="30"><asp:dropdownlist id="ddlItemClassification1" runat="server" Width="120px" BackColor="#EEEEE9"></asp:dropdownlist></TD>
									<TD align="right" width="100" height="30">품목분류2&nbsp;</TD>
									<TD align="left" width="120" height="30"><asp:dropdownlist id="ddlItemClassification2" runat="server" Width="120px" BackColor="#EEEEE9"></asp:dropdownlist></TD>
									<TD align="right" width="100" height="30">품목분류3&nbsp;</TD>
									<TD align="left" width="120" height="30"><asp:dropdownlist id="ddlItemClassification3" runat="server" Width="120px" BackColor="#EEEEE9"></asp:dropdownlist></TD>
									<TD align="right" width="100" height="30">품목분류4&nbsp;</TD>
									<TD vAlign="middle" align="left" width="120" colSpan="3" height="30"><asp:dropdownlist id="ddlItemClassification4" runat="server" Width="120px" BackColor="#EEEEE9"></asp:dropdownlist></TD>
									<TD height="30"></TD>
								</TR>
								<TR>
									<TD align="right" height="30">거래처 명&nbsp;
									</TD>
									<TD height="30">
										<igcmbo:webcombo id="wcCompanyName" runat="server" BackColor="#EEEEE9" Width="120px" Height="20px"
									...
									<TD align="right" height="30"><asp:dropdownlist id="ddlDIV" runat="server" Width="120px" BackColor="#EEEEE9" Height="20px">
											<asp:ListItem Value="전체" Selected="True">전체</asp:ListItem>
											<asp:ListItem Value="사내 부적합">사내 부적합</asp:ListItem>
											<asp:ListItem Value="구매 부적합">구매 부적합</asp:ListItem>
											<asp:ListItem Value="외주 부적합">외주 부적합</asp:ListItem>
										</asp:dropdownlist></TD>
									<TD align="left" colSpan="2" height="30"></TD>
									<TD height="30"></TD>
									<TD height="30"></TD>
									<TD width="65" height="30"><INPUT style="WIDTH: 65px; HEIGHT: 20px" onclick="ResettxtBox()" type="button" value="초기화"></TD>
				...
				<TR>
					<TD width="20" style="HEIGHT: 400px"></TD>
					<TD>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; 90BORDER-RIGHT: black 1px solid"
							align="middle"><BR>
							...
							<TABLE id="Table3" height="400" cellSpacing="0" cellPadding="0" width="800" border="0"
								style="WIDTH: 800px; HEIGHT: 400px">
								<TR>
									<TD style="HEIGHT: 184px" align="center"><igchart:ultrachart id="UltraChart1" runat="server" Width="796px" ForeColor="#E0E0E0" BackColor="WhiteSmoke"
											Height="300px" EnableViewState="False" BackgroundImageStyle="StretchedFit" CrossHairColor="SlateGray" DoughnutChart-InnerRadius="50"
											...
											<ColorModel ColorBegin="Yellow" ColorEnd="Blue" AlphaLevel="199" ModelStyle="PureRandom" Grayscale="False"
												Scaling="Random">
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="수량 기준 지표   " FontSizeBestFit="False"
											...
											<Tooltips BorderThickness="1" FormatString="[&lt;ITEM_LABEL&gt;] : &lt;DATA_VALUE:00.00&gt;"
								...
								<TR>
									<TD style="HEIGHT: 116px" align="center"><igtbl:ultrawebgrid id="DataGrid1" runat="server" Width="100%" Height="230px">
											<DisplayLayout StationaryMargins="Header" RowHeightDefault="20px" Version="3.00" SelectTypeRowDefault="Single"
												...
												<RowSelectorStyleDefault BackColor="#FFE0C0"></RowSelectorStyleDefault>
