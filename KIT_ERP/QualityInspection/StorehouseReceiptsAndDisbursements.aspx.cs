...
namespace KIT_ERP.QualityInspection
{
	...
	public class StorehouseReceiptsAndDisbursements : System.Web.UI.Page
	{
		...
		private decimal TransferStockQuantity(SqlConnection con, SqlTransaction trans, string ItemNum, string ProcessCode)
		{
			...
			{
				case "원자재창고":
					str = "Select StockQuantity"+a+" as StockQuantity From RMS_MT where ItemNum=@ItemNum and RecodingState = 1";
					comm.Parameters.Add("@ItemNum", ItemNum);
					break;
				case "생산창고":
					str = "Select StockQuantity"+a+" as StockQuantity From PS_MT where ItemNum=@ItemNum and ProcessCode = @ProcessCode and RecodingState = 1";
					comm.Parameters.Add("@ItemNum", ItemNum);
					comm.Parameters.Add("@ProcessCode", ProcessCode);
					break;
				case "외주창고":
					str = "Select Sum(StockQuantity"+a+") as StockQuantity From OS_MT where ItemNum=@ItemNum and ProcessCode = @ProcessCode and RecodingState = 1";
					comm.Parameters.Add("@ItemNum", ItemNum);
					comm.Parameters.Add("@ProcessCode", ProcessCode);
					break;
				default:
					str = "Select StockQuantity"+a+" as StockQuantity From BS_MT where ItemNum=@ItemNum and RecodingState = 1";
					comm.Parameters.Add("@ItemNum", ItemNum);
					break;
			}
			comm.CommandText = str;
		...
		private decimal NowStockQuantity(SqlConnection con, SqlTransaction trans, string ItemNum, string ProcessCode)
		{
			...
			{
				case "원자재창고":
					str = "Select StockQuantity12 as StockQuantity From RMS_MT where ItemNum=@ItemNum and RecodingState = 1";
					comm.Parameters.Add("@ItemNum", ItemNum);
					break;
				case "생산창고":
					str = "Select StockQuantity12 as StockQuantity From PS_MT where ItemNum=@ItemNum and ProcessCode = @ProcessCode and RecodingState = 1";
					comm.Parameters.Add("@ItemNum", ItemNum);
					comm.Parameters.Add("@ProcessCode", ProcessCode);
					break;
				case "외주창고":
					str = "Select Sum(StockQuantity12) as StockQuantity From OS_MT where ItemNum=@ItemNum and ProcessCode = @ProcessCode and RecodingState = 1";
					comm.Parameters.Add("@ItemNum", ItemNum);
					comm.Parameters.Add("@ProcessCode", ProcessCode);
					break;
				default:
					str = "Select StockQuantity12 as StockQuantity From BS_MT where ItemNum=@ItemNum and RecodingState = 1";
					comm.Parameters.Add("@ItemNum", ItemNum);
					break;
			}
			comm.CommandText = str;
