...
<%@ Page language="c#" Codebehind="LotStandardIndex.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ManagementInfomation.LotStandardIndex" %>
						...
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
								<TR>
									...
									<TD width="120" height="30"><asp:dropdownlist id="ddlItemClassification1" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류2&nbsp;</TD>
									<TD align="left" width="120" height="30"><asp:dropdownlist id="ddlItemClassification2" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류3&nbsp;</TD>
									<TD align="left" width="120" height="30"><asp:dropdownlist id="ddlItemClassification3" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
									<TD align="right" width="70" height="30">품목분류4&nbsp;</TD>
									<TD vAlign="middle" align="left" width="120" colSpan="3" height="30"><asp:dropdownlist id="ddlItemClassification4" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
								</TR>
								<TR>
									...
									<TD align="right" height="30">구분&nbsp;</TD>
									<TD align="left" height="30"><asp:dropdownlist id="ddlDIV" runat="server" Width="120px" Height="20px" BackColor="#EEEEE9" Font-Size="9pt">
									...
									<TD align="right" colSpan="6" height="30">
										<asp:button id="Button1" runat="server" Height="20px" Width="60px" Text="초기화"></asp:button>&nbsp;
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD vAlign="top" align="center">
										<igchart:ultrachart id="UltraChart1" runat="server" BackColor="WhiteSmoke" Height="272px" Width="796px"
											ForeColor="#E0E0E0" Transform3D-ZRotation="0" Transform3D-Scale="100" Transform3D-XRotation="28"
											Transform3D-YRotation="12" EmptyChartText=" " EnableCrossHair="False" ChartType="StackColumnChart"
											DoughnutChart-BreakAlternatingSlices="True" DoughnutChart-OthersCategoryPercent="0" DoughnutChart-BreakOthersSlice="False"
											DoughnutChart-ColumnIndex="0" DoughnutChart-PieThickness="0" DoughnutChart-BreakAllSlices="True"
											DoughnutChart-StartAngle="0" DoughnutChart-BreakDistancePercentage="10" DoughnutChart-RadiusFactor="100"
											DoughnutChart-InnerRadius="50" CrossHairColor="SlateGray" BackgroundImageStyle="StretchedFit"
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="로트 기준 지표   "
