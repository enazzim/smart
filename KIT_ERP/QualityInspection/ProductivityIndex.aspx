...
<%@ Page language="c#" Codebehind="ProductivityIndex.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ManagementInfomation.ProductivityIndex" %>
					...
					<TD height="60">
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table1" height="50" cellSpacing="0" cellPadding="0" width="800" align="center"
								border="0">
								<TR>
									<TD align="right" width="90" height="28">
										작업장명&nbsp;
									</TD>
									<TD width="100" height="28">
										<igcmbo:webcombo id="wcWCName" runat="server" Editable="True" DropImageXP1="/ig_common/WebGrid3/ig_cmboDown1.bmp"
											DropImageXP2="/ig_common/WebGrid3/ig_cmboDown2.bmp" SelForeColor="White" SelectedIndex="-1"
											SelBackColor="10, 36, 106" BorderColor="Gray" BorderWidth="1px" BorderStyle="Groove" Version="3.00"
											ForeColor="Black" BackColor="#EEEEE9" Height="20px" Width="120px">
									...
									<TD height="28" width="75"><INPUT id="btnReset" style="WIDTH: 65px; HEIGHT: 20px" onclick="javascript:ResettxtBox()"
					...
					<TD>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 100%; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800" border="0">
								<TR>
									<TD vAlign="top">
										<igchart:ultrachart id="UltraChart1" runat="server" Width="794px" ForeColor="#E0E0E0" BackColor="WhiteSmoke"
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="생산성 지표 - 작업효율(%)   "
								...
								<TR>
									<TD vAlign="top">
										<igtbl:ultrawebgrid id="DataGrid1" runat="server" Width="100%" Height="200px">
