<%@ Page language="c#" Codebehind="AutonomyInspectIndex.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.QualityInspection.AutonomyInspectIndex" codePage="949" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" XMLNS:igchart="http://schemas.infragistics.com/ASPNET/WebControls/WebChart">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table3" height="550" cellSpacing="0" cellPadding="0" width="800" border="0"
				style="LEFT: 10px; WIDTH: 800px; POSITION: absolute; TOP: 10px">
				<TR>
					<TD vAlign="top" align="center" height="80" style="WIDTH: 800px">
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; 90BORDER-RIGHT: black 1px solid"
							...
							<TABLE id="Table1" height="50" cellSpacing="0" cellPadding="0" width="800" align="center"
								border="0">
								<TR>
									<TD align="right" width="100" height="30">품목분류1&nbsp;</TD>
									...
									<TD align="right" width="90" height="30">품목분류3&nbsp;</TD>
									<TD align="left" width="100" height="30"><asp:dropdownlist id="ddlItemClassification3" runat="server" Width="120px" BackColor="#EEEEE9"></asp:dropdownlist></TD>
									<TD align="right" width="90" height="30">품목분류4&nbsp;</TD>
									<TD vAlign="middle" align="left" height="30" width="160"><asp:dropdownlist id="ddlItemClassification4" runat="server" Width="120px" BackColor="#EEEEE9"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD align="right" height="28">WC명&nbsp;</TD>
									<TD width="100" height="28" colSpan="6">
										<igcmbo:webcombo id="wcWCName" runat="server" Width="120px" Height="20px" BorderStyle="Groove" DropImageXP2="/ig_common/WebGrid3/ig_cmboDown2.bmp"
											DropImageXP1="/ig_common/WebGrid3/ig_cmboDown1.bmp" SelForeColor="White" ForeColor="Black" SelectedIndex="-1"
											SelBackColor="10, 36, 106" BorderColor="Gray" BorderWidth="1px" Version="3.00" BackColor="#EEEEE9"
											Editable="True">
									...
									<td align="right"><INPUT style="WIDTH: 60px; HEIGHT: 20px" type="button" value="초기화" onclick="ResettxtBox()">&nbsp;
										<asp:button id="btnSearch" runat="server" Width="65px" Height="20px" Text="검  색"></asp:button>&nbsp;&nbsp;</td>
								</TR>
								<TR>
									<TD align="right" height="8"></TD>
									<TD width="100" colSpan="6" height="8"></TD>
									<TD align="right" height="8"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
				...
				<TR>
					<TD align="center" style="WIDTH: 800px"><BR>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 500px"><LEGEND style="FONT-SIZE: 10pt" align="left">[ 
								검색결과 ]
							</LEGEND>
							<table width="796" border="0" cellpadding="0" cellspacing="0" align="center">
								<tr>
									<td align="center">
										<igchart:ultrachart id="UltraChart1" runat="server" Width="796px" Height="300px" BackColor="WhiteSmoke"
											Transform3D-ZRotation="0" Transform3D-Scale="100" Transform3D-XRotation="28" Transform3D-YRotation="12"
											EmptyChartText=" " EnableCrossHair="False" ChartType="StackColumnChart" DoughnutChart-BreakAlternatingSlices="True"
											DoughnutChart-OthersCategoryPercent="0" DoughnutChart-BreakOthersSlice="False" DoughnutChart-ColumnIndex="0"
											DoughnutChart-PieThickness="0" DoughnutChart-BreakAllSlices="True" DoughnutChart-StartAngle="0"
											DoughnutChart-BreakDistancePercentage="10" DoughnutChart-RadiusFactor="100" DoughnutChart-InnerRadius="50"
											CrossHairColor="SlateGray" ForeColor="#E0E0E0" BackgroundImageStyle="StretchedFit" EnableViewState="False">
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="자주검사지표" FontSizeBestFit="False"
										...
										<igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Width="100%" Height="230px">
