...
{
	public class IncongruityPresentIndex :  QualityInspection_BaseClass
	{
		...
		private void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			QualityInspection_Search qis = new QualityInspection_Search(PageNames.부적합현상지표, strDiv);
		...
		// 그리드 컬럼 정렬이나 무빙시 채트가 나오지 않으므로 다시 검색버튼 이번트 부름.
