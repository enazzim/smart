...
<%@ Page language="c#" Codebehind="StorehouseItemReceiptsAndDisbursements.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.QualityInspection.StorehouseItemReceiptsAndDisbursements" %>
					...
					<TD vAlign="top" align="center" width="800">
						<FIELDSET style="BORDER-RIGHT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-BOTTOM: #696969 2px solid"><LEGEND align="top">[검색결과]</LEGEND>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="800">
								<TR>
									<TD colSpan="6" height="450"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Width="800px" Height="450px">
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="입고량" Key="ReceiveStockQuantity" Width="90px" Format="###,###,###" BaseColumnName="ReceiveStockQuantity">
