...
<%@ Page language="c#" Codebehind="StorehouseReceiptsAndDisbursements.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.QualityInspection.StorehouseReceiptsAndDisbursements" %>
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														...
														<igtbl:UltraGridColumn HeaderText="현재고" Key="NowStockQuantity" Width="93px" Format="###,###,###" BaseColumnName="NowStockQuantity">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Right">
																<Padding Right="4px"></Padding>
															</CellStyle>
															<HeaderStyle Cursor="Hand" VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
