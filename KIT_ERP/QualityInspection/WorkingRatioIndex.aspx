<%@ Page language="c#" Codebehind="WorkingRatioIndex.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.ManagementInfomation.WorkingRatioIndex" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD width="800" vAlign="top" align="center">
										<igchart:ultrachart id="UltraChart1" runat="server" Width="796px" ForeColor="#E0E0E0" BackColor="WhiteSmoke"
											...
											<TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="가동률 지표   " FontSizeBestFit="False"
