<%@ Page language="c#" Codebehind="ReceiveingPC.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BusinessManagement.ReceiveingPC" %>
...
<HTML>
  <HEAD>
		...
		{
			GridName = gridName;
    			if(document.ReceiveingPC.chkAll.value == "true")
    			{
					AllCheck();
				}
				else
		...
		function AllCheck() // 전부 체크하기
		{
			...
			document.ReceiveingPC.chkAll.value = "false";
		}
		...
		function AllUncheck() // 전부체크 해제하기
		{
			...
			document.ReceiveingPC.chkAll.value = "true";
		}
		function OK(text)
		{
		...
		function UltraWebGrid1_AfterRowTemplateCloseHandler(gridName, rowId, bSaveChanges){
			...
			//그리드의 Row 값을 저장함
			//document.ReceiveingPC.lb_RowSelectIndex.value = document.ReceiveingPC.lb_RowIndex.value;
			if(event.srcElement.id == "igtbl_reOkBtn")
			{
				...
				var date2 = igdrp_getComboById("UltraWebGrid1xxctl0xwdcxDate2");
				var date3 = igdrp_getComboById("UltraWebGrid1xxctl0xwdcxDate3");
				var date4 = igdrp_getComboById("UltraWebGrid1xxctl0xwdcxDate4");
				var date5 = igdrp_getComboById("UltraWebGrid1xxctl0xwdcxDate5");
				...
				if(row.getCellFromKey("DeliveryRequestDate2").getValue() !=null || row.getCellFromKey("DeliveryRequestDate2").getValue() !="")
					row.getCellFromKey("DeliveryRequestDate2").setValue(date2.getValue());
				if(row.getCellFromKey("DeliveryRequestDate3").getValue() !=null || row.getCellFromKey("DeliveryRequestDate3").getValue() !="")
					row.getCellFromKey("DeliveryRequestDate3").setValue(date3.getValue());
				if(row.getCellFromKey("DeliveryRequestDate4").getValue() !=null || row.getCellFromKey("DeliveryRequestDate4").getValue() !="")
					row.getCellFromKey("DeliveryRequestDate4").setValue(date4.getValue());
				if(row.getCellFromKey("DeliveryRequestDate5").getValue() !=null || row.getCellFromKey("DeliveryRequestDate5").getValue() !="")
					row.getCellFromKey("DeliveryRequestDate5").setValue(date5.getValue());
				
				document.ReceiveingPC.lb_Total.value = row.getCellFromKey("TotalReceiveingOrderQuantity").getValue() // tb_TotalReceiveingOrderQuantity.value;
			}
		}
		function UltraWebGrid1_MouseOverHandler(gridName, id, button)
		{
			...
			{ // Are we over a cell
				...
				document.ReceiveingPC.lb_RowIndex.value = parts[1];
			}
		}
		...
		function UltraWebGrid1_BeforeRowTemplateOpenHandler(gridName, rowId, templateId){
			...
			document.ReceiveingPC.lb_RowSelectIndex.value = document.ReceiveingPC.lb_RowIndex.value;
			//document.ReceiveingPC.ttt.value = document.ReceiveingPC.lb_RowIndex.value;
			...
			if(row.getCellFromKey("ProgressCondition").getValue() == "대기")
			{
				...
				if(row.getCellFromKey("DeliveryRequestDate2").getValue() !=null)
					date2.setValue(row.getCellFromKey("DeliveryRequestDate2").getValue());
				if(row.getCellFromKey("DeliveryRequestDate3").getValue() !=null)
					date3.setValue(row.getCellFromKey("DeliveryRequestDate3").getValue());
				if(row.getCellFromKey("DeliveryRequestDate4").getValue() !=null)
					date4.setValue(row.getCellFromKey("DeliveryRequestDate4").getValue());
				if(row.getCellFromKey("DeliveryRequestDate5").getValue() !=null)
					date5.setValue(row.getCellFromKey("DeliveryRequestDate5").getValue());
			}
			else if(row.getCellFromKey("ProgressCondition").getValue() == "진행")
			{
				alert("진행중인 품목은 수정할 수 없습니다.!");
				return true;
			}
			else if(row.getCellFromKey("ProgressCondition").getValue() == "중단")
			{
				alert("중단된 품목은 수정할 수 없습니다.!");
				return true;
			}
			else if(row.getCellFromKey("ProgressCondition").getValue() == "완료")
			{
		...
		function Process()	
		{
			var total_Quantity = Number(ReceiveingPC.igtbl_TextBox_0_8.value) + Number(ReceiveingPC.igtbl_TextBox_0_10.value)+Number(ReceiveingPC.igtbl_TextBox_0_12.value) + Number(ReceiveingPC.igtbl_TextBox_0_14.value)+Number(ReceiveingPC.igtbl_TextBox_0_16.value);
			var total_Cost = total_Quantity * Number(ReceiveingPC.igtbl_TextBox_0_19.value);
			ReceiveingPC.tb_TotalReceiveingOrderQuantity.value = total_Quantity;
			ReceiveingPC.tb_TotalCost.value = total_Cost;
		}
	...
	<body bgColor="#f7f6f6" MS_POSITIONING="GridLayout">
		<form id="ReceiveingPC" method="post" runat="server">
								...
								<tr>
									<td align="center" width="800" colSpan="2"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Height="386px" Width="100%">
											...
											<Bands>
												<igtbl:UltraGridBand>
													<Columns>
														<igtbl:UltraGridColumn HeaderText="전체" Key="chk" Width="30px" Type="CheckBox" HeaderClickAction="Select" BaseColumnName="chk" AllowUpdate="Yes">
														...
														<igtbl:UltraGridColumn HeaderText="자산분류" Key="PropertyClassification" Width="70px" HeaderClickAction="SortMulti" BaseColumnName="PropertyClassification">
															<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
															<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
														</igtbl:UltraGridColumn>
														...
														<TABLE style="WIDTH: 612px; COLOR: buttontext; HEIGHT: 266px; BACKGROUND-COLOR: whitesmoke">
															<TR>
																...
																<TD height="16" aline="left">
																	<INPUT id="igtbl_TextBox_0_1" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; WIDTH: 110px; BORDER-BOTTOM: dimgray 1px solid; HEIGHT: 20px; BACKGROUND-COLOR: white; TEXT-ALIGN: right"
																...
																<TD height="16" aline="left">
																	<INPUT id="igtbl_TextBox_0_2" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; WIDTH: 110px; BORDER-BOTTOM: dimgray 1px solid; HEIGHT: 20px; BACKGROUND-COLOR: white; TEXT-ALIGN: right"
																...
																<TD height="16" aline="left">
																	<INPUT id="igtbl_TextBox_0_3" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; WIDTH: 110px; BORDER-BOTTOM: dimgray 1px solid; HEIGHT: 20px; BACKGROUND-COLOR: white; TEXT-ALIGN: right"
															...
															<TR>
																...
																<TD height="16" aline="left">
																	<igsch:webdatechooser id="wdc_EditReceivingDate" runat="server" Height="16px" Width="110px" NullDateLabel=" " Text="Null" columnKey="ReceivingOrderDate">
																		<CALENDARLAYOUT DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																			ShowTitle="False" ShowFooter="False">
																			<SELECTEDDAYSTYLE ForeColor="White" BackColor="#0A246A"></SELECTEDDAYSTYLE>
																			<OTHERMONTHDAYSTYLE ForeColor="White"></OTHERMONTHDAYSTYLE>
																...
																<TD height="16" aline="left">
																	<INPUT id="igtbl_TextBox_0_6" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; WIDTH: 110px; BORDER-BOTTOM: dimgray 1px solid; HEIGHT: 20px; BACKGROUND-COLOR: white; TEXT-ALIGN: right"
															...
															<TR>
																...
																<TD height="16" aline="left"><FONT face="굴림">
																		<igsch:webdatechooser id="wdc_Date1" runat="server" Height="20px" Width="110px" NullDateLabel=" " Text="Null" columnKey="DeliveryRequestDate1">
																			<CALENDARLAYOUT DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																				ShowTitle="False" ShowFooter="False">
																				<SELECTEDDAYSTYLE ForeColor="White" BackColor="#0A246A"></SELECTEDDAYSTYLE>
																				<OTHERMONTHDAYSTYLE ForeColor="White"></OTHERMONTHDAYSTYLE>
																...
																<TD align="right" width="110" bgColor="#dcdcdc" height="16"><FONT style="FONT-SIZE: 9pt" face="굴림">2차납기요구량</FONT></TD>
															...
															<TR>
																<TD align="right" width="110" bgColor="#dcdcdc" height="16"><FONT face="굴림">2차납기요구일</FONT></TD>
																<TD height="16" aline="left"><FONT face="굴림">
																		<igsch:webdatechooser id="wdc_Date2" runat="server" Height="20px" Width="110px" NullDateLabel=" " Text="Null" columnKey="DeliveryRequestDate2">
																			<CALENDARLAYOUT DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																				ShowTitle="False" ShowFooter="False">
																				<SELECTEDDAYSTYLE ForeColor="White" BackColor="#0A246A"></SELECTEDDAYSTYLE>
																				<OTHERMONTHDAYSTYLE ForeColor="White"></OTHERMONTHDAYSTYLE>
																...
																<TD align="right" width="110" bgColor="#dcdcdc" height="16"><FONT style="FONT-SIZE: 9pt" face="굴림">3차납기요구량</FONT></TD>
																...
																<TD align="right" width="110" bgColor="#dcdcdc" height="16"><FONT face="굴림"><FONT style="FONT-SIZE: 9pt" face="굴림">3차납기요구일</FONT></FONT></TD>
																<TD height="16" aline="left"><FONT face="굴림"><FONT face="굴림">
																			<igsch:webdatechooser id="wdc_Date3" runat="server" Height="20px" Width="110px" NullDateLabel=" " Text="Null" columnKey="DeliveryRequestDate3">
																				<CALENDARLAYOUT DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																					ShowTitle="False" ShowFooter="False">
																					<SELECTEDDAYSTYLE ForeColor="White" BackColor="#0A246A"></SELECTEDDAYSTYLE>
																					<OTHERMONTHDAYSTYLE ForeColor="White"></OTHERMONTHDAYSTYLE>
															...
															<TR>
																...
																<TD align="right" width="110" bgColor="#dcdcdc" height="16"><FONT face="굴림">4차납기요구일</FONT></TD>
																<TD height="16" aline="left"><FONT face="굴림">
																		<igsch:webdatechooser id="wdc_Date4" runat="server" Height="20px" Width="110px" NullDateLabel=" " Text="Null" columnKey="DeliveryRequestDate4">
																			<CALENDARLAYOUT DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																				ShowTitle="False" ShowFooter="False">
																				<SELECTEDDAYSTYLE ForeColor="White" BackColor="#0A246A"></SELECTEDDAYSTYLE>
																				<OTHERMONTHDAYSTYLE ForeColor="White"></OTHERMONTHDAYSTYLE>
																...
																<TD width="110" bgColor="#dcdcdc" height="16" aline="right"><FONT face="굴림">&nbsp;5차납기요구량</FONT></TD>
															...
															<TR>
																<TD align="right" bgColor="#dcdcdc" height="16"><FONT face="굴림">5차납기요구일</FONT></TD>
																<TD><FONT face="굴림">
																		<igsch:webdatechooser id="wdc_Date5" runat="server" Height="20px" Width="110px" NullDateLabel=" " Text="Null" columnKey="DeliveryRequestDate5">
																			<CALENDARLAYOUT DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
																				ShowTitle="False" ShowFooter="False">
																				<SELECTEDDAYSTYLE ForeColor="White" BackColor="#0A246A"></SELECTEDDAYSTYLE>
																				<OTHERMONTHDAYSTYLE ForeColor="White"></OTHERMONTHDAYSTYLE>
																...
																<TD align="right" bgColor="#dcdcdc" height="16"><FONT face="굴림">적용단가</FONT></TD>
																<TD height="16"><FONT face="굴림"> <INPUT id="igtbl_TextBox_0_19" onkeydown="OnKeyDown_Float(this);" onblur="OnBlur_Float(this);"
																			onkeyup="return Process();" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; WIDTH: 110px; BORDER-BOTTOM: dimgray 1px solid; HEIGHT: 20px; BACKGROUND-COLOR: white; TEXT-ALIGN: right"
																			onfocus="OnFocus_Obj(this);" type="text" columnKey="ApplyUnitCost"></FONT></TD>
																<TD align="right" bgColor="#dcdcdc" height="16"><FONT face="굴림">납품장소</FONT></TD>
																<TD height="16"><FONT face="굴림"><FONT face="굴림"> <INPUT id="igtbl_TextBox_0_26" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; WIDTH: 110px; BORDER-BOTTOM: dimgray 1px solid; HEIGHT: 20px; BACKGROUND-COLOR: white; TEXT-ALIGN: right"
																				type="text" columnKey="DeliveryPlace"></FONT></FONT></TD>
															</TR>
															<TR>
																<TD style="HEIGHT: 16px" align="right" bgColor="#dcdcdc"><FONT face="굴림"><FONT face="굴림"><FONT face="굴림">발주번호</FONT></FONT></FONT></TD>
																<TD style="HEIGHT: 16px"><FONT face="굴림"><FONT face="굴림"><FONT face="굴림"> <INPUT id="igtbl_TextBox_0_25" style="BORDER-RIGHT: dimgray 1px solid; BORDER-TOP: dimgray 1px solid; BORDER-LEFT: dimgray 1px solid; WIDTH: 110px; BORDER-BOTTOM: dimgray 1px solid; HEIGHT: 20px; BACKGROUND-COLOR: white; TEXT-ALIGN: right"
																					type="text" columnKey="OrderNum"></FONT></FONT></FONT></TD>
																<TD style="HEIGHT: 16px" colSpan="4"><FONT face="굴림"></FONT></TD>
															</TR>
															<TR>
			...
			<igtblexp:ultrawebgridexcelexporter id="UltraWebGridExcelExporter1" runat="server"></igtblexp:ultrawebgridexcelexporter><INPUT id="lb_Total" style="Z-INDEX: 102; LEFT: 856px; WIDTH: 80px; POSITION: absolute; TOP: 576px; HEIGHT: 20px; BACKGROUND-COLOR: #eeeee9"
				type="hidden" value="0" runat="server" size="8"><INPUT id="lb_RowSelectIndex" style="Z-INDEX: 103; LEFT: 848px; WIDTH: 80px; POSITION: absolute; TOP: 88px; HEIGHT: 20px"
