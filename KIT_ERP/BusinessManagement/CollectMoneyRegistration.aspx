...
<HTML>
	<HEAD>
		...
		function wcCompany_AfterSelectChange(webComboId){
			...
			document.CollectMoneyRegistration.txtUncollectMoney.value = MakeCommaSeparate(obj.getGrid().Rows.getRow(obj.getSelectedIndex()).getCellFromKey("UncollectMoney").getValue());
		...
		function UltraWebGrid1_DblClickHandler(gridName, cellId){
			...
			document.CollectMoneyRegistration.tb_ItemPaymentCost.value = MakeCommaSeparate(row.getCellFromKey("ItemPaymentCost").getValue());//수금액(물품대)
			document.CollectMoneyRegistration.lb_OldCost.value = row.getCellFromKey("ItemPaymentCost").getValue();//수금액(물품대)
			document.CollectMoneyRegistration.tb_SupplementaryValueTaxPaymentCost.value = MakeCommaSeparate(row.getCellFromKey("SupplementaryValueTaxPaymentCost").getValue());//수금액(부가세)
			...
			<TABLE id="Table1" style="LEFT: 10px; WIDTH: 800px; POSITION: absolute; TOP: 10px" cellSpacing="0"
						...
						<FIELDSET style="BORDER-RIGHT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-LEFT: #696969 2px solid; WIDTH: 100%; BORDER-BOTTOM: #696969 2px solid"><LEGEND align="top">[입력]</LEGEND>
							<TABLE id="Table3" height="185" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD align="left" width="156" height="30"><igcmbo:webcombo id="wcCompany" runat="server" Editable="True" ForeColor="Black" Version="3.00" SelForeColor="White"
											BorderColor="DimGray" Height="20px" SelectedIndex="-1" Width="130px" BackColor="#EEEEE9" SelBackColor="10, 36, 106" BorderWidth="1px"
											BorderStyle="Solid" DropImageXP1="/ig_common/WebGrid3/ig_cmboDown1.bmp" DropImageXP2="/ig_common/WebGrid3/ig_cmboDown2.bmp" Font-Size="9pt">
											<Columns>
									...
									<TD align="left" width="156" height="30"><igsch:webdatechooser id="wdcCollectMoneyDate" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											Font-Size="9pt" NullDateLabel=" " Text=" " MaxDate="2076-06-06">
									...
									<TD align="left" width="157" height="30"><asp:dropdownlist id="dl_DecisionMethod" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD align="right" width="110" height="30"><FONT face="굴림">수금액(물품대)&nbsp;</FONT></TD>
									<TD align="left" width="156" height="30"><asp:textbox id="tb_ItemPaymentCost" style="TEXT-ALIGN: right" runat="server" Height="20px" Width="130px"
											BackColor="#EEEEE9" BorderStyle="Inset" Font-Size="9pt">0</asp:textbox></TD>
									...
									<TD align="left" width="156" height="30"><asp:textbox id="tb_SupplementaryValueTaxPaymentCost" style="TEXT-ALIGN: right" runat="server"
											Height="20px" Width="130px" BackColor="#EEEEE9" BorderStyle="Inset" Font-Size="9pt">0</asp:textbox></TD>
									<TD align="right" width="110" height="30"><FONT face="굴림">미 수 금&nbsp; </FONT>
									</TD>
									<TD align="left" width="157" height="30"><FONT face="굴림"><asp:textbox id="txtUncollectMoney" style="TEXT-ALIGN: right" runat="server" Height="20px" Width="130px"
												BackColor="#EEEEE9" BorderStyle="Inset" Font-Size="9pt" ReadOnly="True">0</asp:textbox></FONT></TD>
								</TR>
								<TR>
									<TD align="right" width="110" height="30"><FONT face="굴림">어음번호1&nbsp;</FONT></TD>
									<TD align="left" width="156" height="30"><asp:textbox id="tb_BillNum1" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											BorderStyle="Inset" Font-Size="9pt"></asp:textbox></TD>
									<TD align="right" width="110" height="30"><FONT face="굴림">결재일자1&nbsp;</FONT></TD>
									<TD align="left" width="156" height="30"><igsch:webdatechooser id="wdcPaymentDate1" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											Font-Size="9pt" NullDateLabel=" " Text="Null" MaxDate="2076-06-06">
											<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
												MaxDate="2076-06-06" ShowTitle="False" ShowFooter="False">
												<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
												<OtherMonthDayStyle ForeColor="White"></OtherMonthDayStyle>
									...
									<TD align="left" width="157" height="30"><asp:dropdownlist id="dl_BankName1" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD align="right" width="110" height="30"><FONT face="굴림">어음번호2&nbsp;</FONT></TD>
									<TD align="left" width="156" height="30"><asp:textbox id="tb_BillNum2" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											BorderStyle="Inset" Font-Size="9pt"></asp:textbox></TD>
									<TD align="right" width="110" height="30"><FONT face="굴림">결재일자2&nbsp;</FONT></TD>
									<TD align="left" width="156" height="30"><igsch:webdatechooser id="wdcPaymentDate2" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											Font-Size="9pt" NullDateLabel=" " Text="Null" MaxDate="2076-06-06">
											<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
												MaxDate="2076-06-06" ShowTitle="False" ShowFooter="False">
												<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
									...
									<TD align="left" width="157" height="30"><asp:dropdownlist id="dl_BankName2" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD align="right" width="110" height="30"><FONT face="굴림">어음번호3&nbsp;</FONT></TD>
									<TD align="left" width="156" height="30"><asp:textbox id="tb_BillNum3" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											BorderStyle="Inset" Font-Size="9pt"></asp:textbox></TD>
									<TD align="right" width="110" height="30"><FONT face="굴림">결재일자3&nbsp;</FONT></TD>
									<TD align="left" width="156" height="30"><FONT face="굴림"><igsch:webdatechooser id="wdcPaymentDate" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
												Font-Size="9pt" NullDateLabel=" " Text="Null" MaxDate="2076-06-06">
												<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
													MaxDate="2076-06-06" ShowTitle="False" ShowFooter="False">
													<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
									...
									<TD align="left" width="157" height="30"><asp:dropdownlist id="dl_BankName3" runat="server" Height="20px" Width="130px" BackColor="#EEEEE9"
											Font-Size="9pt"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD style="HEIGHT: 7px" align="right" width="800" colSpan="6" height="7"><FONT face="굴림"></FONT></TD>
								</TR>
								<TR>
									<TD vAlign="middle" align="right" width="800" colSpan="6" height="30"><INPUT id="lb_CollectMoneyDate" style="WIDTH: 50px; HEIGHT: 20px" type="hidden" runat="server"><INPUT id="lb_OldCost" style="WIDTH: 50px; HEIGHT: 20px" type="hidden" size="3" value="0"
											name="Hidden1" runat="server"><INPUT id="lb_Index" style="WIDTH: 50px; HEIGHT: 20px" type="hidden" value="0" name="Hidden1"
											runat="server">
										...
										<asp:button id="bt_Update" runat="server" Height="20px" Width="60px" Text="수  정" Enabled="False"></asp:button>&nbsp;<asp:button id="bt_Register" runat="server" Height="20px" Width="60px" Text="등  록"></asp:button>&nbsp;</TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
				...
				<TR>
					...
					<TD vAlign="top" align="center" width="800">&nbsp;
						<FIELDSET style="BORDER-RIGHT: #696969 2px solid; BORDER-TOP: #696969 2px solid; BORDER-LEFT: #696969 2px solid; BORDER-BOTTOM: #696969 2px solid"><LEGEND align="top">[입력결과]</LEGEND><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Height="310px" Width="100%">
								...
								<Bands>
									<igtbl:UltraGridBand>
										<Columns>
											...
											<igtbl:UltraGridColumn HeaderText="결재은행코드2" Key="BankCode1" Hidden="True" HeaderClickAction="SortMulti"
												BaseColumnName="BankCode1">
												<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
												<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
											</igtbl:UltraGridColumn>
