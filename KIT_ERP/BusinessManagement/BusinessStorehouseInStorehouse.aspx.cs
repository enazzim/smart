...
{
	/// <summary>
	/// BusinessStorehouseInStorehouse에 대한 요약 설명입니다.
	/// </summary>
	public class BusinessStorehouseInStorehouse : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Button bt_InStoreHouse;
		...
		{    
			...
			this.bt_InStoreHouse.Click += new System.EventHandler(this.bt_InStoreHouse_Click);
		...
		private void search()
		{
			...
			if(ItemSearchControl1.hdItem.Trim() == "")
				aa = new Search("BusinessStorehouseInStorehouse",ItemSearchControl1.ItemNum,ItemSearchControl1.ItemDrawNum,ItemSearchControl1.ItemName,wdcFromDate,wdcToDate);
			else
				aa = new Search("BusinessStorehouseInStorehouse",ItemSearchControl1.ItemNum,"","",wdcFromDate,wdcToDate);
		...
		/// <param name="e"></param>
		private void bt_InStoreHouse_Click(object sender, System.EventArgs e)
		{
			
				
			Register reg = new Register(UltraWebGrid1,"BusinessStorehouseInStorehouse",Session["ID"].ToString());
		...
		{
			Search aa = new Search("BusinessStorehouseInStorehouse",ItemSearchControl1.ItemNum,ItemSearchControl1.ItemDrawNum,ItemSearchControl1.ItemName,wdcFromDate,wdcToDate);
