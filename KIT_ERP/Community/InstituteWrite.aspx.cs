...
{
	/// <summary>
	/// InstituteWrite에 대한 요약 설명입니다.
	/// </summary>
	public class InstituteWrite : System.Web.UI.Page
	{
		...
		{    
			...
			this.sqlConnection1.ConnectionString = "workstation id=\"EZSYS-ERP01\";packet size=4096;user id=sa;data source=\"220.66.115.9\";persist " +
				"security info=True;initial catalog=Sindong;password=\"ezsys#0509\"";
			// 
			// dsUser1
			// 
		...
		private int Max(SqlConnection conn, SqlTransaction tr)
		{
			...
			comm.Transaction = tr;
			comm.CommandText = "Select Max(seq) From T_Institute";
