<%@ Page language="c#" Codebehind="PresidentNoticeEdit.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.PresidentNoticeEdit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PresidentNoticeEdit</title>
					...
					<TD vAlign="top" colSpan="2">
						<TABLE id="Table2" style="WIDTH: 800px; TOP: 1px" borderColor="#000000" cellSpacing="0"
							...
							<TR>
								...
								<TD width="180" bgColor="#f5f5f5" colSpan="5" height="30"><asp:listbox id="ListBox1" runat="server" Height="140px" Width="150px" BackColor="#EEEEE9" SelectionMode="Multiple"></asp:listbox></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
