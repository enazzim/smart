<%@ Page language="c#" Codebehind="InstituteList.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.InstituteList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>InstituteList</title>
				...
				<TBODY>
					...
					<TR>
						<td vAlign="top" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="800px" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:HyperLinkColumn Target="_self" DataNavigateUrlField="seq" DataNavigateUrlFormatString="InstituteContent.aspx?seq={0}"
