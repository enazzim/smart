<%@ Page language="c#" Codebehind="CSRegistration.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.CSRegistration" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>사내표준현황-글쓰기</title>
	...
	<body onload="document.Form1.Title.focus();" bgColor="#f7f6f6" ms_positioning="GridLayout">
				...
				<TR>
					...
					<TD vAlign="top">
						<TABLE id="Table1" borderColor="#000000" height="520" cellSpacing="0" borderColorDark="dimgray"
							...
							<TR>
								<TD style="WIDTH: 100px" vAlign="middle" align="center" bgColor="#f5f5f5" height="20"><FONT face="굴림"><STRONG>Category</STRONG></FONT></TD>
								<TD vAlign="middle" bgColor="#f5f5f5" colSpan="3" height="20"><FONT face="굴림">
										...
										<asp:CheckBox id="CheckBox1" runat="server" Text="Category 직접입력 : " Font-Bold="True" ForeColor="ControlDarkDark"
