<%@ Page language="c#" Codebehind="MaterialsContent.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.MaterialsContent" %>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<tr>
					...
					<TD vAlign="middle" align="center" width="800" height="28" colSpan="2"><FONT face="굴림">
							<FIELDSET style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; WIDTH: 720px; BORDER-BOTTOM: #000000 1px solid; HEIGHT: 88px"
