<%@ Page language="c#" Codebehind="PresidentNoticeWrite.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.PresidentNoticeWrite" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PresidentNoticeWrite</title>
	...
	<body bgColor="#f7f6f6" onload="document.Form1.Title.focus();">
		<form id="Form1" method="post" encType="multipart/form-data" runat="server">
			<FONT face="굴림">
				<table id="Table2" style="Z-INDEX: 101; POSITION: absolute; TOP: 0px; LEFT: 0px" borderColor="#0"
						...
						<TD vAlign="top">
							<TABLE id="Table1" borderColor="#000000" cellSpacing="0" borderColorDark="dimgray" cellPadding="0"
								...
								<TR>
									...
									<TD vAlign="middle" bgColor="whitesmoke" height="30"><asp:textbox id="RegistrationPerson" runat="server" BackColor="#EEEEE9" BorderColor="Gray" BorderStyle="Inset"
								...
								<TR>
									...
									<TD vAlign="middle" bgColor="whitesmoke" height="30"><asp:textbox id="Title" runat="server" BackColor="#EEEEE9" BorderColor="Gray" BorderStyle="Inset"
