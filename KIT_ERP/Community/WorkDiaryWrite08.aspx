<%@ Page language="c#" Codebehind="WorkDiaryWrite08.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.WorkDiaryWrite08" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>WorkDiaryWrite08</title>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table id="table1" style="BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none"
				...
				<TR>
					<TD style="BORDER-BOTTOM: #000000 1px; BORDER-LEFT: #000000 1px solid; WORD-BREAK: break-all; BORDER-TOP: #000000 1px solid; BORDER-RIGHT: #000000 1px solid"
				...
				<tr>
					<td style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top" width="700"
