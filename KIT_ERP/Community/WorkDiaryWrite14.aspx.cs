...
{
	/// <summary>
	/// WorkDiaryWrite14에 대한 요약 설명입니다.
	/// </summary>
	public class WorkDiaryWrite14 : System.Web.UI.Page
	{
			...
			try
			{
				...
				foreach(DataRow dr in ds.Tables[0].Rows)
				{
					if(dr["approval"].ToString() == "기결")
					{
						...
						Literal3.Text = "<br>"+ReplaceBR(dr["06"].ToString());
						Literal4.Text = "<br>"+ReplaceBR(dr["07"].ToString());
						Literal5.Text = "<br>"+ReplaceBR(dr["03"].ToString());
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				Cmd.Parameters.Add("@index",hdIndex.Value.Trim());
				Cmd.Parameters.Add("@06",TextBox4.Text);
				Cmd.ExecuteNonQuery();
				Cmd.Parameters.Clear();
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if(Approval == "기결")
					...
					str = @"Update WorkReportID Set  [01] = @01, [02] = @02, [03] = @03, [07] = @07, [10] = @10  Where [Index] = @index";
				...
				Cmd.Parameters.Add("@03",TextBox5.Text);
