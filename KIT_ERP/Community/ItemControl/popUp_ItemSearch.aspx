...
<%@ Page language="c#" Codebehind="popUp_ItemSearch.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.ItemControl.popUp_ItemSearch" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>popUp_ItemSearch</title>
							...
							<Bands>
								<igtbl:UltraGridBand>
									<Columns>
										...
										<igtbl:UltraGridColumn HeaderText="도면번호" Key="itemdrawnum" Width="300px" BaseColumnName="도면번호"></igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="품목명" Key="itemname" Width="200px" BaseColumnName="품목명"></igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="규격" Key="Standard" Width="98px" BaseColumnName="Standard"></igtbl:UltraGridColumn>
									</Columns>
								</igtbl:UltraGridBand>
							</Bands>
