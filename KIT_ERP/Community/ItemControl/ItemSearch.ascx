<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ItemSearch.ascx.cs" Inherits="KIT_ERP.Community.ItemControl.ItemSearch" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<!--
	function openPopupChild(id, controlName, propertyClassification, businessRegistrationNum, unitcostDistinction)
	{
		...
		arr = window.showModalDialog
			("../ItemControl/popUp_ItemSearch.aspx?tag="+ controlName + "&value=" + value + "&propertyClassification=" + propertyClassification + "&businessregistrationnum=" + businessRegistrationNum + "&unitcostdistinction=" + unitcostDistinction ,"f", "dialogHeight: 400px; dialogWidth: 807px; center: yes; help: no; resizable: no; status: no;");
