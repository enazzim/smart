...
{
	/// <summary>
	/// WorkDiaryWrite16에 대한 요약 설명입니다.
	/// </summary>
	public class WorkDiaryWrite16 : System.Web.UI.Page
	{
			...
			try
			{
				...
				foreach(DataRow dr in ds.Tables[0].Rows)
				{
					if(dr["approval"].ToString() == "기결")
					{
						...
						Literal5.Text = "<br>"+ReplaceBR(dr["07"].ToString());

						Literal6.Text = "<br>"+ReplaceBR(dr["04"].ToString());
						Literal7.Text = "<br>"+ReplaceBR(dr["05"].ToString());
