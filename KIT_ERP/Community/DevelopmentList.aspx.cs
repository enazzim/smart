...
{
	/// <summary>
	/// DevelopmentList에 대한 요약 설명입니다.
	/// </summary>
	public class DevelopmentList : System.Web.UI.Page
	{
		...
		private DataSet Search()
		{
			...
			Cmd.Connection = Con;
			Cmd.CommandText = @"Select  seq, thread, depth, writer, title, Convert(varchar, transdate, 111) as transdate FROM T_Development ORDER BY thread desc";			
		...
		{
			Response.Redirect("DevelopmentWrite.aspx");
		}
