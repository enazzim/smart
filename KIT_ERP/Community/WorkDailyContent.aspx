<%@ Page language="c#" Codebehind="WorkDailyContent.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.WorkDailyContent" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>WorkDailyContent</title>
	...
	<body bgColor="#f7f6f6">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px; HEIGHT: 550px"
				height="621" cellSpacing="0" cellPadding="0" width="800" align="center" border="0">
				<TR>
					<TD vAlign="bottom" width="20"><FONT face="굴림"></FONT></TD>
					<TD vAlign="bottom" align="right" colSpan="2">
						<asp:button id="btnReply" runat="server" Height="20px" Width="65px" Text="답   변"></asp:button><FONT face="굴림">&nbsp;
						</FONT>
					</TD>
				</TR>
				<TR>
					...
					<TD vAlign="top" colSpan="2">
						<TABLE id="Table2" style="WIDTH: 800px; TOP: 1px; HEIGHT: 492px" borderColor="#000000"
							height="492" cellSpacing="0" borderColorDark="dimgray" cellPadding="0" width="800"
							...
							<TR>
								...
								<TD width="180" bgColor="whitesmoke" height="30">
									<P align="center">
										<asp:label id="lbWriter" runat="server" ForeColor="ControlDarkDark"></asp:label></P>
								</TD>
								<TD width="100" bgColor="whitesmoke" height="30">
									<P align="center"><FONT face="굴림"><STRONG>작 성 일</STRONG></FONT></P>
								</TD>
								<TD width="250" bgColor="whitesmoke" height="30" colspan="3">
									<P align="center">
										<asp:label id="lblRegistrationDate" runat="server" ForeColor="ControlDarkDark"></asp:label></P>
								</TD>
							</TR>
							<TR>
								...
								<TD vAlign="middle" bgColor="whitesmoke" colSpan="6" height="30">
									<asp:textbox id="txtTitle" runat="server" Height="20px" Width="99.9%" MaxLength="50" BorderStyle="Inset"
										BorderColor="Gray" BorderWidth="1px" ReadOnly="True" BackColor="#EEEEE9" Font-Size="9pt"></asp:textbox>
									<asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ErrorMessage="제목을 입력해주세요!" ControlToValidate="txtTitle"
							...
							<TR>
								...
								<TD style="WIDTH: 180px" bgColor="#f5f5f5" height="30"><FONT face="굴림">
							...
							<TR>
								...
								<TD bgColor="whitesmoke" colSpan="6"><FONT face="굴림"></FONT><FONT face="굴림"></FONT><FONT face="굴림">
										<asp:textbox id="txtContents" runat="server" Height="440px" Width="100%" BorderStyle="Inset"
											BorderColor="Gray" BorderWidth="1px" ReadOnly="True" BackColor="#EEEEE9" Font-Size="9pt"
											Rows="23" TextMode="MultiLine"></asp:textbox>
										<asp:requiredfieldvalidator id="RequiredFieldValidator2" runat="server" ErrorMessage="내용을 입력해주세요!" ControlToValidate="txtContents"
				...
				<TR>
					...
					<TD vAlign="middle" align="right" width="440" height="28">
						<asp:validationsummary id="ValidationSummary1" runat="server" DisplayMode="List" ShowMessageBox="True"
							ShowSummary="False"></asp:validationsummary>
						<asp:button id="btnEdit" runat="server" Height="20px" Width="65px" Text="수   정" Enabled="False"
