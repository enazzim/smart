...
{
	/// <summary>
	/// PipeContent에 대한 요약 설명입니다.
	/// </summary>
	public class PipeContent : System.Web.UI.Page
	{
		...
		private void LoadData()
		{
			...
			comm.CommandText = "SELECT TOP 1 seq FROM T_Pipe WHERE seq < @seq ORDER BY seq DESC";
			...
			comm = new SqlCommand("SELECT TOP 1 seq FROM T_Pipe WHERE seq > @seq ORDER BY seq ASC", conn);
			comm.Parameters.Add("@seq", SqlDbType.Int).Value = Request.QueryString["seq"];
			if(comm.ExecuteScalar() == null)
			{
			...
			hlnkPreContent.NavigateUrl = "PipeContent.aspx?seq=" + Pre.ToString();
			hlnkNextContent.NavigateUrl = "PipeContent.aspx?seq=" + Next.ToString();
		...
		private void btnReply_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("PipeWrite.aspx?thread=" + thread + "&depth=" + depth + "&seq=" + seq);
		}

		private void btnEdit_Click(object sender, System.EventArgs e)
		{
			Response.Redirect("PipeEdit.aspx?seq=" + ViewState["seq"].ToString());   
		}
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				Cmd.CommandText = "DELETE FROM T_Pipe WHERE seq = @seq";							
				Cmd.Parameters.Add("@seq", SqlDbType.Int);
				Cmd.Parameters["@seq"].Value = seq;
				Cmd.ExecuteNonQuery();
