...
{
	/// <summary>
	/// CSDownload에 대한 요약 설명입니다.
	/// </summary>
	public class CSDownload : System.Web.UI.Page
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!Page.IsPostBack)
			{
				...
				Cmd.CommandText = "SELECT * FROM CCS_T WHERE CCompanyStandardIndex = @CCompanyStandardIndex";
				Cmd.Parameters.Add("@CCompanyStandardIndex", SqlDbType.Int);
				Cmd.Parameters["@CCompanyStandardIndex"].Value = Request.QueryString["CCompanyStandardIndex"];
