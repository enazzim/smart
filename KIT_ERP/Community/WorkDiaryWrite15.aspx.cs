...
{
	/// <summary>
	/// WorkDiaryWrite15에 대한 요약 설명입니다.
	/// </summary>
	public class WorkDiaryWrite15 : System.Web.UI.Page
	{
			...
			try
			{
				...
				foreach(DataRow dr in ds.Tables[0].Rows)
				{
					if(dr["approval"].ToString() == "기결")
					{
						...
						Literal4.Text = "<br>"+ReplaceBR(dr["06"].ToString());
					...
					else
					{
						...
						else
						{
							...
							TextBox2.Text = dr["02"].ToString();
							TextBox3.Text = dr["03"].ToString();
							Literal4.Text = "<br>"+ReplaceBR(dr["06"].ToString());
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if(Approval == "기결")
					...
					str = @"Update WorkReportID Set  [01] = @01, [02] = @02, [03] = @03, [06] = @06  Where [Index] = @index";
				
				
				Cmd.Parameters.Add("@index",hdIndex.Value.Trim());
				Cmd.Parameters.Add("@01",TextBox1.Text);
				Cmd.Parameters.Add("@02",TextBox2.Text);
				Cmd.Parameters.Add("@03",TextBox3.Text);
				Cmd.Parameters.Add("@06",TextBox4.Text);;
				Cmd.CommandText = str;
				Cmd.ExecuteNonQuery();
				tr.Commit();
