...
<%@ Page language="c#" Codebehind="RealItemOrganizationInfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.Popup.RealItemOrganizationInfo" %>
				...
				<TR>
					<TD style="FONT-SIZE: 0pt; HEIGHT: 179px" vAlign="top" align="center"><asp:datagrid id="DataGrid1" runat="server" Font-Size="10pt" Width="680px" AllowPaging="True"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="RealItemOrganizationInfoIndex" HeaderText="Index No.">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
