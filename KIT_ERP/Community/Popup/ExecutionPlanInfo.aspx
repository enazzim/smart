<%@ Page language="c#" Codebehind="ExecutionPlanInfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.Popup.ExecutionPlanInfo" %>
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" border="0" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px">
				...
				<TR>
					<TD vAlign="top" align="center" style="FONT-SIZE: 0pt">
						<asp:DataGrid id="DataGrid1" runat="server" Width="948px" AutoGenerateColumns="False" Font-Size="10pt"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="ExecutionPlanInfoIndex" HeaderText="Index No.">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
								...
								<asp:BoundColumn DataField="PlanDate" HeaderText="날짜">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="PlanQuantity" HeaderText="계획수량">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="SaleUnitCost" HeaderText="판매단가">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="PlanTotalCost" HeaderText="계획총금액">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
							</Columns>
