<%@ Page language="c#" Codebehind="OutSideOrderUnitCostInfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.Popup.OutSideOrderUnitCostInfo" %>
					...
					<TD align="left" height="30">
						<table cellpadding="0" cellspacing="0" border="0" id="Table2">
							<tr>
								...
								<td width="174" align="right"><INPUT style="WIDTH: 60px; HEIGHT: 20px" onclick="ResettxtBox()" type="button" value="초기화"></td>
							</tr>
							<tr>
								<td width="600">
									<uc1:ItemSearch id="ISC1" runat="server"></uc1:ItemSearch></td>
								<td width="174" align="right"><FONT face="굴림">
					...
					<TD vAlign="top" align="center" style="FONT-SIZE: 0pt">
						<asp:DataGrid id="DataGrid1" runat="server" Width="768px" AutoGenerateColumns="False" Font-Size="10pt"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="BeginProcess" HeaderText="시작공정">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="EndProcess" HeaderText="종료공정">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
