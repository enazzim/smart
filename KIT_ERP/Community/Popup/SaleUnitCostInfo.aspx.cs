...
{
	/// <summary>
	/// SaleUnitCostInfo에 대한 요약 설명입니다.
	/// </summary>
	public class SaleUnitCostInfo : System.Web.UI.Page
	{
		...
		private void DataGridBind()
		{
			...
			{
				Cmd.CommandText = @"select Top "+TopCount.ToString()+ @" UCI_MT.UnitCostInfoIndex AS UnitCostInfoIndex, II_MT.ItemName AS ItemName, 
											II_MT.ItemNum AS ItemNum, CI_MT.CompanyName,
											II_MT.PropertyClassification AS PropertyClassification, 
									...
									Where CI_MT.RecodingState = 1 and  (UCI_MT.UnitCostDistinction = '판매단가') and UCI_MT.RecodingState = 1 and II_MT.RecodingState = 1 and CI_MT.RecodingState = 1  
			...
			foreach(DataGridItem item in DataGrid1.Items)
			{
				...
				if(cb.Checked)
				{
					...
					try
					{
						...
						{
							Cmd.CommandText = "INSERT CR_T VALUES('판매단가정보', "+ item.Cells[1].Text +", 'T_Materials', "+ MaterialsIndex +")";
							Cmd.ExecuteNonQuery();
							trans.Commit();
						...
						{
							Cmd.CommandText = "INSERT CR_T VALUES('판매단가정보', "+ item.Cells[1].Text +", 'T_Product', "+ ProductIndex +")";
							Cmd.ExecuteNonQuery();
							trans.Commit();
						...
						{
							Cmd.CommandText = "INSERT CR_T VALUES('판매단가정보', "+ item.Cells[1].Text +", 'T_Development', "+ DevelopmentIndex +")";
							Cmd.ExecuteNonQuery();
							trans.Commit();
