...
<%@ Page language="c#" Codebehind="RealWorkStandardInfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.Popup.RealWorkStandardInfo" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>진작업표준 정보</title>
					...
					<TD style="FONT-SIZE: 0pt; HEIGHT: 179px" vAlign="top" align="center">
						<asp:DataGrid id="DataGrid1" runat="server" Width="700px" AutoGenerateColumns="False" Font-Size="10pt"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="RealWorkStandardInfoIndex" HeaderText="Index No.">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
