<%@ Page language="c#" Codebehind="RealProcessSequenceInfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.Popup.RealRealProcessSequenceInfo" %>
					...
					<TD style="FONT-SIZE: 0pt; HEIGHT: 179px" vAlign="top" align="center">
						<asp:DataGrid id="DataGrid1" runat="server" Width="700px" AutoGenerateColumns="False" Font-Size="10pt"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="RealProcessSequenceInfoIndex" HeaderText="Index No.">
									<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								</asp:BoundColumn>
