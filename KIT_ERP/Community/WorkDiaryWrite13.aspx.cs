...
{
	/// <summary>
	/// WorkDiaryWrite13에 대한 요약 설명입니다.
	/// </summary>
	public class WorkDiaryWrite13 : System.Web.UI.Page
	{
			...
			try
			{
				...
				foreach(DataRow dr in ds.Tables[0].Rows)
				{
					if(dr["approval"].ToString() == "기결")
					{
						...
						Literal5.Text = "<br>"+ReplaceBR(dr["06"].ToString());
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if(Approval == "기결")
					...
					str =  @"Update WorkReportID Set  [01] = @01, [02] = @02, [03] = @03, [04] = @04, [07] = @07, [10] = @10   Where [Index] = @index";
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				Cmd.Parameters.Add("@index",hdIndex.Value.Trim());
				Cmd.Parameters.Add("@06",TextBox6.Text);
				Cmd.ExecuteNonQuery();
				Cmd.Parameters.Clear();
