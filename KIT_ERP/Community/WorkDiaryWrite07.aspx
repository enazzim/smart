<%@ Page language="c#" Codebehind="WorkDiaryWrite07.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.WorkDiaryWrite07" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>WorkDiaryWrite07</title>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table width="700" border="1" cellspacing="0" cellpadding="0" style="BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none"
				...
				<tr>
					<td height="38" colspan="2" Width="700" style="BORDER-BOTTOM: #000000 1px; BORDER-LEFT: #000000 1px solid; HEIGHT: 38px; BORDER-TOP: #000000 1px solid; BORDER-RIGHT: #000000 1px solid"
						align="center">&nbsp;
				...
				<tr>
					...
					<td style="BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none; WORD-BREAK: break-all" align="left"
						width="300">&nbsp;
				...
				<tr>
					<td colspan="2" style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top"
						height="100" Width="700"><FONT face="±¼¸²">&nbsp;
				...
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top" colSpan="2"
						height="100" Width="700"><FONT face="±¼¸²">&nbsp;
							...
							<asp:TextBox id="TextBox6" runat="server" Width="700px" Font-Size="9pt" Height="100px" TextMode="MultiLine"
				...
				<TR style="BORDER-TOP-STYLE: none">
					<TD style="BORDER-RIGHT-STYLE: none; WORD-BREAK: break-all; BORDER-TOP: #000000 1px solid"
						vAlign="middle" Width="400" align="left" height="25"><FONT face="±¼¸²">&nbsp;
