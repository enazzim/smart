<%@ Page language="c#" Codebehind="WorkDiaryWrite16.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.WorkDiaryWrite16" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>WorkDiaryWrite11</title>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table width="700" border="1" cellspacing="0" cellpadding="0" style="BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none"
				...
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" height="200" vAlign="top"
						width="700" colSpan="2">
						<asp:Literal id="Literal6" runat="server"></asp:Literal>
						<asp:TextBox style="Z-INDEX: 0" id="TextBox6" runat="server" Font-Names="±¼¸²" Font-Size="9pt"
				...
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" height="100" vAlign="top"
						width="700" colSpan="2"><FONT face="±¼¸²">
							...
							<asp:TextBox style="Z-INDEX: 0" id="TextBox7" runat="server" Font-Names="±¼¸²" Font-Size="9pt"
