...
{
	/// <summary>
	/// WorkDiaryWrite09에 대한 요약 설명입니다.
	/// </summary>
	public class WorkDiaryWrite09 : System.Web.UI.Page
	{
			...
			try
			{
				...
				foreach(DataRow dr in ds.Tables[0].Rows)
				{
					if(dr["approval"].ToString() == "기결")
					{
						...
						Literal2.Text = "<br>"+ReplaceBR(dr["06"].ToString());
						Literal3.Text = "<br>"+ReplaceBR(dr["07"].ToString());

						Literal4.Text = "<br>"+ReplaceBR(dr["02"].ToString());
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if(Approval == "기결")
					...
					str =  @"Update WorkReportID Set  [01] = @01,[02]=@02, [07] = @07, [10] = @10  Where [Index] = @index";
				
				Cmd.Transaction = tr;
				Cmd.Parameters.Add("@index",hdIndex.Value.Trim());
				Cmd.Parameters.Add("@01",TextBox1.Text);
				Cmd.Parameters.Add("@02",TextBox4.Text);
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				Cmd.Parameters.Add("@index",hdIndex.Value.Trim());
				Cmd.Parameters.Add("@06",TextBox3.Text);
				Cmd.ExecuteNonQuery();
				Cmd.Parameters.Clear();
