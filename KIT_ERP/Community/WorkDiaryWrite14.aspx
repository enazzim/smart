<%@ Page language="c#" Codebehind="WorkDiaryWrite14.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.WorkDiaryWrite14" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>WorkDiaryWrite14</title>
			...
			<table width="700" border="1" cellspacing="0" cellpadding="0" style="BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none"
				...
				<tr>
					<td style="BORDER-BOTTOM: #000000 1px; BORDER-LEFT: #000000 1px solid; WORD-BREAK: break-all; BORDER-TOP: #000000 1px; BORDER-RIGHT: #000000 1px solid"
						vAlign="top" height="300" colspan="2" width="700"><FONT face="±¼¸²">&nbsp; </FONT>
						<asp:Literal id="Literal1" runat="server"></asp:Literal>
						<asp:TextBox id="TextBox1" runat="server" BorderStyle="None" TextMode="MultiLine" Height="300px"
				...
				<tr>
					<td colspan="2" style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top"
						height="150" width="700"><FONT face="±¼¸²">&nbsp;
							...
							<asp:TextBox id="TextBox3" runat="server" BorderStyle="None" TextMode="MultiLine" Height="150px"
								Width="700px" Font-Size="9pt" Font-Names="±¼¸²"></asp:TextBox></FONT></td>
				</tr>
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top"
						width="700" colSpan="2">
						<asp:Literal id="Literal5" runat="server"></asp:Literal>
						<asp:TextBox id="TextBox5" runat="server" Font-Names="±¼¸²" Font-Size="9pt"
							Width="700px" Height="150px" TextMode="MultiLine" BorderStyle="None"></asp:TextBox></TD>
				</TR>
				<tr>
					<td colspan="2" style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top"
						height="100" width="700">&nbsp;
						<asp:Literal id="Literal4" runat="server"></asp:Literal>
						<asp:TextBox id="TextBox2" runat="server" BorderStyle="None" TextMode="MultiLine" Height="100px"
							Width="700px" Font-Size="9pt" Font-Names="±¼¸²"></asp:TextBox></td>
				</tr>
				<tr>
					<td colspan="2" style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top"
