<%@ Page language="c#" Codebehind="TechnologyData.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.TechnologyData" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>±â¼ú ÀÚ·á½Ç</title>
				...
				<TBODY>
					...
					<TR>
						...
						<td vAlign="top" width="780" colSpan="4">
							<asp:datagrid id="DataGrid1" runat="server" PageSize="15" BorderStyle="None" BorderWidth="0px"
								BackColor="White" CellPadding="0" GridLines="Horizontal" AutoGenerateColumns="False" AllowCustomPaging="True"
								...
								<Columns>
									<asp:HyperLinkColumn DataNavigateUrlField="CTechnologyDataIndex" DataNavigateUrlFormatString="TnAdjustment.aspx?CTechnologyDataIndex={0}"
