...
{
	/// <summary>
	/// TnRegistration에 대한 요약 설명입니다.
	/// </summary>
	public class TnRegistration : System.Web.UI.Page
	{
		...
		private void btnApply_Click(object sender, System.EventArgs e)
		{
			...
			if(CheckBox1.Checked)
			{
				...
				else
				{
					...
					Cmd.Parameters.Add("@Classify", SqlDbType.SmallInt).Value = 5;
					Cmd.ExecuteNonQuery();
					Cmd.Parameters.Clear();


					Cmd.CommandText = "INSERT INTO CTD_T(Title, Category, Contents, AppendFile, FileName, FileSize, FileType, RegistrationPerson) VALUES(@Title, @Category, @Contents, @AppendFile, @FileName, @FileSize, @FileType, @RegistrationPerson)";
					...
					Response.Cookies["CTD_T"]["PageNumber"] = "0";
					Response.Redirect("TechnologyData.aspx");
				}
			}
