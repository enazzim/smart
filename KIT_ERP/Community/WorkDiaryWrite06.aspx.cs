...
{
	/// <summary>
	/// WorkDiaryWrite06에 대한 요약 설명입니다.
	/// </summary>
	public class WorkDiaryWrite06 : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Literal Literal7;
		protected System.Web.UI.WebControls.TextBox TextBox2;
		protected System.Web.UI.WebControls.TextBox TextBox8;
		protected System.Web.UI.WebControls.Literal Literal8;
		protected System.Web.UI.WebControls.TextBox TextBox9;
		protected System.Web.UI.WebControls.Literal Literal9;
			...
			try
			{
				...
				foreach(DataRow dr in ds.Tables[0].Rows)
				{
					if(dr["approval"].ToString() == "기결")
					{
						...
						Literal4.Text = "<br>"+ReplaceBR(dr["04"].ToString());
						Literal5.Text = "<br>"+ReplaceBR(dr["05"].ToString());
						Literal6.Text = "<br>"+ReplaceBR(dr["06"].ToString());
						Literal7.Text = "<br>"+ReplaceBR(dr["07"].ToString());

						Literal8.Text = "<br>"+ReplaceBR(dr["08"].ToString());
						Literal9.Text = "<br>"+ReplaceBR(dr["09"].ToString());
					...
					else
					{
						...
						else
						{
							...
							TextBox5.Text = dr["04"].ToString();
							TextBox6.Text = dr["05"].ToString();
							TextBox2.Text = dr["07"].ToString();

							TextBox8.Text = dr["08"].ToString();
							TextBox9.Text = dr["09"].ToString();
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if(Approval == "기결")
					...
					str =  @"Update WorkReportID Set  [01] = @01, [02] = @02, [03] = @03, [04] = @04, [05] = @05, [07] = @07, [08]=@08, [09]=@09, [10] = @10   Where [Index] = @index";
				...
				Cmd.Parameters.Add("@04",TextBox5.Text);
				Cmd.Parameters.Add("@05",TextBox6.Text);

				Cmd.Parameters.Add("@08",TextBox8.Text);
				Cmd.Parameters.Add("@09",TextBox9.Text);
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				Cmd.Parameters.Add("@index",hdIndex.Value.Trim());
				Cmd.Parameters.Add("@06",TextBox7.Text);
				Cmd.ExecuteNonQuery();
				Cmd.Parameters.Clear();
