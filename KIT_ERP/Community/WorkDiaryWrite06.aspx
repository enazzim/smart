<%@ Page language="c#" Codebehind="WorkDiaryWrite06.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.WorkDiaryWrite06" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>WorkDiaryWrite06</title>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table width="700" border="1" cellspacing="0" cellpadding="0" style="BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none"
				...
				<tr>
					<td style="BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; WORD-BREAK: break-all"
						width="400">&nbsp;
						<asp:Label id="lbDate" runat="server"></asp:Label></td>
					<td style="BORDER-BOTTOM: #000000 1px solid; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-RIGHT: #000000 1px solid"
				...
				<tr>
					<td style="BORDER-BOTTOM: #000000 1px; BORDER-LEFT: #000000 1px solid; WORD-BREAK: break-all; BORDER-TOP: #000000 1px; BORDER-RIGHT: #000000 1px solid"
						vAlign="top" height="100" colspan="2" Width="700">&nbsp;
						<asp:Literal id="Literal1" runat="server"></asp:Literal>
						<asp:TextBox id="TextBox1" runat="server" BorderStyle="None" TextMode="MultiLine" Height="100px"
							Width="700px" Font-Size="9pt" Font-Names="±¼¸²"></asp:TextBox></td>
				</tr>
				<tr>
					<td colspan="2" Width="700" style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all"
						vAlign="top" height="100"><FONT face="±¼¸²">&nbsp;
							<asp:Literal id="Literal2" runat="server"></asp:Literal>
							<asp:TextBox id="TextBox3" runat="server" BorderStyle="None" TextMode="MultiLine" Height="100px"
				...
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top" colSpan="2"
						Width="700" height="100"><FONT face="±¼¸²">&nbsp;
							<asp:Literal id="Literal3" runat="server"></asp:Literal>
						</FONT>
						<asp:TextBox id="TextBox4" runat="server" BorderStyle="None" TextMode="MultiLine" Height="100px"
							Width="700px" Font-Size="9pt" Font-Names="±¼¸²"></asp:TextBox></TD>
				</TR>
				<tr>
					<td colspan="2" Width="700" style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all"
				...
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top" colSpan="2"
						Width="700" height="100"><FONT face="±¼¸²">&nbsp;
							...
							<asp:TextBox id="TextBox6" runat="server" Width="700px" Font-Size="9pt" Height="150px" TextMode="MultiLine"
				...
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" height="100" vAlign="top"
						...
						<asp:TextBox style="Z-INDEX: 0" id="TextBox8" runat="server" Font-Names="±¼¸²" Font-Size="9pt"
							Width="700px" Height="200px" TextMode="MultiLine" BorderStyle="None"></asp:TextBox></TD>
				</TR>
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" height="100" vAlign="top"
						width="700" colSpan="2"><FONT face="±¼¸²">
							<asp:Literal id="Literal9" runat="server"></asp:Literal>
							<asp:TextBox style="Z-INDEX: 0" id="TextBox9" runat="server" Font-Names="±¼¸²" Font-Size="9pt"
								Width="700px" Height="100px" TextMode="MultiLine" BorderStyle="None"></asp:TextBox></FONT></TD>
				</TR>
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none" vAlign="top" colSpan="2" Width="700" height="100"><FONT face="±¼¸²">&nbsp;
				...
				<TR>
					<TD style="BORDER-BOTTOM-STYLE: none" vAlign="top" colSpan="2" Width="700" height="100"><FONT face="±¼¸²">&nbsp;
						...
						<asp:TextBox id="TextBox7" runat="server" Width="700px" Font-Size="9pt" Height="100px" TextMode="MultiLine"
							BorderStyle="None" Font-Names="±¼¸²"></asp:TextBox></TD>
				</TR>
				<tr>
				...
				<TR style="BORDER-TOP-STYLE: none; WORD-BREAK: break-all">
					...
					<TD style="BORDER-LEFT-STYLE: none; WORD-BREAK: break-all; BORDER-TOP: black 1px solid"
						vAlign="middle" align="right" height="25" Width="300"><FONT face="±¼¸²">
