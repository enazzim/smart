<%@ Page language="c#" Codebehind="PipeList.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.PipeList" %>
				...
				<TBODY>
					...
					<TR>
						<td vAlign="top" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="800px" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:HyperLinkColumn DataNavigateUrlField="seq" DataNavigateUrlFormatString="PipeContent.aspx?seq={0}" 
