<%@ Page language="c#" Codebehind="DevelopmentList.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.DevelopmentList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>DevelopmentList</title>
				...
				<TBODY>
					...
					<TR>
						<td vAlign="top" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="800px" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:HyperLinkColumn DataNavigateUrlField="seq" DataNavigateUrlFormatString="DevelopmentContent.aspx?seq={0}"
