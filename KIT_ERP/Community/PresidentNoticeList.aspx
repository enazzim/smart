<%@ Page language="c#" Codebehind="PresidentNoticeList.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.PresidentNoticeList_aspx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PresidentNoticeList</title>
				...
				<TBODY>
					...
					<TR>
						<td vAlign="top" colSpan="3"><asp:datagrid id="DataGrid1" runat="server" Width="800px" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:HyperLinkColumn DataNavigateUrlField="seq" DataNavigateUrlFormatString="PresidentNoticeContent.aspx?seq={0}"
