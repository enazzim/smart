<%@ Page language="c#" Codebehind="WorkDiaryWrite15.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.Community.WorkDiaryWrite15" %>
			...
			<table width="700" border="1" cellspacing="0" cellpadding="0" style="BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none"
				...
				<tr>
					<td style="BORDER-BOTTOM: #000000 1px; BORDER-LEFT: #000000 1px solid; WORD-BREAK: break-all; BORDER-TOP: #000000 1px; BORDER-RIGHT: #000000 1px solid"
						vAlign="top" height="150" colspan="2" width="700"><FONT face="±¼¸²">&nbsp; </FONT>
				...
				<tr>
					<td colspan="2" style="BORDER-BOTTOM-STYLE: none; WORD-BREAK: break-all" vAlign="top"
						height="400" width="700"><FONT face="±¼¸²">&nbsp;
							<asp:Literal id="Literal2" runat="server"></asp:Literal>
							<asp:TextBox id="TextBox2" runat="server" BorderStyle="None" TextMode="MultiLine" Height="400px"
				...
				<tr>
					<td colspan="2" style="BORDER-BOTTOM-STYLE: none; HEIGHT: 120px; WORD-BREAK: break-all"
						vAlign="top" height="100" width="700">&nbsp;
