...
{
	/// <summary>
	/// UpdateItemOrganizationInfoHistory에 대한 요약 설명입니다.
	/// </summary>
	public class UpdateItemOrganizationInfoHistory : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			//ItemSearchControl1.lbItemNum.Text = "모품목번호";
		...
		private DataSet Search(string a)
		{
			...
			SqlCommand comm = new SqlCommand("SPUpdateReasonIOI",conn);
