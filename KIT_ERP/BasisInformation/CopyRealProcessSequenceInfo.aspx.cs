...
{
	/// <summary>
	/// CopyRealProcessSequenceInfo에 대한 요약 설명입니다.
	/// </summary>
	public class CopyRealProcessSequenceInfo : System.Web.UI.Page
	{
		...
		private void CopyProcess()
		{
			...
			try
			{
				string str = "Select Count(*) From RPSI_MT Where ItemNum = @ItemNum and RecodingState = 1";
				...
				{
					str = @"Select ItemNum, ProcessSequenceNum, ProcessCode, WorkDistinction, WCName, OutsideOrderRate, ProgressRate, LeadTime, EtcText, RegistrationPerson, RegistrationPersonID, RegistrationDate From RPSI_MT Where ItemNum = @ItemNum and RecodingState =1";
					comm.CommandText = str;
					...
					foreach(DataRow dr in ds.Tables[0].Rows)
					{
						...
						test = true;
						str = @"Insert into RPSI_MT (ItemNum, ProcessSequenceNum, ProcessCode, WorkDistinction, WCName, OutsideOrderRate, ProgressRate, LeadTime, EtcText, RecodingState, RegistrationPerson, RegistrationPersonID, RegistrationDate)
