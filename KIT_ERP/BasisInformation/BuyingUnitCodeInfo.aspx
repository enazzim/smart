...
<HTML>
	<HEAD>
		...
		function UltraWebGrid1_DblClickHandler(gridName, cellId){
			...
			document.BuyingUnitCodeInfo.tb_StandardUnitCost.value = MakeCommaSeparate(row.getCellFromKey("StandardUnitCost").getValue());//기준단가
			document.BuyingUnitCodeInfo.tb_DiscountUnitCost.value = MakeCommaSeparate(row.getCellFromKey("DiscountUnitCost").getValue());	//할인단가
			document.BuyingUnitCodeInfo.lb_Index.value = row.getCellFromKey("UnitCostInfoIndex").getValue();
			document.BuyingUnitCodeInfo.CSC1_txtCompanyName.value = row.getCellFromKey("CompanyName").getValue();
			document.BuyingUnitCodeInfo.CSC1_txtBusinessRegistrationNum.value = row.getCellFromKey("BusinessRegistrationNum").getValue();
						...
						<TD vAlign="top">
							...
							<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid"
								...
								<TABLE style="WIDTH: 800px; HEIGHT: 200px" cellSpacing="0" cellPadding="0">
									...
									<TR>
										<TD align="left" width="200" colSpan="2"><FONT style="COLOR: red" face="굴림">
...
<asp:textbox id="tb_DiscountUnitCost" style="TEXT-ALIGN: right" runat="server" BorderStyle="Solid"
            ...
            <ROWSTYLE BorderStyle="Solid" BorderWidth="1px" BorderColor="Gray" BackColor="White">
									...
									<TR>
										...
										<TD style="HEIGHT: 7px" align="right" width="70"><FONT face="굴림">변경사유</FONT></TD>
										<TD style="HEIGHT: 7px" align="left" width="200" colSpan="2"><FONT face="굴림"><FONT face="굴림">
													<asp:textbox id="tbUpdateReason" runat="server" BorderStyle="Solid" BorderWidth="1px" BorderColor="DimGray"
														BackColor="#EEEEE9" Height="20px" Width="180px"></asp:textbox></FONT></FONT></TD>
										<TD style="HEIGHT: 7px" align="left" width="130"><FONT face="굴림">
												<asp:button id="btHistory" runat="server" Height="20px" Width="60px" Text="이력보기"></asp:button></FONT></TD>
									</TR>
									<TR>
										<TD align="right" width="70" height="5"><FONT face="굴림"></FONT></TD>
										<TD align="left" width="130" height="5"></TD>
										...
										<TD align="left" width="130" height="5"></TD>
										<TD align="right" width="70" height="5"></TD>
										<TD align="left" width="130" height="5"><INPUT id="lb_ReferenceIndex" style="WIDTH: 30px; HEIGHT: 22px" type="hidden" name="lb_ReferenceIndex"
												runat="server" size="1"><INPUT id="lb_ReferenceTable" style="WIDTH: 30px; HEIGHT: 22px" type="hidden" name="lb_ReferenceTable"
												runat="server" size="1"></TD>
										<TD style="RIGHT: 97px" width="70" height="5"></TD>
										<TD align="left" width="130" height="5"><INPUT id="lb_Index" style="WIDTH: 77px; HEIGHT: 22px" type="hidden" size="7" value="0"
									...
									<TR>
										...
										<TD align="left" colSpan="4"><FONT face="굴림">&nbsp;&nbsp;<INPUT id="File1" style="WIDTH: 320px; HEIGHT: 20px; BACKGROUND-COLOR: #eeeee9" type="file"
										...
										<TD align="right" width="400" colSpan="3">
											...
											<asp:button id="bt_Update" runat="server" Height="20px" Width="60px" Text="수  정" Enabled="False"></asp:button><FONT face="굴림">&nbsp;</FONT>
											<asp:button id="bt_Delete" runat="server" Height="20px" Width="60px" Text="삭  제" Enabled="False"></asp:button><FONT face="굴림">&nbsp;</FONT>
									...
									<TR>
										<TD colSpan="8" height="10">
											<igtbl:ultrawebgrid id="Ultrawebgrid2" runat="server" Height="130px" Width="800px">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
													...
													<RowSelectorStyleDefault Cursor="Hand"></RowSelectorStyleDefault>
													<FrameStyle Width="800px" BorderWidth="1px" Font-Size="8pt" Font-Names="Verdana" BorderColor="DimGray"
														BorderStyle="Solid" BackColor="Silver" Height="130px"></FrameStyle>
													<FooterStyleDefault BorderWidth="1px" BorderStyle="Solid" BackColor="LightGray">
														<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
													</FooterStyleDefault>
