<%@ Page language="c#" Codebehind="BusinessPlanInfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BasisInformation.BusinessPlanInfo" %>
...
<HTML>
	<HEAD>
		...
		function wcCompany_AfterSelectChange(webComboId){
			...
			if(document.BusinessPlanInfo.tb_ItemNum.value == "")
			{
				alert('품목을 먼저 선택하세요!');
				return false;
			}
		...
		function UltraWebGrid1_DblClickHandler(gridName, cellId){
			...
			document.BusinessPlanInfo.tb_PlanQuantity.value = MakeCommaSeparate(row.getCellFromKey("PlanQuantity").getValue());	//계획량
			document.BusinessPlanInfo.tb_SaleUnitCost.value = MakeCommaSeparate(row.getCellFromKey("SaleUnitCost").getValue());//기준단가
			document.BusinessPlanInfo.tb_PlanTotalCost.value = MakeCommaSeparate(row.getCellFromKey("PlanTotalCost").getValue());		//금액
		...
		function Process()	
		{
			...
			BusinessPlanInfo.tb_PlanTotalCost.value = MakeCommaSeparate((Math.round((total * 10000)) / 10000));
		}
	...
	<body bgColor="#f7f6f6" onload="Load()" MS_POSITIONING="GridLayout">
		<form id="BusinessPlanInfo" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 10px; POSITION: absolute; TOP: 10px" cellSpacing="0"
				cellPadding="0" width="800" border="0" height="540">
				<TR>
					<TD vAlign="top">
						<TABLE id="table1" height="30" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD align="left" width="600" height="30" colSpan="2"><FONT face="굴림"></FONT></TD>
								<TD vAlign="bottom" align="right" width="200" height="30">
									<asp:linkbutton id="LinkButton1" runat="server" Font-Size="9pt">전체사업계획보기</asp:linkbutton></TD>
							</TR>
						</TABLE>
						<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid"
							...
							<TABLE cellSpacing="0" cellPadding="0" width="800">
								<TR>
									<TD align="left" width="600" colSpan="4" height="20"><FONT face="굴림">
								...
								<TR>
									<TD vAlign="middle" align="left" width="800" colSpan="6" height="20"><FONT face="굴림">
											<TABLE id="Table2" height="20" cellSpacing="0" cellPadding="0" width="800" border="0">
												<TBODY>
													<TR>
														<TD width="70" align="right" style="FONT-SIZE: 9pt"><FONT style="COLOR: black" face="굴림">단 
																위&nbsp; </FONT>
														</TD>
														<TD width="130">
															<asp:textbox id="tb_Unit" runat="server" BackColor="#EEEEE9" Height="20px" BorderStyle="Solid"
																BorderColor="DimGray" BorderWidth="1px" Width="97px" Font-Size="9pt" ReadOnly="True"></asp:textbox></TD>
														<TD width="70" align="right"><FONT style="COLOR: black" face="굴림" color="#ff0000">규 격</FONT>
											&nbsp; </FONT><FONT face="굴림"></FONT>
									</TD>
									<TD width="130">
										<asp:textbox id="tb_Standard" runat="server" BackColor="#EEEEE9" Height="20px" BorderStyle="Solid"
											BorderColor="DimGray" BorderWidth="1px" Width="100px" Font-Size="9pt" ReadOnly="True"></asp:textbox></TD>
									<TD width="70"></TD>
									<TD width="130"></TD>
									<TD width="70">
										<asp:label id="lb_ItemIndex" runat="server" Height="8px" Width="23px" Font-Size="8pt" Visible="False">0</asp:label></TD>
									<TD width="130">
										<asp:button id="bt_BusinessPlanView" runat="server" Height="20px" Width="90px" Text="사업계획보기"
				...
				<TR>
					<TD width="800" colSpan="6" height="250"><FONT face="굴림">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
							...
							<TBODY>
								<TR>
									...
									<TD align="left" width="100"><FONT face="굴림">
											<igcmbo:webcombo id="wcCompany" runat="server" BorderWidth="1px" BorderColor="DimGray" BorderStyle="Solid"
												Height="20px" BackColor="#EEEEE9" Width="100" Font-Size="9pt" ForeColor="Black" SelBackColor="10, 36, 106"
												SelectedIndex="-1" SelForeColor="White" DropImageXP2="/ig_common/WebGrid3/ig_cmboDown2.bmp" DropImageXP1="/ig_common/WebGrid3/ig_cmboDown1.bmp"
												Version="3.00">
												<Columns>
									...
									<TD align="left" width="70">
										<asp:dropdownlist id="dl_Year" runat="server" Height="20px" BackColor="#EEEEE9" Width="55px" Font-Size="9pt">
									...
									<TD align="left" width="70">
										<asp:dropdownlist id="dl_Month" runat="server" Height="20px" BackColor="#EEEEE9" Width="50px" Font-Size="9pt">
											<asp:ListItem Value="0">선택</asp:ListItem>
									...
									<TD align="left" width="70">
										<asp:dropdownlist id="dl_Day" runat="server" Height="20px" BackColor="#EEEEE9" Width="50px" Font-Size="9pt">
											<asp:ListItem Value="0">선택</asp:ListItem>
											<asp:ListItem Value="1">1</asp:ListItem>
											<asp:ListItem Value="2">2</asp:ListItem>
											<asp:ListItem Value="3">3</asp:ListItem>
									...
									<TD align="left" width="90">
										<asp:textbox id="tb_PlanQuantity" style="TEXT-ALIGN: right" runat="server" BorderWidth="1px"
											BorderColor="DimGray" BorderStyle="Solid" Height="20px" BackColor="#EEEEE9" Width="70px"
											Font-Size="9pt">0</asp:textbox></TD>
									<TD align="right" width="35"><FONT face="굴림"><FONT style="COLOR: #ff0000" face="굴림">단가&nbsp;</FONT></FONT>
									</TD>
									<TD align="left" width="90">
										<asp:textbox id="tb_SaleUnitCost" style="TEXT-ALIGN: right" runat="server" BorderWidth="1px"
											BorderColor="DimGray" BorderStyle="Solid" Height="20px" BackColor="#EEEEE9" Width="90px"
											Font-Size="9pt">0</asp:textbox></TD>
									<TD style="COLOR: #ff0000" align="right" width="35">금액&nbsp;</TD>
									<TD align="left" width="90">
										<asp:textbox id="tb_PlanTotalCost" style="TEXT-ALIGN: right" runat="server" BorderWidth="1px"
											BorderColor="DimGray" BorderStyle="Solid" Height="20px" BackColor="#EEEEE9" Width="70px"
											Font-Size="9pt">0</asp:textbox></TD>
								</TR>
								<TR>
									<TD align="right" width="70">
										<asp:button id="bt_Reference" runat="server" Height="20px" Width="60px" Text="참고 보기" Font-Size="9pt"></asp:button>&nbsp;</TD>
									<TD align="right" width="740" colSpan="13">
										<asp:label id="lb_Idx" runat="server" Height="10px" Width="8px" Visible="False">0</asp:label><INPUT id="lb_ReferenceTable" style="WIDTH: 30px" type="hidden" name="lb_ReferenceTable"
											...
											runat="server">
										<asp:linkbutton id="ComSelect" runat="server" Visible="False">ComSelect</asp:linkbutton>
			...
			<TR>
				<TD width="800" colSpan="6" height="10">
					<igtbl:ultrawebgrid id="Ultrawebgrid2" runat="server" Height="135px" Width="800px">
						<DisplayLayout StationaryMargins="Header" AutoGenerateColumns="False" AllowSortingDefault="Yes"
