<%@ Page language="c#" Codebehind="CopyWorkStandardInfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BasisInformation.CopyWorkStandardInfo" %>
<%@ Register TagPrefix="uc1" TagName="ItemSearch" Src="ItemSearch/ItemSearch.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ItemSearchControl" Src="../Common/ItemSearchControl/ItemSearchControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CopyWorkStandardInfo</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="LEFT: 5px; POSITION: absolute; TOP: 10px" cellSpacing="0" cellPadding="0"
				...
				<TR>
					<TD style="HEIGHT: 20px" align="right" height="20"><asp:button id="Button1" runat="server" Text="작업표준 복사" Height="20px" Width="90px"></asp:button></TD>
				</TR>
				<TR>
					<TD height="10"></TD>
				</TR>
