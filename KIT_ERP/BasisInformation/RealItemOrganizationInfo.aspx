<%@ Page language="c#" Codebehind="RealItemOrganizationInfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BasisInformation.RealItemOrganizationInfo" %>
...
<HTML>
	<HEAD>
		<title>RealItemOrganizationInfo</title>
		...
		function UltraWebGrid1_DblClickHandler(gridName, cellId){
			...
			document.RealItemOrganizationInfo.ItemSearch1_ChildtxtItemNum.value = row.getCellFromKey("ChildItemNum").getValue()	//자품번호
			document.RealItemOrganizationInfo.hdItemNum.value = row.getCellFromKey("ChildItemNum").getValue()	//자품번호
			document.RealItemOrganizationInfo.ItemSearch1_ChildtxtItemDrawNum.value = row.getCellFromKey("ItemDrawNum").getValue()	//자품번호
			document.RealItemOrganizationInfo.ItemSearch1_ChildtxtItemName.value = row.getCellFromKey("ItemName").getValue()	//자품번호
			document.RealItemOrganizationInfo.tb_ChildPropertyClassification.value = row.getCellFromKey("PropertyClassification").getValue();//자품목분류
			
			document.RealItemOrganizationInfo.tb_ChildUnit.value = row.getCellFromKey("ChildUnit").getValue()	//자품단위
			if(row.getCellFromKey("Standard").getValue() == null)
				document.RealItemOrganizationInfo.tb_ChildStandard.value = "";
			else
				document.RealItemOrganizationInfo.tb_ChildStandard.value = row.getCellFromKey("Standard").getValue()	//자품규격
			document.RealItemOrganizationInfo.tb_NeedQuantityNumerator.value = row.getCellFromKey("NeedQuantityNumerator").getValue()	//소요량분자
			document.RealItemOrganizationInfo.tb_NeedQuantityDenominator.value = row.getCellFromKey("NeedQuantityDenominator").getValue();//소요량분모
			
			//공정관리
			if(document.RealItemOrganizationInfo.dl_ProcessManagement.options[0].innerText == row.getCellFromKey("ProcessManagement").getValue())
				document.RealItemOrganizationInfo.dl_ProcessManagement.options[0].selected=true;
			else
				document.RealItemOrganizationInfo.dl_ProcessManagement.options[1].selected=true;
				
			//하위구분
			if(document.RealItemOrganizationInfo.dl_SubDivision.options[0].innerText == row.getCellFromKey("SubDivision").getValue())
				document.RealItemOrganizationInfo.dl_SubDivision.options[0].selected=true;
			else
				document.RealItemOrganizationInfo.dl_SubDivision.options[1].selected=true;
				
			
			
			//조달구분
			for(var i=0;i<document.RealItemOrganizationInfo.dl_SupplyDivision.options.length;i++)
			{
				if(document.RealItemOrganizationInfo.dl_SupplyDivision.options[i].innerText == row.getCellFromKey("Division").getValue())
				{
					document.RealItemOrganizationInfo.dl_SupplyDivision.options[i].selected=true;
				}
			}
			
			//Bom단위
			for(var i=0;i<document.RealItemOrganizationInfo.dl_BOMUnit.options.length;i++)
			{
				if(document.RealItemOrganizationInfo.dl_BOMUnit.options[i].innerText == row.getCellFromKey("SmallClassificationName").getValue())
				{
					document.RealItemOrganizationInfo.dl_BOMUnit.options[i].selected=true;
				}
			}
			
			document.RealItemOrganizationInfo.lb_Index.value = row.getCellFromKey("RealItemOrganizationInfoIndex").getValue();
			document.RealItemOrganizationInfo.bt_Update.disabled = false;
		    document.RealItemOrganizationInfo.bt_Delete.disabled = false;
		    document.RealItemOrganizationInfo.bt_Registration.disabled = true;
		    document.RealItemOrganizationInfo.ItemSearch1_btnItemNumOpen.disabled = true;
		    document.RealItemOrganizationInfo.ItemSearch1_btnItemDrawNumOpen.disabled = true;
		    document.RealItemOrganizationInfo.ItemSearch1_btnItemNameOpen.disabled = true;
		    document.RealItemOrganizationInfo.ItemSearch1_ChildtxtItemNum.disabled = true;
		    document.RealItemOrganizationInfo.ItemSearch1_ChildtxtItemDrawNum.disabled = true;
			document.RealItemOrganizationInfo.ItemSearch1_ChildtxtItemName.disabled = true;
		}
		...
		function Ultrawebgrid2_AfterSelectChangeHandler(gridName, id){
			...
			RealItemOrganizationInfo.lb_ReferenceTable.value = row.getCellFromKey("CommunityDataTableID").getValue();
			RealItemOrganizationInfo.lb_ReferenceIndex.value = row.getCellFromKey("CDTIndex").getValue();
		}
	...
	<body bgColor="#f7f6f6" ms_positioning="GridLayout">
		<form id="RealItemOrganizationInfo" method="post" runat="server">
							...
							<tr>
								<td>
									<table id="table1" style="HEIGHT: 20px" cellSpacing="0" cellPadding="0" width="100%" bgColor="#f7f6f6">
										<TR>
											<td align="left" width="600" colSpan="3"><INPUT id="ItemIndex" style="WIDTH: 30px" type="hidden" name="ItemIndex" runat="server"><asp:label id="lb_ItemIndex" runat="server" Visible="False" Font-Size="10pt"></asp:label><FONT face="굴림">&nbsp;&nbsp;
												</FONT>
											</td>
											<td vAlign="bottom" align="right" width="200" colSpan="5"><asp:linkbutton id="LinkButton1" runat="server" Font-Size="9pt">진품목구성보기</asp:linkbutton></td>
										</TR>
									</table>
								</td>
							</tr>
									...
									<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; HEIGHT: 480px"
										...
										<TABLE style="WIDTH: 800px; HEIGHT: 368px" cellSpacing="0" cellPadding="0">
											<TR>
												...
												<TD align="left" width="130" height="20"><FONT face="굴림"><asp:textbox id="tb_ParentPropertyClassification" runat="server" Font-Size="9pt" BorderWidth="1px"
															BorderColor="DimGray" ReadOnly="True" Width="100px" Height="20px" BorderStyle="Solid" BackColor="#EEEEE9"></asp:textbox></FONT></TD>
											</TR>
											<TR>
												<TD align="right" width="70"><FONT face="굴림">단 위&nbsp;</FONT></TD>
												<TD align="left" width="130"><asp:textbox id="tb_ParentUnit" runat="server" Font-Size="9pt" BorderWidth="1px" BorderColor="DimGray"
														ReadOnly="True" Width="100px" Height="20px" BorderStyle="Solid" BackColor="#EEEEE9"></asp:textbox></TD>
												<TD align="right" width="70"><FONT face="굴림">규 격&nbsp;</FONT></TD>
												<TD align="left" width="130"><asp:textbox id="tb_ParentStandard" runat="server" Font-Size="9pt" BorderWidth="1px" BorderColor="DimGray"
														ReadOnly="True" Width="100px" Height="20px" BorderStyle="Solid" BackColor="#EEEEE9"></asp:textbox></TD>
												<TD align="right" width="70"><FONT face="굴림"></FONT></TD>
												<TD align="right" width="330" colSpan="3">
													<asp:button id="Button2" runat="server" Height="20px" Width="65px" Text="BOM 복사"></asp:button>&nbsp;
													<asp:button id="Button1" runat="server" Height="20px" Width="65px" Text="역 BOM"></asp:button>&nbsp;<asp:button id="bt_Expansion" runat="server" Width="65px" Height="20px" Text="BOM전개"></asp:button>&nbsp;
													<asp:button id="bt_ExpansionView" runat="server" Width="90px" Height="20px" Text="소요자재보기"></asp:button>&nbsp;</TD>
											</TR>
											<TR>
											...
											<TR>
												<TD vAlign="top" align="left" width="800" colSpan="8" height="180"><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Width="800px" Height="190px">
											...
											<TR>
												<TD style="HEIGHT: 25px" align="left" width="800" colSpan="8">
													<INPUT id="Hidden1" style="WIDTH: 30px" type="hidden" name="ItemIndex" runat="server">
													<asp:label id="lb_ItemOrganization" runat="server" Visible="False" Font-Size="10pt"></asp:label><asp:label id="lb_ItemIndex1" runat="server" Visible="False" Font-Size="10pt"></asp:label></TD>
											</TR>
											<TR>
												<TD align="left" width="600" colSpan="6" height="20">
												...
												<TD align="left" width="130" height="20"><asp:textbox id="tb_ChildPropertyClassification" runat="server" Font-Size="9pt" BorderWidth="1px"
														BorderColor="DimGray" ReadOnly="True" Width="100px" Height="20px" BorderStyle="Solid" BackColor="#EEEEE9"></asp:textbox></TD>
											</TR>
											<TR>
												<TD align="right" width="70"><FONT face="굴림">단 위&nbsp;</FONT></TD>
												<TD align="left" width="130"><asp:textbox id="tb_ChildUnit" runat="server" Font-Size="9pt" BorderWidth="1px" BorderColor="DimGray"
														ReadOnly="True" Width="100px" Height="20px" BorderStyle="Solid" BackColor="#EEEEE9"></asp:textbox></TD>
												<TD align="right" width="70"><FONT face="굴림">규 격&nbsp;</FONT></TD>
												<TD align="left" width="130"><asp:textbox id="tb_ChildStandard" runat="server" Font-Size="9pt" BorderWidth="1px" BorderColor="DimGray"
														ReadOnly="True" Width="100px" Height="20px" BorderStyle="Solid" BackColor="#EEEEE9"></asp:textbox></TD>
												...
												<TD align="left" width="130"><asp:textbox id="tb_NeedQuantityNumerator" style="TEXT-ALIGN: right" runat="server" Font-Size="9pt"
														BorderWidth="1px" BorderColor="DimGray" Width="100px" Height="20px" BorderStyle="Solid" BackColor="#EEEEE9">0</asp:textbox></TD>
												...
												<TD align="left" width="130"><asp:textbox id="tb_NeedQuantityDenominator" style="TEXT-ALIGN: right" runat="server" Font-Size="9pt"
														BorderWidth="1px" BorderColor="DimGray" Width="100px" Height="20px" BorderStyle="Solid" BackColor="#EEEEE9">1</asp:textbox></TD>
											</TR>
											<TR>
												<TD style="HEIGHT: 18px" align="right" width="70"><FONT style="COLOR: red" face="굴림">공정관리&nbsp;</FONT></TD>
												<TD align="left" width="130"><asp:dropdownlist id="dl_ProcessManagement" runat="server" Font-Size="9pt" Width="65px" Height="20px"
														BackColor="#EEEEE9">
												...
												<TD style="HEIGHT: 18px" align="left" width="130"><asp:dropdownlist id="dl_SubDivision" runat="server" Font-Size="9pt" Width="65px" Height="20px" BackColor="#EEEEE9">
														<asp:ListItem Value="0">아니오</asp:ListItem>
														<asp:ListItem Value="1">예</asp:ListItem>
													</asp:dropdownlist></TD>
												<TD style="HEIGHT: 18px" align="right" width="70"><FONT face="굴림">조달구분&nbsp;</FONT></TD>
												<TD style="HEIGHT: 18px" width="130"><asp:dropdownlist id="dl_SupplyDivision" runat="server" Font-Size="9pt" Width="100px" Height="20px"
												...
												<TD style="HEIGHT: 18px" width="130"><asp:dropdownlist id="dl_BOMUnit" runat="server" Font-Size="9pt" Width="100px" Height="20px" BackColor="#EEEEE9"></asp:dropdownlist></TD>
											</TR>
											<TR>
												<TD style="HEIGHT: 25px" align="right" width="70"><FONT style="FONT-SIZE: 8pt; COLOR: red" face="굴림">*적용시작일&nbsp;</FONT></TD>
												<TD style="HEIGHT: 25px" align="left" width="130"><igsch:webdatechooser id="wdcBeginDate" runat="server" Font-Size="9pt" BorderColor="DimGray" Width="95px"
														Height="20px" BorderStyle="Solid" BackColor="#EEEEE9" Text="Null" MaxDate="2079-06-06" NullDateLabel=" ">
												...
												<TD style="HEIGHT: 25px" width="130"><igsch:webdatechooser id="wdcEndDate" runat="server" Font-Size="9pt" BorderColor="DimGray" Width="95px"
														Height="20px" BorderStyle="Solid" BackColor="#EEEEE9" Text="Null" MaxDate="2079-06-06" NullDateLabel=" ">
														<CalendarLayout DayNameFormat="FirstLetter" FooterFormat="Today: {0:d}" ShowNextPrevMonth="False"
															MaxDate="2079-06-06" ShowTitle="False" ShowFooter="False">
															<SelectedDayStyle ForeColor="White" BackColor="#0A246A"></SelectedDayStyle>
												...
												<TD width="200" colSpan="2"><FONT face="굴림"></FONT>&nbsp;
													<asp:textbox id="tbUpdateReason" runat="server" Font-Size="9pt" BackColor="#EEEEE9" BorderStyle="Solid"
											...
											<TR>
												...
												<TD align="left" width="130">&nbsp; <INPUT id="lb_Index" style="WIDTH: 47px; HEIGHT: 22px" type="hidden" size="2" value="0"
												...
												<TD align="left" width="130"><FONT face="굴림"><INPUT id="hdItemNum" style="WIDTH: 32px; HEIGHT: 22px" type="hidden" size="1" name="Hidden2"
															runat="server"></FONT></TD>
												<TD align="right" width="70"></TD>
												<TD align="right" width="330" colSpan="3"><asp:button id="bt_Clear" runat="server" Width="60px" Height="20px" Text="초기화"></asp:button><FONT face="굴림">&nbsp;</FONT><asp:button id="bt_Update" runat="server" Width="60px" Height="20px" Text="수  정" Enabled="False"></asp:button><FONT face="굴림">&nbsp;</FONT><asp:button id="bt_Delete" runat="server" Width="60px" Height="20px" Text="삭  제" Enabled="False"></asp:button><FONT face="굴림">&nbsp;</FONT><asp:button id="bt_Registration" runat="server" Width="60px" Height="20px" Text="등  록"></asp:button>&nbsp;</TD>
											</TR>
											<TR>
											...
											<TR>
												<TD colSpan="8" height="10"><igtbl:ultrawebgrid id="Ultrawebgrid2" runat="server" Width="800px" Height="128px">
