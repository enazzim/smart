<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ItemSearch.ascx.cs" Inherits="KIT_ERP.BasisInformation.ItemSearch.ItemSearch" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
