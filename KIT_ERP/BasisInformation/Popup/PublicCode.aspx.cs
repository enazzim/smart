...
{
	/// <summary>
	/// PublicCode에 대한 요약 설명입니다.
	/// </summary>
	public class PublicCode : System.Web.UI.Page
	{
		...
		private DataSet PageLoad()
		{
			...
			string str = @"SELECT LargeClassificationCode, LargeClassificationName, SmallClassificationCode, SmallClassificationName From PUC_MT 
				Where SmallClassificationName is not null
				order by LargeClassificationName, SmallClassificationName";
