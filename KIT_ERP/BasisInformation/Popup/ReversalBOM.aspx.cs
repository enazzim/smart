...
{
	/// <summary>
	/// ReversalBOM에 대한 요약 설명입니다.
	/// </summary>
	public class ReversalBOM : System.Web.UI.Page
	{
		...
		private DataTable Table_Add(string Item)
		{
			...
			if(stack1.Count == 1)
			{
				...
				if(PropertyClassification(st.Name))
				{					
					AddItem(st);
				}
				else
			...
			//기존TempTable 레코드 삭제
			string strDel = "Delete From TBReversalBOM";
		...
		private bool PropertyClassification(string ItemNum)
		{
