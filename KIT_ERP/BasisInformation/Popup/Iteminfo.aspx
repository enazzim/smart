<%@ Page language="c#" Codebehind="Iteminfo.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BasisInformation.Popup.Iteminfo" %>
...
<HTML>
	<HEAD>
		...
		function UltraWebGrid1_AfterSelectChangeHandler(gridName, id){
			...
			Iteminfo.ItemIndex.value = row.getCellFromKey("ItemInfoIndex").getValue();
			Iteminfo.RowIndex.value = parts[1]; 
...
--></SCRIPT>
	...
	<body MS_POSITIONING="GridLayout" bgColor="buttonface">
		<form id="Iteminfo" method="post" runat="server">
			<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; FONT-SIZE: 0pt; Z-INDEX: 101; LEFT: 8px; BORDER-LEFT: dimgray 2px solid; WIDTH: 80.55%; BORDER-BOTTOM: dimgray 2px solid; POSITION: absolute; TOP: 8px; HEIGHT: 384px"><LEGEND align="top"><asp:label id="Label2" Font-Size="10pt" Runat="server"> [결&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;과]</asp:label></LEGEND><igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Width="752px" Height="355px">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
						...
						<FrameStyle Width="752px" BorderWidth="1px" Font-Size="8pt" Font-Names="Verdana" BorderStyle="Solid"
					...
					<Bands>
						<igtbl:UltraGridBand>
							<Columns>
								<igtbl:UltraGridColumn HeaderText="품목번호" Key="ItemNum" Width="250px" HeaderClickAction="SortMulti" BaseColumnName="ItemNum">
			...
			<INPUT id="ItemIndex" style="Z-INDEX: 102; LEFT: 8px; WIDTH: 32px; POSITION: absolute; TOP: 392px; HEIGHT: 22px"
				...
				type="hidden" size="1" runat="server" NAME="RowIndex"></form>
	</body>
</HTML>
