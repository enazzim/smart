...
{
	/// <summary>
	/// RealItemOrganization에 대한 요약 설명입니다.
	/// </summary>
	public class RealItemOrganization : System.Web.UI.Page
	{
		protected System.Web.UI.WebControls.Button bt_Excel;
		protected Infragistics.WebUI.UltraWebGrid.UltraWebGrid UltraWebGrid1;
		protected Infragistics.WebUI.UltraWebGrid.ExcelExport.UltraWebGridExcelExporter UltraWebGridExcelExporter2;
		...
		private DataSet PageLoad()
		{
			...
			string str = @"SELECT   IOI_MT.ParentItemNum, IOI_MT.ChildItemNum, II_MT_1.ItemDrawNum,
				II_MT_1.ItemName, IOI_MT.NeedQuantityNumerator,
