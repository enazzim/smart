<%@ Page language="c#" Codebehind="Item.aspx.cs" AutoEventWireup="false" Inherits="KIT_ERP.BasisInformation.Popup.Item" %>
...
<HTML>
	<HEAD>
		...
		function UltraWebGrid1_AfterSelectChangeHandler(gridName, id){
			...
			Item.ItemIndex.value = row.getCellFromKey("ItemInfoIndex").getValue();
			Item.RowIndex.value = parts[1];  
		}
--></SCRIPT>
	</HEAD>
	<body MS_POSITIONING="GridLayout" bgColor="buttonface">
		<form id="Item" method="post" runat="server">
			<FIELDSET style="BORDER-RIGHT: dimgray 2px solid; BORDER-TOP: dimgray 2px solid; FONT-SIZE: 0pt; Z-INDEX: 101; LEFT: 8px; BORDER-LEFT: dimgray 2px solid; WIDTH: 800px; BORDER-BOTTOM: dimgray 2px solid; POSITION: absolute; TOP: 8px; HEIGHT: 350px"><LEGEND align="top"><asp:label id="Label2" Font-Size="10pt" Runat="server"> [결&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;과]</asp:label></LEGEND>
				<igtbl:ultrawebgrid id="UltraWebGrid1" runat="server" Height="355px" Width="790px">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
						...
						<FrameStyle Width="790px" BorderWidth="1px" Font-Size="8pt" Font-Names="Verdana" BorderStyle="Solid"
							BackColor="Silver" Height="355px"></FrameStyle>
					...
					<Bands>
						<igtbl:UltraGridBand>
							<Columns>
								...
								<igtbl:UltraGridColumn HeaderText="품목명" Key="ItemName" Width="285px" BaseColumnName="ItemName">
									<CellStyle VerticalAlign="Middle" HorizontalAlign="Center"></CellStyle>
									<HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"></HeaderStyle>
								</igtbl:UltraGridColumn>
			...
			<INPUT id="ItemIndex" style="Z-INDEX: 102; LEFT: 8px; WIDTH: 32px; POSITION: absolute; TOP: 392px; HEIGHT: 22px"
				type="hidden" size="1" runat="server"> <INPUT id="RowIndex" style="Z-INDEX: 103; LEFT: 48px; WIDTH: 32px; POSITION: absolute; TOP: 392px; HEIGHT: 22px"
				type="hidden" size="1" runat="server"></form>
	</body>
</HTML>
