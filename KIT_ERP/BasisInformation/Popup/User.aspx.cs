...
namespace KIT_ERP.BasisInformation.Popup
{
	...
	public class User : System.Web.UI.Page
	{
		...
		private DataSet PageLoad()
		{
			...
			string str = @"select ID, Name, PostCode, SmallClassificationName as Post, Responsibility, IdentificationNumber, 
				Telephone1, Telephone2, Address, EnterDate, EMail, UserInfoIndex From UI_MT
				left outer join PUC_MT on UI_MT.PostCode = PUC_MT.SmallClassificationCode
				Where UI_MT.RecodingState=1 order by Name";
