namespace KIT_ERP.Common.ItemSearchControl
{
	using System;
	using System.Data;
	...
	/// <summary>
	///		ItemSearchControl에 대한 요약 설명입니다.
	/// </summary>
	public class ItemSearchControl : System.Web.UI.UserControl
	{
		...
		protected bool 상품 = false, 제품 = false, 팬텀 = false, 반제품 = false, 원자재 = false, 부자재 = false, 소모품 = false;
		...
		protected System.Web.UI.WebControls.Label lbItemDrawNum;
		...
		{
			string propertyClassification = 상품 + ";" + 제품 + ";" + 팬텀 + ";" + 반제품 + ";" + 원자재 + ";"  + 부자재 + ";" + 소모품;
		...
		/// <summary>
		/// 품목검색시 자산분류가 부자재를 검색할 것 인지를 결정합니다. - 기본값은 false
		/// </summary>
		public bool  SubMaterials
		{
			set
			{
				this.부자재 = value;
		...
		public string hdItem
		{
			get
			{
				return hdItemNum.Value;
			}
		}
