...
{
	public class popUp_ItemSearchColtrol : System.Web.UI.Page
	{
		...
		private void Bind()
		{
			try
			{
				...
				string[] arrStrValue = new String[6];
				...
				adap.SelectCommand.Parameters.Add("@부자재", SqlDbType.Bit).Value = Convert.ToBoolean( arrStrValue[5]);
