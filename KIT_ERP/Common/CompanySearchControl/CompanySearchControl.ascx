<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CompanySearchControl.ascx.cs" Inherits="KIT_ERP.Common.CompanySearchControl.CompanySearchControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<!--
	function Popupopen(id, controlName,unitcostDistinction,ItemNum)
	{
		...
		arr = window.showModalDialog
			("../Common/CompanySearchControl/popUp_CompanySearch.aspx?tag="+ controlName + "&value=" + value+"&unitcostdistinction=" + unitcostDistinction+"&ItemNum="+ItemNum ,"f", "dialogHeight: 370px; dialogWidth: 370px; center: yes; help: no; resizable: no; status: no;");
