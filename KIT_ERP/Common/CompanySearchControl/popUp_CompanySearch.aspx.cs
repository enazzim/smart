...
namespace KIT_ERP.Common.CompanySearchControl
{
	/// <summary>
	/// popUp_CompanySearch에 대한 요약 설명입니다.
	/// </summary>
	public class popUp_CompanySearch : System.Web.UI.Page
	{
		...
		private void Bind()
		{
			try
			{
				...
				string strItemNum = Request["ItemNum"];				
				
				SqlDataAdapter adap = new SqlDataAdapter("CompanyNameSearch_Popup", strConnectionString);
				...
				adap.SelectCommand.Parameters.Add("@ItemNum", strItemNum);
