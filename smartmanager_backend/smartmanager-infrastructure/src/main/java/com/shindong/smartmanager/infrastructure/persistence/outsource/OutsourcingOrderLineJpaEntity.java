...
@Entity
@Table(name = "outsourcing_order_line")
public class OutsourcingOrderLineJpaEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @Column(name = "outsourcing_order_id", nullable = false)
    ...
    @Column(name = "begin_process_code_id", nullable = false)
    private Long beginProcessCodeId;

    @Column(name = "end_process_code_id", nullable = false)
    ...
    protected OutsourcingOrderLineJpaEntity() {
    }
