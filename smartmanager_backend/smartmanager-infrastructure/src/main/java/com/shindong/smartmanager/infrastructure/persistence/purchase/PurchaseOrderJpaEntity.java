...
public class PurchaseOrderJpaEntity {
    ...
    @Column(name = "source_type", nullable = false, columnDefinition = "ENUM('MRP','SALES_ORDER','MANUAL')")
    ...
    public PurchaseOrderSourceType getSourceType() {
        return sourceType;
    }

    public void setSourceType(PurchaseOrderSourceType sourceType) {
